    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion"))
        if (("0.8.59") != yeapfVersion())
          die("<ul class=err>Your configure version is '0.8.59' while your installed version is '".yeapfVersion()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>");
