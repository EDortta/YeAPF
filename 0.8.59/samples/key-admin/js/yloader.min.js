...
function unmaskHTML(a){if("string"==typeof a){if(0<a.length){var b=a.substr(0,1);if('"'==b||"'"==b){var c=a.substr(a.length-1);b==c&&(a=a.substr(1,a.length-2))}}for(;0<=a.indexOf("!!");)a=a.replace("!!","&");a=a.replace(/\[/g,"<");a=a.replace(/\]/g,">");a=a.replace(/\&\#91\;/g,"[");a=a.replace(/\&\#93\;/g,"]")}else a="number"==typeof a?a.toString():"";return a}function escapeRegExp(a){return a.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1")}
...
g|a>>>32-g,c)},d=function(a,c,d,e,f,g,h){a=b(a,b(b(c&e|d&~e,f),h));return b(a<<g|a>>>32-g,c)},e=function(a,c,d,e,f,g,h){a=b(a,b(b(c^d^e,f),h));return b(a<<g|a>>>32-g,c)},f=function(a,c,d,e,f,g,h){a=b(a,b(b(d^(c|~e),f),h));return b(a<<g|a>>>32-g,c)},g=function(a){var b="",c="",d;for(d=0;3>=d;d++)c=a>>>8*d&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},h=[],k,l,t,x,w,p,q,s,m;a=this.utf8_encode(a);h=function(a){var b,c=a.length;b=c+8;for(var d=16*((b-b%64)/64+1),e=Array(d-1),f=0,g=0;g<
c;)b=(g-g%4)/4,f=g%4*8,e[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;e[b]|=128<<g%4*8;e[d-2]=c<<3;e[d-1]=c>>>29;return e}(a);p=1732584193;q=4023233417;s=2562383102;m=271733878;a=h.length;for(k=0;k<a;k+=16)l=p,t=q,x=s,w=m,p=c(p,q,s,m,h[k+0],7,3614090360),m=c(m,p,q,s,h[k+1],12,3905402710),s=c(s,m,p,q,h[k+2],17,606105819),q=c(q,s,m,p,h[k+3],22,3250441966),p=c(p,q,s,m,h[k+4],7,4118548399),m=c(m,p,q,s,h[k+5],12,1200080426),s=c(s,m,p,q,h[k+6],17,2821735955),q=c(q,s,m,p,h[k+7],22,4249261313),p=c(p,q,s,m,h[k+
8],7,1770035416),m=c(m,p,q,s,h[k+9],12,2336552879),s=c(s,m,p,q,h[k+10],17,4294925233),q=c(q,s,m,p,h[k+11],22,2304563134),p=c(p,q,s,m,h[k+12],7,1804603682),m=c(m,p,q,s,h[k+13],12,4254626195),s=c(s,m,p,q,h[k+14],17,2792965006),q=c(q,s,m,p,h[k+15],22,1236535329),p=d(p,q,s,m,h[k+1],5,4129170786),m=d(m,p,q,s,h[k+6],9,3225465664),s=d(s,m,p,q,h[k+11],14,643717713),q=d(q,s,m,p,h[k+0],20,3921069994),p=d(p,q,s,m,h[k+5],5,3593408605),m=d(m,p,q,s,h[k+10],9,38016083),s=d(s,m,p,q,h[k+15],14,3634488961),q=d(q,s,
m,p,h[k+4],20,3889429448),p=d(p,q,s,m,h[k+9],5,568446438),m=d(m,p,q,s,h[k+14],9,3275163606),s=d(s,m,p,q,h[k+3],14,4107603335),q=d(q,s,m,p,h[k+8],20,1163531501),p=d(p,q,s,m,h[k+13],5,2850285829),m=d(m,p,q,s,h[k+2],9,4243563512),s=d(s,m,p,q,h[k+7],14,1735328473),q=d(q,s,m,p,h[k+12],20,2368359562),p=e(p,q,s,m,h[k+5],4,4294588738),m=e(m,p,q,s,h[k+8],11,2272392833),s=e(s,m,p,q,h[k+11],16,1839030562),q=e(q,s,m,p,h[k+14],23,4259657740),p=e(p,q,s,m,h[k+1],4,2763975236),m=e(m,p,q,s,h[k+4],11,1272893353),s=
e(s,m,p,q,h[k+7],16,4139469664),q=e(q,s,m,p,h[k+10],23,3200236656),p=e(p,q,s,m,h[k+13],4,681279174),m=e(m,p,q,s,h[k+0],11,3936430074),s=e(s,m,p,q,h[k+3],16,3572445317),q=e(q,s,m,p,h[k+6],23,76029189),p=e(p,q,s,m,h[k+9],4,3654602809),m=e(m,p,q,s,h[k+12],11,3873151461),s=e(s,m,p,q,h[k+15],16,530742520),q=e(q,s,m,p,h[k+2],23,3299628645),p=f(p,q,s,m,h[k+0],6,4096336452),m=f(m,p,q,s,h[k+7],10,1126891415),s=f(s,m,p,q,h[k+14],15,2878612391),q=f(q,s,m,p,h[k+5],21,4237533241),p=f(p,q,s,m,h[k+12],6,1700485571),
m=f(m,p,q,s,h[k+3],10,2399980690),s=f(s,m,p,q,h[k+10],15,4293915773),q=f(q,s,m,p,h[k+1],21,2240044497),p=f(p,q,s,m,h[k+8],6,1873313359),m=f(m,p,q,s,h[k+15],10,4264355552),s=f(s,m,p,q,h[k+6],15,2734768916),q=f(q,s,m,p,h[k+13],21,1309151649),p=f(p,q,s,m,h[k+4],6,4149444226),m=f(m,p,q,s,h[k+11],10,3174756917),s=f(s,m,p,q,h[k+2],15,718787259),q=f(q,s,m,p,h[k+9],21,3951481745),p=b(p,l),q=b(q,t),s=b(s,x),m=b(m,w);return(g(p)+g(q)+g(s)+g(m)).toLowerCase()};
...
function yAnalise(a,b,c){if(void 0!==a){a=unmaskHTML(a);c=!0===window.__allowInsecureJSCalls__?c||window:c||{};var d=/\%(|\w+)\(/gi,e,f,g,h,k;for(f="";"string"==typeof a&&0<=(e=a.search(d));)if(f=a.slice(e).search(/\(/),0<=f){g=a.slice(e+f+1,e+f+2);if('"'==g||"'"==g){k=e+f+1;do k++,h=a.slice(k,k+1);while(h!=g&&k<a.length);g=k+a.slice(k).search(/\)/)-e}else g=a.slice(e).search(/\)/);var l=a.slice(e+1,e+f);h=a.slice(e+f+1,e+g);k=null;h=h.split(",");for(k=0;k<h.length;k++)h[k]=yAnalise(h[k],b,c);f=void 0;
k=h[0].toUpperCase();var t=h[0];if(void 0!==b)if(void 0==b[0])f=b[k]?yAnalise(b[k],b,c):yAnalise(b[t],b,c);else for(var x=b.length-1;0<=x&&void 0==f;x--)void 0!=b[x][k]?f=yAnalise(b[x][k],b,c):void 0!=b[x][t]&&(f=yAnalise(b[x][t],b,c));else f=""==t?"":"."!=t.substr(0,1)&&"string"==eval("typeof "+t)?eval(t):yAnalise(t,null,c);void 0==f&&(f="");h[0]=f;switch(l){case "integer":case "int":case "intz":case "intn":f=str2int(f);0==f&&("intz"==l?f="-":"intn"==l&&(f=""));break;case "decimal":h=Math.max(0,
parseInt(h[1]));f=str2double(f);f=f.toFixed(h);break;case "phone":f=(f||"").asPhone();break;case "lon2deg":f=dec2deg(f,!1);break;case "lat2deg":f=dec2deg(f,!0);break;case "ibdate":f=IBDate2Date(f);break;case "tsdate":f=timestamp2date(f);break;case "tstime":f=timestamp2time(f);break;case "date":f=h[1]?UDate2Date(f,h[1]):UDate2Date(f);break;case "time":f=h[1]?UDate2Time(f,h[1]):UDate2Time(f);break;case "nl2br":f=f.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "abbreviate":f=f.abbreviate(h[1]||
20,h[2]||!1);break;case "words":l=f.split(" ");t=Math.max(0,str2int(h[1]));x=Math.max(l.length-1,str2int(h[2]));h=Math.max(0,str2int(h[3]));f="";for(k=t;k<t+x;k++){var w=onlyDefinedValue(l[k]);""<w&&(f+=" "+w)}0<h&&(f=wordwrap(f,h,"<br>",!0));break;case "quoted":f=('"'+f).trim()+'"';break;case "singleQuoted":f=("'"+f).trim()+"'";break;case "condLabel":break;case "checked":f=countCheckedElements(f);break;default:""<l&&"function"==typeof c[l]&&(f=c[l].apply(null,h))}a=a.slice(0,e)+f+a.slice(e+g+1)}else{console.log("HALTING yAnalise as entering in loop");
break}}else a="";return a}
...
t(b[s]),l=null!==d?unmaskHTML(k[d]||""):unmaskHTML(k);c.columns&&c.columns[d]&&(c.columns[d].align&&(f.style.textAlign=c.columns[d].align),c.columns[d].type&&(l=yAnalise("%"+c.columns[d].type+"("+l+")")));h||f.addClass("warning");f.innerHTML=0===l.length?"&nbsp;":l;f.style.verticalAlign="top";f.id=a+"_"+z+"_"+q.rows.length;f.setAttribute("colName",d);if("function"==typeof c.onNewItem)c.onNewItem(a,f,k);z+=1}},q,s,m,z,B=(new Date).getTime()-1447265735470,v;if(k)if("TABLE"==k.nodeName){q=0<k.getElementsByTagName("tbody").length?
k.getElementsByTagName("tbody")[0]:k;0<q.getElementsByTagName("tbody").length&&(q=q.getElementsByTagName("tbody")[0]);if(l)if("undefined"==typeof(c.columns||c.rows||c.html)){if(ycomm.dom._elem_templates[a]={},0<q.rows.length)for(ycomm.dom._elem_templates[a].rows=[],l=0;l<q.rows.length;l++)ycomm.dom._elem_templates[a].rows[l]=trim(q.rows[l].innerHTML+"").replace(/\ \s+/g,"")}else ycomm.dom._elem_templates[a]={},ycomm.dom._elem_templates[a].columns=c.columns,ycomm.dom._elem_templates[a].rows=c.rows,
ycomm.dom._elem_templates[a].html=c.html;mergeObject(ycomm.dom._elem_templates[a],c,!0);if(!0===d.deleteRows)for(;0<q.rows.length;)q.deleteRow(q.rows.length-1);var E=q.rows.length%2;z=null;for(s in b)if(b.hasOwnProperty(s)){v=t(b[s]);E++;h=!0;if(!d.deleteRows&&v[e])for(l=0;h&&l<q.rows.length;l++)if(q.rows[l].id==v[e]){for(g=q.rows[l];0<g.cells.length;)g.deleteCell(0);h=!1;v.rowid=l}h&&(g=d.insertAtTop?q.insertRow(0):q.insertRow(q.rows.length));B++;v.rowid=d.insertAtTop||"undefined"===typeof g.rowIndex?
B+"":g.rowIndex;v._elementid_=a;w(g);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,v);if("undefined"==typeof c.html&&"undefined"==typeof c.rows&&"undefined"==typeof c.columns)if("string"==typeof v)p(null);else for(f in v)v.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&p(f);else if("undefined"!=typeof c.columns)if(isArray(c.columns))for(m=0;m<c.columns.length;m++)p(c.columns[m]);else for(m in c.columns)c.columns.hasOwnProperty(m)&&p(m);else if("undefined"!=typeof c.html){if(l=
g.insertCell(0),l.innerHTML=yAnalise(c.html,v),l.style.verticalAlign="top",l.id=a+"_"+z+"_"+q.rows.length,"function"==typeof c.onNewItem)c.onNewItem(a,l,v)}else if("undefined"!=typeof c.rows)for(l=!0,r=0;r<c.rows.length;r++){l||(g=q.insertRow(q.rows.length),w(g));g.innerHTML=yAnalise(c.rows[r],v);if(!h&&d.deleteRows)for(m=0;m<g.cells.length;m++)g.cells[m].style.borderLeft="solid 1px red";if("function"==typeof c.onNewItem)c.onNewItem(a,g,v);l=!1}if("function"==typeof c.onNewRowReady)c.onNewRowReady(a,
g)}f=new Event("filled");k.dispatchEvent(f)}else if("UL"==k.nodeName){if(d.deleteRows)for(;k.firstChild;)k.removeChild(k.firstChild);for(s in b)if(b.hasOwnProperty(s)){v=t(b[s]);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,v);l=document.createElement("li");x(l,v);m="";p=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)m=m+yAnalise(c.rows[r],v)+"";p=!0}else if("string"==typeof c.html)m=m+yAnalise(c.html,v)+"",p=!0;else for(f in v)""===m&&v.hasOwnProperty(f)&&f!=e&&"rowid"!=
f&&"_elementid_"!=f&&(m+=v[f]||"");w(l);p?l.innerHTML=m:l.appendChild(document.createTextNode(m));"string"==typeof c.beforeElement?(m=y$(c.beforeElement),k.insertBefore(l,m)):k.appendChild(l);if("function"==typeof c.onNewItem)c.onNewItem(a,l,v)}f=new Event("filled");k.dispatchEvent(f)}else if("LISTBOX"==k.nodeName){if(d.deleteRows)for(;0<k.childElementCount;)k.childNodes[0].remove();w=0;for(s in b)if(b.hasOwnProperty(s)){v=t(b[s]);v._elementid_=a;if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,
...
if("function"==typeof c.onNewItem)c.onNewItem(a,l,v);z+=1;g.appendChild(l)}x(g,v);k.appendChild(g);w++}f=new Event("filled");k.dispatchEvent(f)}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);z=0;for(s in b)if(b.hasOwnProperty(s)){v=t(b[s]);v._elementid_=a;if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,v);l="";if("undefined"==typeof c.columns)if("string"==typeof v)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");
else for(f in v)v.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(l+=v[f]||"");else if(w=c.sep||"",isArray(c.columns))for(m=0;m<c.columns.length;m++)""<l&&(l+=w),l=l+v[c.columns[m]]||"";else if("string"==typeof v)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(l=l+(v[f]||"")+w);w=document.createElement("option");"undefined"!=typeof v[e]&&("DATALIST"==k.nodeName?w.setAttribute("data-"+e,v[e]):w.value=v[e]);w.innerHTML=l;w.id=a+"_"+z;x(w,v);if("function"==
typeof c.onNewItem)c.onNewItem(a,w,v);k.appendChild(w);z++}f=new Event("filled");k.dispatchEvent(f);if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var C,A,y;y=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length){var D=t(b[0]||b);x(k,D);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,D);p=c.elementPrefixName||c.prefix||k.getAttribute("data-prefix")||"";B=c.elementPostixName||c.postfix||k.getAttribute("data-postfix")||"";for(l=0;l<y.length;l++)if(w=
y[l].getAttribute("data-edit-mask")||y[l].getAttribute("editMask"),m=y[l].getAttribute("data-storage-mask")||y[l].getAttribute("storageMask"),v=y[l].getAttribute("data-value-type")||y[l].getAttribute("valueType")||"text",C=suggestKeyName(D,y[l].name||y[l].id,p,B),f=c.columns&&suggestKeyName(c.columns,y[l].name||y[l].id)||null,"undefined"!=typeof D[C]&&(A=unmaskHTML(D[C]),C=y[l].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(v=c.columns[f].type,w=c.columns[f].editMask||w,m=c.columns[f].storageMask||
m);"text"!=v&&(""<w&&""<m?0<=v.indexOf("date")&&(A=dateTransform(A,m,w)):A=yAnalise("%"+v+"("+A+")"));switch(C){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "number":case "range":case "search":case "tel":case "time":case "url":case "week":y[l].value=A;break;case "radio":case "checkbox":y[l].value==A&&(y[l].checked=y[l].value===A);break;case "select-one":case "select-multi":for(s=0;s<y[l].options.length;s++)y[l].options[s].value==
A&&(y[l].selectedIndex=s)}if("function"==typeof c.onNewItem)c.onNewItem(a,y[l],D)}f=new Event("filled");k.dispatchEvent(f)}else 1<b.length&&_dump("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&(d.deleteRows&&(k.innerHTML=""),l=k.innerHTML,b)){for(s in b)if(b.hasOwnProperty(s)){v=t(b[s]);x(k,v);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,v);if(c.html)l+=yAnalise(c.html,v);else for(f in v)v.hasOwnProperty(f)&&(l+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,
v[f]||""))}k.innerHTML=l;f=new Event("filled");k.dispatchEvent(f)}};ycomm.dom.getRowId=function(a,b){if(a)for(;a&&a.parentNode;)a=a.parentNode};ycomm.dom.getRowByRowNo=function(a,b){var c=document.getElementById(a);return c?c.rows[b]:null};ycomm.dom.getTableRowId=function(a,b){var c=ycomm.dom.getRowByRowNo(a,b);return c?c.id:null};
...
"calBand",d=!0),e="",1==b.cfg.orientation?y<v||y>E?C():0===b.cfg.view||1===b.cfg.view?A(0):2===b.cfg.view?A(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?A(0):2===b.cfg.view?A(1):_dumpy(8,1,"Not implemented")),""<e&&(g=q+"Cell",0===y.getDay()&&(g+=" "+q+"FreeCell"),y.getDate()==b.cfg.date.getDate()&&(g+=" "+q+"Highlight"),k=document.createElement("div"),mergeObject(B,k.style),k.id=f,k.className=g,mergeObject(B,k.style),k.date=y,l=document.createElement("span"),
l.id=f+"_tag",l.className="calTag",null!=b.cfg.callback&&(h=b.cfg.callback(b,"getTagContent",l)||"",""<h&&(e=h)),l.innerHTML=e,k.appendChild(l),null!=b.cfg.callback&&(t=b.cfg.callback(b,"getCellContent",k)||"",""<t&&(k.innerHTML+=t)),m.appendChild(k)),1==b.cfg.orientation?y.setTime(y.getTime()+x*b.context.nRows):y.setTime(y.getTime()+x),w++,w>=b.context.nCols&&(w=0,p++,d=!1,1==b.cfg.orientation&&(y=G[p])),D--;if(d){for(;w<b.context.nCols;)C();w=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
