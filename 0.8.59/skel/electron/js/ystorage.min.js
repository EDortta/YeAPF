...
for(var c in b.cfg.dataTemplate)b.cfg.dataTemplate.hasOwnProperty(c)&&(d[c]=a[c])}return d},b.sendToServer=function(a,d,c){c=c||console.warn;if(b.busy)return c("yInfoObj busy"),!1;b.busy=!0;b.cfg.onrecordcount=null;b.cfg.oncomplete=a||null;b.cfg.onprogress=d||null;var e=0;b.server.serverReady(function(){b.each(function(a){var d=b.templatedData(a);a._ts_upload=(new Date(a)).getTime()/1E3;mergeObject(b.cfg.condition,d);ycomm.crave("sync","setDocument",d,function(a,d,f){if(200==a){if("function"==typeof b.cfg.onprogress)b.cfg.onprogress(b.cfg.dbName,
f[0],++e)}else c(a+": "+d)})},function(){if("function"==typeof b.cfg.oncomplete)b.cfg.oncomplete(b.cfg.dbName);b.busy=!1},b.cfg.condition)},function(a,b){c("Erro {0} ao tentar acessar o servidor: {1}".format(a,b.message))});return!0},b.init=function(a){b.cfg.interleave=yRestTimeControl(500);b.cfg.dataTemplateEmpty="undefined"===typeof a?!0:!1;b.cfg.dataTemplate=a||{};b.cfg.db.onremove=b.onremove;b.server=yServerWatcherObj(restServer);b.cleanCondition();return b},b.init(g.dataTemplate);console.error("Since 0.8.55 the parameters or yInfoObj() has changed to (aDBSpec: {}, aServerSpec: {})");
