...
/*
    ...
    YeAPF 0.8.59-47 built on 2017-09-11 15:23 (-3 DST)
    Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com
    2017-09-11 15:23:56 (-3 DST)
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.59-47 built on 2017-09-11 15:23 (-3 DST)\n");
  ...
  echo sayStep("<div class=cpyrght><strong><big><I>skel/workbench/www/configure.php</I></big></strong><br>
    YeAPF 0.8.59-47 built on 2017-09-11 15:23 (-3 DST)<br>
    Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com<br>
    2017-09-11 15:23:56 (-3 DST)</div>");
  ...
  $ySearchPath="includes;YeAPF/includes;YeAPF/.distribution/0.8.59/includes;lib;lib/YeAPF;lib/YeAPF/includes";
    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion")) {
        if (("%"."YEAPF_VERSION%")==yeapfVersion())
          ...
          if (("0.8.59") != yeapfVersion())
            die(sayStep("<ul class=err>Your configure version is '0.8.59' while your installed version is '".yeapfVersion()." at ".yeapfBaseDir()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>"));
      }
                ...
                */
                ...
                if (function_exists("yeapfVersion"))
                  if (("%"."YEAPF_VERSION%")==yeapfVersion()) {
                    ...
                    if (("0.8.59") != yeapfVersion())
                      _yLoaderDie(true, "Your configure version is \'0.8.59\' while your installed version is \'".yeapfVersion()."\'");
                  }
                if (!isset($appName))
                  $appName = "dummy";
