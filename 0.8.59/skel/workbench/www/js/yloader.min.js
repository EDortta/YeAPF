...
break;default:c.r=a.value,c.g=g,c.b=h}c.r=Math.round(255*c.r);c.g=Math.round(255*c.g);c.b=Math.round(255*c.b)}b?(d[0]=c.r,d[1]=c.g,d[2]=c.b):d=c;return d}}},hsmColor=hsmColorBase(),xml2array=function(a){var b,c={};c.not_whitespace=new RegExp(/[^\s]/);c.parent_count=null;c.xml2array=function(a,e){var f,g,h,k="";e=e||{};a.nodeName&&"#"!=a.nodeName.charAt(0)&&1<a.childNodes.length&&(f={},k=a.nodeName);var l=a.nodeValue;a.parentNode&&a.parentNode.nodeName&&l&&c.not_whitespace.test(l)&&(f={},f[a.parentNode.nodeName]=
l);if(a.childNodes.length)if(1==a.childNodes.length)f=c.xml2array(a.childNodes[0],e);else{f||(f=[]);for(var v=l=0;v<a.childNodes.length;v++)if(h=c.xml2array(a.childNodes[v],e)){g=!1;var w=0,t=null;for(b in h)if(h.hasOwnProperty(b)&&(t=b,isNaN(b)&&(g=!0),w++,2<w))break;if(g&&1==w)if(f[t])e&&e[t]||(e[t]=0,g=f[t],f[t]={},f[t][0]=g),e[t]++,f[t][e[t]]=h[t];else{if(e[t]=0,f[t]=h[t],a.childNodes[v].attributes&&a.childNodes[v].attributes.length)for(h=0;h<a.childNodes[v].attributes.length;h++)if(g=a.childNodes[v].attributes[h].nodeName)f["attribute_"+
t+"_"+g]=a.childNodes[v].attributes[h].value}else f[l]=h,l++}}k&&f&&(h=f,f={},f[k]=h);return f};return c.xml2array(a)},utf8_decode=function(a){var b=[],c=0,d=0,e=0,f=0,g=0,h=0;for(a+="";c<a.length;)e=a.charCodeAt(c),191>=e?(b[d++]=String.fromCharCode(e),c++):223>=e?(f=a.charCodeAt(c+1),b[d++]=String.fromCharCode((e&31)<<6|f&63),c+=2):239>=e?(f=a.charCodeAt(c+1),g=a.charCodeAt(c+2),b[d++]=String.fromCharCode((e&15)<<12|(f&63)<<6|g&63),c+=3):(f=a.charCodeAt(c+1),g=a.charCodeAt(c+2),h=a.charCodeAt(c+
3),e=(e&7)<<18|(f&63)<<12|(g&63)<<6|h&63,e-=65536,b[d++]=String.fromCharCode(55296|e>>10&1023),b[d++]=String.fromCharCode(56320|e&1023),c+=4);return b.join("")},utf8_encode=function(a){if(null===a||"undefined"===typeof a)return"";a+="";var b="",c,d,e=0;c=d=0;for(var e=a.length,f=0;f<e;f++){var g=a.charCodeAt(f),h=null;if(128>g)d++;else if(127<g&&2048>g)h=String.fromCharCode(g>>6|192,g&63|128);else if(55296!=(g&63488))h=String.fromCharCode(g>>12|224,g>>6&63|128,g&63|128);else{if(55296!=(g&64512))throw new RangeError("Unmatched trail surrogate at "+
f);h=a.charCodeAt(++f);if(56320!=(h&64512))throw new RangeError("Unmatched lead surrogate at "+(f-1));g=((g&1023)<<10)+(h&1023)+65536;h=String.fromCharCode(g>>18|240,g>>12&63|128,g>>6&63|128,g&63|128)}null!==h&&(d>c&&(b+=a.slice(c,d)),b+=h,c=d=f+1)}d>c&&(b+=a.slice(c,e));return b};function utf8_to_ascii(a){var b="",c,d=a.length,e;for(c=0;c<d;c++)128>a.charCodeAt(c)?b+=a.charAt(c):(e=""+a.charCodeAt(c).toString(16),b+="\\u"+(2===e.length?"00"+e:3===e.length?"0"+e:e));return b}
...
g|a>>>32-g,c)},d=function(a,c,d,e,f,g,h){a=b(a,b(b(c&e|d&~e,f),h));return b(a<<g|a>>>32-g,c)},e=function(a,c,d,e,f,g,h){a=b(a,b(b(c^d^e,f),h));return b(a<<g|a>>>32-g,c)},f=function(a,c,d,e,f,g,h){a=b(a,b(b(d^(c|~e),f),h));return b(a<<g|a>>>32-g,c)},g=function(a){var b="",c="",d;for(d=0;3>=d;d++)c=a>>>8*d&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},h=[],k,l,v,w,t,m,q,s,p;a=this.utf8_encode(a);h=function(a){var b,c=a.length;b=c+8;for(var d=16*((b-b%64)/64+1),e=Array(d-1),f=0,g=0;g<
c;)b=(g-g%4)/4,f=g%4*8,e[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;e[b]|=128<<g%4*8;e[d-2]=c<<3;e[d-1]=c>>>29;return e}(a);m=1732584193;q=4023233417;s=2562383102;p=271733878;a=h.length;for(k=0;k<a;k+=16)l=m,v=q,w=s,t=p,m=c(m,q,s,p,h[k+0],7,3614090360),p=c(p,m,q,s,h[k+1],12,3905402710),s=c(s,p,m,q,h[k+2],17,606105819),q=c(q,s,p,m,h[k+3],22,3250441966),m=c(m,q,s,p,h[k+4],7,4118548399),p=c(p,m,q,s,h[k+5],12,1200080426),s=c(s,p,m,q,h[k+6],17,2821735955),q=c(q,s,p,m,h[k+7],22,4249261313),m=c(m,q,s,p,h[k+
8],7,1770035416),p=c(p,m,q,s,h[k+9],12,2336552879),s=c(s,p,m,q,h[k+10],17,4294925233),q=c(q,s,p,m,h[k+11],22,2304563134),m=c(m,q,s,p,h[k+12],7,1804603682),p=c(p,m,q,s,h[k+13],12,4254626195),s=c(s,p,m,q,h[k+14],17,2792965006),q=c(q,s,p,m,h[k+15],22,1236535329),m=d(m,q,s,p,h[k+1],5,4129170786),p=d(p,m,q,s,h[k+6],9,3225465664),s=d(s,p,m,q,h[k+11],14,643717713),q=d(q,s,p,m,h[k+0],20,3921069994),m=d(m,q,s,p,h[k+5],5,3593408605),p=d(p,m,q,s,h[k+10],9,38016083),s=d(s,p,m,q,h[k+15],14,3634488961),q=d(q,s,
p,m,h[k+4],20,3889429448),m=d(m,q,s,p,h[k+9],5,568446438),p=d(p,m,q,s,h[k+14],9,3275163606),s=d(s,p,m,q,h[k+3],14,4107603335),q=d(q,s,p,m,h[k+8],20,1163531501),m=d(m,q,s,p,h[k+13],5,2850285829),p=d(p,m,q,s,h[k+2],9,4243563512),s=d(s,p,m,q,h[k+7],14,1735328473),q=d(q,s,p,m,h[k+12],20,2368359562),m=e(m,q,s,p,h[k+5],4,4294588738),p=e(p,m,q,s,h[k+8],11,2272392833),s=e(s,p,m,q,h[k+11],16,1839030562),q=e(q,s,p,m,h[k+14],23,4259657740),m=e(m,q,s,p,h[k+1],4,2763975236),p=e(p,m,q,s,h[k+4],11,1272893353),s=
e(s,p,m,q,h[k+7],16,4139469664),q=e(q,s,p,m,h[k+10],23,3200236656),m=e(m,q,s,p,h[k+13],4,681279174),p=e(p,m,q,s,h[k+0],11,3936430074),s=e(s,p,m,q,h[k+3],16,3572445317),q=e(q,s,p,m,h[k+6],23,76029189),m=e(m,q,s,p,h[k+9],4,3654602809),p=e(p,m,q,s,h[k+12],11,3873151461),s=e(s,p,m,q,h[k+15],16,530742520),q=e(q,s,p,m,h[k+2],23,3299628645),m=f(m,q,s,p,h[k+0],6,4096336452),p=f(p,m,q,s,h[k+7],10,1126891415),s=f(s,p,m,q,h[k+14],15,2878612391),q=f(q,s,p,m,h[k+5],21,4237533241),m=f(m,q,s,p,h[k+12],6,1700485571),
p=f(p,m,q,s,h[k+3],10,2399980690),s=f(s,p,m,q,h[k+10],15,4293915773),q=f(q,s,p,m,h[k+1],21,2240044497),m=f(m,q,s,p,h[k+8],6,1873313359),p=f(p,m,q,s,h[k+15],10,4264355552),s=f(s,p,m,q,h[k+6],15,2734768916),q=f(q,s,p,m,h[k+13],21,1309151649),m=f(m,q,s,p,h[k+4],6,4149444226),p=f(p,m,q,s,h[k+11],10,3174756917),s=f(s,p,m,q,h[k+2],15,718787259),q=f(q,s,p,m,h[k+9],21,3951481745),m=b(m,l),q=b(q,v),s=b(s,w),p=b(p,t);return(g(m)+g(q)+g(s)+g(p)).toLowerCase()};
...
function yAnalise(a,b){if(void 0!==a){a=unmaskHTML(a);var c=/\%(|\w+)\(/gi,d,e,f,g,h;for(e="";"string"==typeof a&&0<=(d=a.search(c));)if(e=a.slice(d).search(/\(/),0<=e){f=a.slice(d+e+1,d+e+2);if('"'==f||"'"==f){h=d+e+1;do h++,g=a.slice(h,h+1);while(g!=f&&h<a.length);f=h+a.slice(h).search(/\)/)-d}else f=a.slice(d).search(/\)/);var k=a.slice(d+1,d+e);e=g=a.slice(d+e+1,d+f);g=g.split(",");for(h=0;h<g.length;h++)g[h]=yAnalise(g[h],b);e=void 0;h=g[0].toUpperCase();var l=g[0];if(void 0!==b)if(void 0==b[0])e=
b[h]?yAnalise(b[h],b):yAnalise(b[l],b);else for(var v=b.length-1;0<=v&&void 0==e;v--)void 0!=b[v][h]?e=yAnalise(b[v][h],b):void 0!=b[v][l]&&(e=yAnalise(b[v][l],b));else e="string"==eval("typeof "+l)?eval(l):yAnalise(l);void 0==e&&(e="");g[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":g=Math.max(0,parseInt(g[1]));e=str2double(e);e=e.toFixed(g);break;case "lon2deg":e=dec2deg(e,!1);break;case "lat2deg":e=dec2deg(e,
!0);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;case "tstime":e=timestamp2time(e);break;case "date":e=g[1]?UDate2Date(e,g[1]):UDate2Date(e);break;case "time":e=g[1]?UDate2Time(e,g[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "abbreviate":e=e.abbreviate(g[1]||20,g[2]||!1);break;case "words":k=e.split(" ");l=Math.max(0,str2int(g[1]));v=Math.max(k.length-1,str2int(g[2]));g=Math.max(0,str2int(g[3]));e="";
for(h=l;h<l+v;h++){var w=onlyDefinedValue(k[h]);""<w&&(e+=" "+w)}0<g&&(e=wordwrap(e,g,"<br>",!0));break;case "quoted":e=('"'+e).trim()+'"';break;case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(h=0;h<g.length;h++)""<e&&(e+=","),e+="'"+g[h]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}else{console.log("HALTING yAnalise as entering in loop");break}}else a="";return a}
...
if(b.pos<b.buf.length){if("/"==a&&"*"!=b.oneChar(1))b.oneChar(1);var e=b.optable[a];if(void 0===e)switch(b._whatis(a)){case b._ALPHA:d=b._process_identifier();a=String(d.token_string).toUpperCase();if("AND"==a||"OR"==a||"LIKE"==a)d.token_string=a,d.type="OPERATOR";break;case b._DIGIT:d=b._process_number();break;case b._QUOTE:d=b._process_quote()}else{var d=a,f=b.oneChar(1),g=b.voidToken,h=b.pos;if(b.optable[a+f])a+=f,e=b.optable[a],d=a;else if(0<="-+".indexOf(a)){var k=b.priorToken.type;if(null===
k||"OPERATOR"==k&&"L_PAREN"==b.priorToken.token)f=b._whatis(f),f==b._DIGIT?g=b._process_number():f==b._ALPHA&&(g=b._process_identifier())}d={type:g.type||"OPERATOR",token:g.token||e,pos:h,token_string:g.token_string||d};b.pos+=a.length}}else d.type="EOF",d.token=null;return b.priorToken=d},tokenTypeIs:function(a,b){return 0<=(","+b+",").indexOf(","+a.type+",")},getExpectedToken:function(a){var d=b.pos,e=b.getToken();if(b.tokenTypeIs(e,a))return e;b.pos=d;return!1},_analiseText:function(){var a,d=
b.voidToken,e,f,g;do if(g=!1,(a=b.getToken())&&"EOF"!=a.type){0<b.symStack.length&&(d=b.symStack[b.symStack.length-1]);d=d||b.voidToken;if("OPERATOR"==a.type)if(e=b.opprecedence[a.token_string]||99,f=b.opprecedence[d.token_string]||10,e<=f)d=b.symStack.pop(),b.symStack.push(a),d&&"("!=d.token_string&&b.postFixStack.push(d),g=!0;else if(")"==a.token_string){do(d=b.symStack.pop())&&"("!=d.token_string&&b.postFixStack.push(d);while(d&&"("!=d.token_string);g=!0}g||a&&("OPERATOR"==a.type?b.symStack.push(a):
b.postFixStack.push(a))}while("ERROR"!=a.type&&"EOF"!=a.type);do(d=b.symStack.pop())&&"EOF"!=d.type&&b.postFixStack.push(d);while(d&&"EOF"!=d.type)},solve:function(a){var d,e=[],f,g,h,k;for(d=0;d<b.postFixStack.length;d++)if(h=!1,f=b.postFixStack[d]){if("NUMBER"==f.type||"LITERAL"==f.type)g=f.token_string,isNumber(g)||(g=String(g).toUpperCase()),h=!0;"IDENTIFIER"==f.type&&(g=a[f.token_string],"undefined"==typeof g?(g="'"+f.token_string+"' is not defined on data",console.warn(g),g=!1):"string"==typeof g&&
(g=String(g).toUpperCase()),h=!0);if(h)e.push(g);else{k=e.pop();h=e.pop();switch((""+f.token_string).toUpperCase()){case "+":f=h+k;break;case "-":f=h-k;break;case "*":f=h*k;break;case "/":f=h/k;break;case "^":f=Math.pow(h,k);break;case ">":f=h>k;break;case "<":f=h<k;break;case ">=":f=h>=k;break;case "<=":f=h<=k;break;case "<>":case "!=":f=h!=k;break;case "==":f=h==k;break;case "AND":case "&&":f=h&&k;break;case "OR":case "||":f=h||k;break;case "LIKE":h=String(h).toUpperCase();k=String(k).toUpperCase();
f=k.replace(/\%/g,"");f="%"!=k.substr(0,1)?"%"!=k.substr(k.length-1)?h==k:h.substr(0,f.length)==f:"%"==k.substr(k.length-1,1)?0<=h.indexOf(f):h.substr(h.length-f.length)==f;break;default:throw g="'"+f.token_string+"' is not a recognized operator",console.error(g),Error();}null!==f&&e.push(f)}}return f=e.pop()},showStack:function(a){for(var b="\t",e=0;e<a.length;e++)b+=a[e].token_string+" ";console.log(b)},parse:function(){b.reset();b._analiseText();return b.stack},reset:function(){b.pos=0;b.symStack=
...
function(a){};a.displayTab=function(b,c){if(!a.changingView){a.changingView=!0;try{if(!a.locked()&&b){0>a.initialized&&a.init();_dumpy(64,1,"displayTab "+b.id);var d=!0,e=0;if(d=b.dispatchEvent(a.tabchangeEvent)||d){var f=a.getContainerFromParam(c);if(f){_dumpy(64,1,"canchange");for(var d=-1,g=!1,e=0;e<f.childs.length;e++)f.childs[e]!=b?g|=!a.hideTab(f.childs[e],b,f):d=e;_dumpy(64,1,"readytochange "+!g);if(g)_dumpy(64,1,"freeze");else{a.setCurrentContainer(a.getContainerNdx(f));f.currentTabNdx=d;
a._currentTab=b.id;b.dispatchEvent(a.tabfocusEvent);b.style.display="block";for(f=b;f&&f!=document.body;)f.style.display="block",f=f.parentNode;for(var h=b.getElementsByTagName("*"),e=0;e<h.length;){if("checkbox"==h[e].type||"radio"==h[e].type||"password"==h[e].type||"hidden"==h[e].type||"text"==h[e].type||"select-one"==h[e].type||"textarea"==h[e].type){h[e].focus();break}e++}window.dispatchEvent(a.tabshowEvent)}}}_dumpy(64,1,"return")}}finally{a.changingView=!1}}};a.showWaitIcon=function(){y$("waitIcon")&&
...
h[b],y$(fieldName)&&y$(fieldName).addClass("fieldWarning");if(d.formError){h="";for(b in d.formError)d.formError.hasOwnProperty(b)&&(""<h&&(h+="\n"),h+=d.formError[b]);alert(h)}}if(a){void 0!=d.formID&&""==formID&&(formID=d.formID);d.firstRow=parseInt(d.firstRow);d.rowCount=parseInt(d.rowCount);d.requestedRows=parseInt(d.requestedRows);h=d.rowCount;b=a.data?a.data.row:a.row;1==h&&(b=Array(b));if(b){c=[];for(var v in b)if(b.hasOwnProperty(v)){c[v]={};for(var w in b[v])b[v].hasOwnProperty(w)&&(c[v][w]=
unmaskHTML(b[v][w]))}}void 0!==a.data&&(f=a.data.geometry)}}return{data:c,geometry:f,dataContext:d,error:e,userMsg:g}};ycomm.text2data=function(a){var b={};"function"==typeof DOMParser&&(a=(new DOMParser).parseFromString(a,"application/xml"),b=ycomm.explodeData(a));return b};
...
c,!0);if(d.deleteRows)for(;0<q.rows.length;)q.deleteRow(q.rows.length-1);var D=q.rows.length%2;z=null;for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);D++;h=!0;if(!d.deleteRows&&l[e])for(k=0;h&&k<q.rows.length;k++)if(q.rows[k].id==l[e]){for(g=q.rows[k];0<g.cells.length;)g.deleteCell(0);h=!1;l.rowid=k}h&&(g=d.insertAtTop?q.insertRow(0):q.insertRow(q.rows.length));A++;l.rowid=d.insertAtTop||"undefined"===typeof g.rowIndex?A+"":g.rowIndex;l._elementid_=a;t(g);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,
l);if("undefined"==typeof c.html&&"undefined"==typeof c.rows&&"undefined"==typeof c.columns)if("string"==typeof l)m(null);else for(f in l)l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&m(f);else if("undefined"!=typeof c.columns)if(isArray(c.columns))for(p=0;p<c.columns.length;p++)m(c.columns[p]);else for(p in c.columns)c.columns.hasOwnProperty(p)&&m(p);else if("undefined"!=typeof c.html){if(x=g.insertCell(0),x.innerHTML=yAnalise(c.html,l),x.style.verticalAlign="top",x.id=a+"_"+z+"_"+q.rows.length,
"function"==typeof c.onNewItem)c.onNewItem(a,x,l)}else if("undefined"!=typeof c.rows)for(k=!0,r=0;r<c.rows.length;r++){k||(g=q.insertRow(q.rows.length),t(g));g.innerHTML=yAnalise(c.rows[r],l);if(!h&&d.deleteRows)for(p=0;p<g.cells.length;p++)g.cells[p].style.borderLeft="solid 1px red";if("function"==typeof c.onNewItem)c.onNewItem(a,g,l);k=!1}if("function"==typeof c.onNewRowReady)c.onNewRowReady(a,g)}}else if("UL"==k.nodeName){if(d.deleteRows)for(;k.firstChild;)k.removeChild(k.firstChild);for(s in b)if(b.hasOwnProperty(s)){l=
...
k.appendChild(p);if("function"==typeof c.onNewItem)c.onNewItem(a,p,l)}}else if("LISTBOX"==k.nodeName){if(d.deleteRows)for(;0<k.childElementCount;)k.childNodes[0].remove();t=0;for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);l._elementid_=a;if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,l);g=document.createElement("listitem");z=0;if("undefined"==typeof c.columns)if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in l){if(l.hasOwnProperty(f)&&f!=
e&&"rowid"!=f&&"_elementid_"!=f){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;g.appendChild(x)}}else for(f in c.columns)if(f!=e){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;g.appendChild(x)}w(g,l);k.appendChild(g);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);
...
ycomm.dom.getFormElements=function(a,b,c){b=b||{};var d=b.elementPrefixName||b.prefix||"";b=b.elementPostixName||b.postfix||"";var e={};a=this.selectElements(a);for(var f,g,h,k,l,v,w=0,t,m=0;m<a.length;m++)if(a[m].getAttribute?(k=a[m].getAttribute("editMask")||"",l=a[m].getAttribute("storageMask")||"",v=a[m].getAttribute("valueType")||"text"):(l=k="",v="text"),t=!0,g=a[m].type.toLowerCase(),f=a[m].name||a[m].id,f.substr(f.length,-b.length)==b&&f.substr(0,d.length)==d&&(f=f.substr(d.length),f=f.substr(0,
f.length-b.length),""<f)){h="";if("radio"==g||"checkbox"==g)t=!1,"undefined"==typeof e[f]&&(e[f]="");switch(g){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "search":case "tel":case "time":case "url":case "week":h=a[m].value+"";""<k&&""<l&&0<=v.indexOf("date")&&(h=(h=dateTransform(h,k,l))?h+"":"");break;case "number":case "range":h=a[m].value;isNumber(h)&&(h=h.toFloat());break;case "radio":case "checkbox":h=
a[m].checked?a[m].value:"";t=""!==h;break;case "select-one":case "select-multi":h=a[m].selectedIndex;a[m].options[h]&&(h=a[m].options[h].value);break;case "file":"function"==typeof c?(g=new FileReader,w++,g._fieldName=f,g.addEventListener("load",function(){e[this._fieldName]=this.result;w--;0>=w&&c(e)}),g.readAsDataURL(a[m].files[0]),t=!1):h="aOnReady() not present in js call to getFormElements()"}"string"==typeof h&&0<=h.indexOf(",")&&(h=encodeURIComponent(h));t&&(e[f]=h)}return e};
...
var ycommSSEBase=function(a,b,c,d,e,f){var g={pollTimeout:Math.min(6E4,Math.max("number"==typeof d?d:1E3,1E3)),prefGateway:(e||"SSE").toUpperCase(),dbgDiv:y$(f),debug:function(){for(var a=new Date,b,c=b=!1,a=pad(a.getHours(),2)+":"+pad(a.getMinutes(),2)+":"+pad(a.getSeconds(),2)+" SSE: ",d=0;d<arguments.length;d++)a+=arguments[d].trim()+" ",0<=arguments[d].toUpperCase().indexOf("ERROR")&&(b=!0),0<=arguments[d].toUpperCase().indexOf("STATUS")&&(c=!0),0<=arguments[d].toUpperCase().indexOf("WARN")&&
...
g.sse_session_id);return new Promise(function(c,d){g.debug("OUT: "+a);g.rpcMethod("_sse",a,b,function(a,b,e){200==a?c(e):d(a)},!1)})},poll:function(){g.pollEnabled&&g.rpc("peekMessage").then(function(a){if(a){g.debug("IN: data: "+JSON.stringify(a));for(var b=0;b<a.length;b++)g.dispatchEvent(a[b].event,{data:a[b].data})||g.message({data:a[b].data})}setTimeout(g.poll,g.pollTimeout)})},userAlive:function(){var a=function(a){g.debug("STATUS: User logged out");g.close(a)};g.rpc("userAlive").then(function(b){var c=
!1;b&&b[0]&&(c="CLOSE"==(b[0].event||"").toUpperCase());c?a():(g.debug("IN: User is alive"),1==g.state?setTimeout(g.userAlive,g.userAliveInterval):g.debug("Unexpected SSE state: "+g.state))}).catch(a)},attachUser:function(b){g.rpc("attachUser",{w:a,user:g.user}).then(function(c){g.debug("IN: attach info");c&&c[0]&&c[0].ok&&(g.w=a,g.sse_session_id=c[0].sse_session_id,g.userAliveInterval=Math.min(3E4,Math.max(5E3,1E3*c[0].userAliveInterval)),g.debug("userAliveInterval: "+g.userAliveInterval),b())})},
addEventListener:function(a,b){"undefined"==typeof g.events&&(g.events={});"undefined"==typeof g.events[a]&&(g.events[a]=[]);g.events[a].push([g.state,b]);1==g.state&&(g.pollEnabled||g.evtSource.addEventListener(a,b),"ready"==trim(a.toLowerCase())&&g.dispatchEvent("ready"));return g},dispatchEvent:function(a,b){var c=!1;if("undefined"!==typeof g.events)for(var d=0;d<(g.events[a]||[]).length;d++)g.events[a][d][1](b),c|=1;eventName1=a;eventName2="on_"+a;"function"==typeof g[eventName1]?(g[eventName1](b),
c|=1):"function"==typeof g[eventName2]?(g[eventName2](b),c|=1):c|=0;return c},startPolling:function(){g.pollEnabled=!0;g.state=1;g.dispatchEvent("ready",{gateway:"Polling"});setTimeout(g.poll,125);g.debug("STATUS: polling for messages. pollTimeout: {0}ms".format(g.pollTimeout))},guardianTimeout:function(a){g.debug("Guardian Timeout! Let's use polling mode");clearTimeout(g.evtGuardian);g.evtSource.close();g.evtSource=void 0;g.startPolling()},close:function(a){g.closing||(g.closing=!0,g.debug("STATUS: CLOSE"),
g.state=-1,g.pollEnabled=!1,g.dispatchEvent("onclose"),g.evtSource&&g.evtSource.close(),g.closing=!1)},open:function(a){clearTimeout(g.evtGuardian);g.debug("STATUS: OPEN");setTimeout(g.userAlive,g.userAliveInterval/100);g.dispatchEvent("onopen");ycomm.msg&&"function"==typeof ycomm.msg.notifyServerOnline&&ycomm.msg.notifyServerOnline()},error:function(a){g.debug("ERROR: while using SSE");g.dispatchEvent("onerror")},message:function(a){clearTimeout(g.evtGuardian);g.debug("MESSAGE");if(0===g.state){g.state=
1;g.debug("userAliveInterval: {0}ms".format(g.userAliveInterval));for(var b in g.events)if(g.events.hasOwnProperty(b))for(var c=0;c<g.events[b].length;c++){var d=g.events[b][c];1>d[0]&&(d[0]=1,g.evtSource.addEventListener(b,d[1]))}g.dispatchEvent("onready",{gateway:"SSE"})}if("function"==typeof g.onmessage)g.onmessage(a.data)},startup:function(a){a=(a||g.prefGateway||"SSE").toUpperCase();g.prefGateway=a;g.evtGuardian&&clearTimeout(g.evtGuardian);g.attachUser(function(){g.state=0;"SSE"==g.prefGateway&&
"function"==typeof window.EventSource?(g.debug("INFO: Attaching events"),g.evtSource||(g.evtSource=new EventSource(g._dataLocation_+"?si="+md5(g.sse_session_id))),g.evtSource.onopen=g.open,g.evtSource.onclose=g.close,g.evtSource.onmessage=g.message,g.evtSource.addEventListener("error",g.error,!1),g.debug("INFO: Configuring guardianTimeout"),g.evtGuardian=setTimeout(g.guardianTimeout,3E4)):g.startPolling()})},init:function(){g.state=-1;if("undefined"==typeof c||null===c){var a=g,d;d=g.getLocation();
var e=d.lastIndexOf("/");d=d.substr(0,e+1)+"sse.php";a._dataLocation_=d}else g._dataLocation_=c;"file:"==g._dataLocation_.substr(0,5)?g.debug("ERROR: '"+g._dataLocation_+"' is not a correct data location"):(g.user=null!==b&&"undefined"!=typeof b?b:generateUUID(),a=g.getFolder(g.getLocation()),d=g.getFolder(g._dataLocation_),g.rpcMethod=a==d?ycomm.invoke:ycomm.crave,g.startup());return g}};return g.init()};_dump("ycomm-sse");
...
"calBand",d=!0),e="",1==b.cfg.orientation?y<A||y>D?C():0===b.cfg.view||1===b.cfg.view?B(0):2===b.cfg.view?B(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?B(0):2===b.cfg.view?B(1):_dumpy(8,1,"Not implemented")),""<e&&(g=q+"Cell",0===y.getDay()&&(g+=" "+q+"FreeCell"),y.getDate()==b.cfg.date.getDate()&&(g+=" "+q+"Highlight"),k=document.createElement("div"),mergeObject(x,k.style),k.id=f,k.className=g,mergeObject(x,k.style),k.date=y,l=document.createElement("span"),
l.id=f+"_tag",l.className="calTag",null!=b.cfg.callback&&(h=b.cfg.callback(b,"getTagContent",l)||"",""<h&&(e=h)),l.innerHTML=e,k.appendChild(l),null!=b.cfg.callback&&(v=b.cfg.callback(b,"getCellContent",k)||"",""<v&&(k.innerHTML+=v)),p.appendChild(k)),1==b.cfg.orientation?y.setTime(y.getTime()+w*b.context.nRows):y.setTime(y.getTime()+w),t++,t>=b.context.nCols&&(t=0,m++,d=!1,1==b.cfg.orientation&&(y=G[m])),F--;if(d){for(;t<b.context.nCols;)C();t=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
...
function calcGridAddItem(a,b,c,d,e,f,g,h,k,l){void 0==h&&(h=!1);void 0==k&&(k="");void 0==l&&(l="2");var v=!0,w=e.split(",");if(!h)for(var t in w)w.hasOwnProperty(t)&&void 0==b[w[t]]&&(v=!1);v?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=g,a[c].units=k,a[c].decimalPlaces=l):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
function fillTable(a,b,c,d,e,f,g,h,k){ycomm.invoke("yeapfDB","doSQL",{sql:'"'+b+'"'},function(b,h,k){console.log(b,a);b=c.split(",");h="";for(var t=0;t<b.length;t++)h+='<td><a href="{1}">%({0})</a></td>'.format(b[t],d);ycomm.dom.fillElement(a,k,{onNewItem:f,rows:[h],inplaceData:[e],onNewItem:f,onReady:g})})}function getCheckboxTable(a){return y$(a).parentElement?y$(a).parentElement.parentElement:null}
