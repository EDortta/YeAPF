...
(function(){window.ystorage||(window.ystorage=function(){var g=[],h={},a={};Object.defineProperty(h,"getItem",{value:function(b){return b?a[b]:null},writable:!1,configurable:!1,enumerable:!1});Object.defineProperty(h,"key",{value:function(b){return g[b]},writable:!1,configurable:!1,enumerable:!1});Object.defineProperty(h,"setItem",{value:function(b,a){b&&(document.cookie=escape(b)+"="+escape(a)+"; expires=Tue, 19 Jan 2038 03:14:07 GMT; path=/")},writable:!1,configurable:!1,enumerable:!1});Object.defineProperty(h,
"length",{get:function(){return g.length},configurable:!1,enumerable:!1});Object.defineProperty(h,"removeItem",{value:function(b){b&&(document.cookie=escape(b)+"=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/")},writable:!1,configurable:!1,enumerable:!1});a.get=function(){var b,a;for(a in h)b=g.indexOf(a),-1===b?h.setItem(a,h[a]):g.splice(b,1),delete h[a];for(;0<g.length;g.splice(0,1))h.removeItem(g[0]);for(var c=0,e=document.cookie.split(/\s*;\s*/);c<e.length;c++)b=e[c].split(/\s*=\s*/),1<b.length&&
(h[a=unescape(b[0])]=unescape(b[1]),g.push(a));return h};a.configurable=!1;a.enumerable=!0;return a}());window.ySingleDb||(console.log("Creating ySingleDb ... "),window.ySingleDb=function(g,h){var a={_list:null,toBinArray:function(b){for(var a=(b||"").length,c=new Uint8Array(a),e=0;e<a;e++)c[e]=b.charCodeAt(e);return c},toBinString:function(b){b=new Uint8Array(b);for(var a=[],c=0;65535*c<b.length;c++)a.push(String.fromCharCode.apply(null,b.subarray(65535*c,65535*(c+1))));return a.join("")},setItem:function(b,
d,c){var e,f,k;b=String(b);d._id=d._id||generateUUID();d._ts_update=(new Date).getTime()/1E3;if(isArray(c)&&(k=a.getItem(b),!isEmpty(k)))for(e=0;e<c.length;e++)"undefined"!==typeof k[c[e]]&&(d[c[e]]=k[c[e]]);if(d._linked){for(e=0;e<d._linked.length;e++)delete d[d._linked[e]];delete d._linked}for(f in d)d.hasOwnProperty(f)&&"_"!=f.substr(0,1)&&isArray(d[f])&&(d[f]=JSON.stringify(d[f]));localStorage.setItem(a._dbTag_+"_item_"+b,JSON.stringify(d));-1==a._list.indexOf(b)&&(a._list[a._list.length]=b,localStorage.setItem(a._dbTag_+
...
b)},blankList:function(){a.cleanList(!1)},init:function(b,d){a._dbTag_=b;a._keyName_=d||"_id";console.log("ystorage: creating "+b);a._list=localStorage.getItem(a._dbTag_+"_list");"string"==typeof a._list&&(a._list=JSON&&JSON.parse(a._list)||[]);a._list=a._list||[];return a}};return a.init(g,h)},console.log("ystorage ready!"));window.yIndexedDB||(window.indexedDB||(window.indexedDB=window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB),window.IDBTransaction=window.IDBTransaction||window.webkitIDBTransaction||
window.msIDBTransaction,window.IDBKeyRange=window.IDBKeyRange||window.webkitIDBKeyRange||window.msIDBKeyRange,window.yIndexedDB=function(g,h,a){var b={_newTransaction:function(a,c,e){e=e||function(b){0!==b&&k&&(k=!1,"function"==typeof c&&c(520,b,[{}]))};a=b._db.transaction([b._dbTag_],"readwrite");var f,k=!0;a.oncomplete=function(){f=0;"function"==typeof e&&e(f)};a.onerror=function(){f=1;"function"==typeof e&&e(f)};return a.objectStore(b._dbTag_)},count:function(a){var c=b._newTransaction("readonly").count();
c.onsuccess=function(){"function"==typeof a&&a(200,0,[c.result])}},setItem:function(a,c,e){a=!1;if(3==b.status){c._id=c._id||generateUUID();c._ts_update=(new Date).getTime()/1E3;var f=b._newTransaction("readwrite",e).put(c);f.onsuccess=function(){"function"==typeof e&&e(200,0,[f.result])};a=!0}return a},getItem:function(a,c){var e=!1;if(3==b.status){var f=b._newTransaction("readonly",c).get(a);f.onsuccess=function(){"function"==typeof c&&c(200,0,[f.result])};e=!0}return e},insertData:function(a,c,
e){c=!1;if(3==b.status){c=b._newTransaction("readwrite",e);for(var f=0,k=0,l=0;a&&l<a.length;l++){var g=a[l];g._id=g._id||generateUUID();g._ts_update=(new Date).getTime()/1E3;g=c.put(g);g.onsuccess=function(b){b=b.target;f++;f+k>=a.length&&"function"==typeof e&&e(200,{errorCount:k},[b.result])};g.onerror=function(b){k++;f+k>=a.length&&"function"==typeof e&&e(200,{errorCount:k},[{}])}}c=!0}return c},filter:function(a,c,e,f){if(3==b.status){var g=function(a){0===a&&"function"==typeof c&&c()};if("function"==
typeof a){e=e||!0;var l=!1;if(!0===e)l=!0;else{var h=yLexObj(e);h.parse()}e=b._newTransaction("readonly",void 0,g).openCursor();e.onsuccess=function(b){var c=b.target.result;c&&((b=l||h.solve(c.value))&&a(c.value),f||c.continue())};e.onerror=function(){}}else g(0)}},slice:function(a,c,e,f,g){if(3==b.status){var l=function(a){0===a&&"function"==typeof c&&c()};if("function"==typeof a){var l=b._newTransaction("readonly",void 0,l).openCursor(),h=0;e=Math.max(0,e);l.onsuccess=function(b){if(b=b.target.result)h<
e?(h=e,console.log("Advancing to {0}".format(e)),0<e&&b.advance(e)):(h++,h<=f&&("function"===typeof a&&a(b.value),g||h<f&&b.continue()))};l.onerror=function(){}}else l(0)}},removeItem:function(a,c){var e=!1;if(3==b.status){var f=b._newTransaction("readonly",c).delete(a);f.onsuccess=function(){"function"==typeof c&&c(200,0,f.result)};e=!0}return e},onDBRequestError:function(a){b._status=-1;console.error("yIndexedDB error trying to open '{0}'".format(g))},onDBRequestSuccess:function(d){b._status=3;
...
c?0<parseInt(f.pong||0)&&(c=(new Date).getTime()-d,console.log("Server ready..."),console.log("Wasted time: {0}ms".format(c)),ycomm.wd_interval=4*c,"function"==typeof a&&a()):"function"==typeof b&&b(c,e)})},init:function(){ycomm.setDataLocation(g);h.serverReady(function(){console.log("Server ready!")});return h}};return h.init()});window.yInfoObj||(window.yInfoObj=function(g,h){var a={};if("object"==typeof g&&"string"==typeof g.dbName)return a.cfg={db:ySingleDb(g.dbName,g.keyName),garbage:ySingleDb(g.dbName+
