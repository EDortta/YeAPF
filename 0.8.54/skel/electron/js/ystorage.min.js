...
typeof a&&(c=null):c=a=null;if(c){var b={db:c,linkage:a||null};d._siblingDB=d._siblingDB||[];d._siblingDB.push(b)}},filter:function(c,a,b,f){if("function"==typeof c){b=yLexObj(b||!0);b.parse();var h,m=d.getList(),e,k;for(h=0;h<m.length;h++)if(e=d.getItem(m[h]),k=b.solve(e))c(e),f&&(h=m.length+1)}"function"==typeof a&&a()},each:function(c,a,b,f){var h=function(a,b){b=String(b).split(" ");var c=!0,d,f;for(d in b)f=trim(b[d]),c=isNumber(f)&&isNumber(a)?c&&parseFloat(f)===parseFloat(a):c&&0<=(""+a).toUpperCase().indexOf(f.toUpperCase());
return c},e,n=d.getList(),k,g;for(e=0;e<n.length;e++)if("function"==typeof c){k=d.getItem(n[e]);g="undefined"==typeof b;if(!g)if("string"==typeof b)g=h(k[d.cfg.keyName],b);else if("object"==typeof b){g=!0;for(var l in b)b.hasOwnProperty(l)&&(g="undefined"!==typeof k[l]?g&&h(k[l],b[l]):!1)}g&&(c(k),f&&(e=n.length+1))}"function"==typeof a&&a()},insertData:function(c){for(var a in c)c.hasOwnProperty(a)&&d.setItem(c[a][d._keyName_],c[a])},count:function(c){var a=0;d.each(function(){a++},null,c);return a},
