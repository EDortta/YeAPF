...
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.54-1 built on 2017-01-31 11:51 (-2 DST)\n");
  ...
  echo "<div class=cpyrght><strong><big><I>tools/yDoc/configure.php</I></big></strong><br>
    YeAPF 0.8.54-1 built on 2017-01-31 11:51 (-2 DST)<br>
    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion"))
        if (("0.8.54") != yeapfVersion())
          die("<ul class=err>Your configure version is '0.8.54' while your installed version is '".yeapfVersion()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>");
