/* YeAPF 0.8.50-44 built on 2016-10-03 11:28 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.50-44 built on 2016-10-03 11:28 (-3 DST)");
...
"undefined"==typeof Date.prototype.monthLastDOW&&(Date.prototype.monthLastDOW=function(a){a=new Date((a||this).getTime());a.setDate(that.lastDay(a));return a.getDay()});"undefined"==typeof Date.prototype.nextMonth&&(Date.prototype.nextMonth=function(){var a=this.getMonth();this.setMonth(a+1);this.getMonth()!=a+1&&0!==this.getMonth()&&this.setDate(0)});
