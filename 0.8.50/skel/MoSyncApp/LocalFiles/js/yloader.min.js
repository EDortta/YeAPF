/* YeAPF 0.8.50-35 built on 2016-09-19 16:59 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.50-35 built on 2016-09-19 16:59 (-3 DST)");
...
function wordwrap(a,b,c,d){c=c||"\n";b=b||75;return a?a.match(RegExp(".{1,"+b+"}(\\s|$)"+(d?"|.{"+b+"}|.+$":"|\\S+?(\\s|$)"),"g")).join(c):a}function nl2br(a){var b="";void 0!==a&&(b=a.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2"));return b}function dec2deg(a,b){b=b||!0;var c=0<Math.sign(a),d=parseInt(a),e,f=60*(a-1*d);e=f-1*parseInt(f);f=parseInt(f);e=parseInt(60*e);return d+"&deg; "+f+"' "+e+"'' "+(b?c?"N":"S":c?"E":"W")}
