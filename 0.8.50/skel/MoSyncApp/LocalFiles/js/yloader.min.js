/* YeAPF 0.8.50-21 built on 2016-09-01 09:31 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.50-21 built on 2016-09-01 09:31 (-3 DST)");
...
"function"!==typeof Object.copyObj&&(Object.prototype.copyObj=function(){var a;try{a=JSON.stringify(this)}catch(b){a={}}return JSON.parse(a)});Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=c);d<c;d++)if(d in this&&this[d]===a)return d;return-1});
...
break;case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(g=0;g<h.length;g++)""<e&&(e+=","),e+="'"+h[g]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}}else a="";return a}
...
var yRestTimeControl=function(a){var b={setRestTime:function(a){b._restTime=min(max(125,a),144E5)},adjustRestTime:function(a){a=(new Date).getTime()-a;b.setRestTime(b._restTime-(b._restTime-a)/2)},init:function(){b.setRestTime(a);Object.defineProperty(b,"restTime",{get:function(){return b._restTime},set:b.setRestTime});return b}};return b.init()},ycommBase=function(){var a={urlCodification:{"%20":" ","%21":"!","%2A":"*","%27":"'","%28":"(","%29":")","%3B":";","%3A":":","%40":"@","%26":"&","%3D":"=",
"%2B":"+","%24":"$","%2C":",","%2F":"/","%3F":"?","%23":"#","%5B":"[","%5D":"]"},_AsyncMode:!0,_dummyWaitIconControl:function(){},setAsyncMode:function(a){void 0===a&&(a=!0);_AsyncMode=a},xq_urlEncode:function(b,c){"undefined"==typeof c&&(c=!0);if("string"==typeof b&&""<b){b=b.replace(/%/g,"%25");b=b.replace(/,/g,"\\,");for(var d in a.urlCodification)if(a.urlCodification.hasOwnProperty(d)){var e=new RegExp(escapeRegExp(a.urlCodification[d]),"g");b=b.replace(e,d)}"'"!=b.substring(0,1)&&'"'!=b.substring(0,
...
"ycomm.pinger.pong");a.pinger.pingerWatchdog=setTimeout(a.pinger.notAnswer,a.pinger.pingTimeout)},stopPing:function(){a.pinger.pingerWatchdog&&clearTimeout(a.pinger.pingerWatchdog);_dumpy(4,1,"stop pinging");a.pinger.canPing=!1}}};a.setWaitIconControl();return a},ycomm=ycommBase();_dump("ycomm");
