/* YeAPF 0.8.50-56 built on 2016-10-04 16:59 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.50-56 built on 2016-10-04 16:59 (-3 DST)");
...
(c|~e),f),h));return b(a<<g|a>>>32-g,c)},h=function(a){var b="",c="",d;for(d=0;3>=d;d++)c=a>>>8*d&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},g=[],k,p,w,v,t,l,q,m,s;a=this.utf8_encode(a);g=function(a){var b,c=a.length;b=c+8;for(var d=16*((b-b%64)/64+1),e=Array(d-1),f=0,g=0;g<c;)b=(g-g%4)/4,f=g%4*8,e[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;e[b]|=128<<g%4*8;e[d-2]=c<<3;e[d-1]=c>>>29;return e}(a);l=1732584193;q=4023233417;m=2562383102;s=271733878;a=g.length;for(k=0;k<a;k+=16)p=l,w=q,
v=m,t=s,l=c(l,q,m,s,g[k+0],7,3614090360),s=c(s,l,q,m,g[k+1],12,3905402710),m=c(m,s,l,q,g[k+2],17,606105819),q=c(q,m,s,l,g[k+3],22,3250441966),l=c(l,q,m,s,g[k+4],7,4118548399),s=c(s,l,q,m,g[k+5],12,1200080426),m=c(m,s,l,q,g[k+6],17,2821735955),q=c(q,m,s,l,g[k+7],22,4249261313),l=c(l,q,m,s,g[k+8],7,1770035416),s=c(s,l,q,m,g[k+9],12,2336552879),m=c(m,s,l,q,g[k+10],17,4294925233),q=c(q,m,s,l,g[k+11],22,2304563134),l=c(l,q,m,s,g[k+12],7,1804603682),s=c(s,l,q,m,g[k+13],12,4254626195),m=c(m,s,l,q,g[k+14],
17,2792965006),q=c(q,m,s,l,g[k+15],22,1236535329),l=d(l,q,m,s,g[k+1],5,4129170786),s=d(s,l,q,m,g[k+6],9,3225465664),m=d(m,s,l,q,g[k+11],14,643717713),q=d(q,m,s,l,g[k+0],20,3921069994),l=d(l,q,m,s,g[k+5],5,3593408605),s=d(s,l,q,m,g[k+10],9,38016083),m=d(m,s,l,q,g[k+15],14,3634488961),q=d(q,m,s,l,g[k+4],20,3889429448),l=d(l,q,m,s,g[k+9],5,568446438),s=d(s,l,q,m,g[k+14],9,3275163606),m=d(m,s,l,q,g[k+3],14,4107603335),q=d(q,m,s,l,g[k+8],20,1163531501),l=d(l,q,m,s,g[k+13],5,2850285829),s=d(s,l,q,m,g[k+
2],9,4243563512),m=d(m,s,l,q,g[k+7],14,1735328473),q=d(q,m,s,l,g[k+12],20,2368359562),l=e(l,q,m,s,g[k+5],4,4294588738),s=e(s,l,q,m,g[k+8],11,2272392833),m=e(m,s,l,q,g[k+11],16,1839030562),q=e(q,m,s,l,g[k+14],23,4259657740),l=e(l,q,m,s,g[k+1],4,2763975236),s=e(s,l,q,m,g[k+4],11,1272893353),m=e(m,s,l,q,g[k+7],16,4139469664),q=e(q,m,s,l,g[k+10],23,3200236656),l=e(l,q,m,s,g[k+13],4,681279174),s=e(s,l,q,m,g[k+0],11,3936430074),m=e(m,s,l,q,g[k+3],16,3572445317),q=e(q,m,s,l,g[k+6],23,76029189),l=e(l,q,m,
s,g[k+9],4,3654602809),s=e(s,l,q,m,g[k+12],11,3873151461),m=e(m,s,l,q,g[k+15],16,530742520),q=e(q,m,s,l,g[k+2],23,3299628645),l=f(l,q,m,s,g[k+0],6,4096336452),s=f(s,l,q,m,g[k+7],10,1126891415),m=f(m,s,l,q,g[k+14],15,2878612391),q=f(q,m,s,l,g[k+5],21,4237533241),l=f(l,q,m,s,g[k+12],6,1700485571),s=f(s,l,q,m,g[k+3],10,2399980690),m=f(m,s,l,q,g[k+10],15,4293915773),q=f(q,m,s,l,g[k+1],21,2240044497),l=f(l,q,m,s,g[k+8],6,1873313359),s=f(s,l,q,m,g[k+15],10,4264355552),m=f(m,s,l,q,g[k+6],15,2734768916),
q=f(q,m,s,l,g[k+13],21,1309151649),l=f(l,q,m,s,g[k+4],6,4149444226),s=f(s,l,q,m,g[k+11],10,3174756917),m=f(m,s,l,q,g[k+2],15,718787259),q=f(q,m,s,l,g[k+9],21,3951481745),l=b(l,p),q=b(q,w),m=b(m,v),s=b(s,t);return(h(l)+h(q)+h(m)+h(s)).toLowerCase()};
...
typeof c.onNewItem)c.onNewItem(a,x,p);s+=1;h.appendChild(x)}k.appendChild(h);v++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.options.remove(0);s=0;for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);p._elementid_=a;v="";if("undefined"==typeof c.columns)if("string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in p)p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(v+=p[f]);else if(isArray(c.columns))for(m=
0;m<c.columns.length;m++)v=v+p[c.columns[m]]+" ";else if("string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(v+=p[f]);t=document.createElement("option");"undefined"!=typeof p[e]&&(t.value=p[e]);t.innerHTML=v;t.id=a+"_"+s;if(c.inplaceData)for(m=0;m<c.inplaceData.length;m++)"undefined"!==typeof p[c.inplaceData[m]]&&t.setAttribute("data_"+c.inplaceData[m],p[c.inplaceData[m]]);if("function"==typeof c.onNewItem)c.onNewItem(a,t,p);k.appendChild(t);
s++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var B,A;x=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(var C=w(b[0]||b),t=c.elementPrefixName||c.prefix||"",z=c.elementPostixName||c.postfix||"",k=0;k<x.length;k++){if(v=x[k].getAttribute("editMask"),m=x[k].getAttribute("storageMask"),p=x[k].getAttribute("valueType")||"text",B=suggestKeyName(C,x[k].name||x[k].id,t,z),f=c.columns&&suggestKeyName(c.columns,x[k].name||x[k].id)||null,"undefined"!=
typeof C[B]&&(A=unmaskHTML(C[B]),B=x[k].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(p=c.columns[f].type,v=c.columns[f].editMask||v,m=c.columns[f].storageMask||m);"text"!=p&&(""<v&&""<m?0<=p.indexOf("date")&&(A=dateTransform(A,m,v)):A=yAnalise("%"+p+"("+A+")"));switch(B){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "number":case "range":case "search":case "tel":case "time":case "url":case "week":x[k].value=
...
p:["http://","https://","ws://","wss://","ftp://"],mn:"James John Robert Michael William David Richard Charles".split(" "),fn:"Mary Patricia Linda Barbara Elizabeth Jennifer Maria Susan".split(" "),sn:"Smith Jones Taylor Williams Brown Davies Evans Wilson".split(" "),ch:"qwertyuiopasdfghjklzxcvbnmQAZWSXEDCRFVTGBYHNUJMIKOLP0123456789"};
ycomm.dom.testFormWithJunk=function(a){a=this.selectElements(a);var b,c,d,e,f,h=function(a,b,c){var d="";for(c=Math.floor(Math.random()*c+b);d.length<c;)b=Math.floor(Math.random()*a.length),d+=a[b];return d},g=function(a,b){return Math.floor(Math.random()*b+a)},k=function(a){var b=!1;a=a.toUpperCase();for(var c=0;c<lClasses.length;c++)b=b||0<=lClasses[c].indexOf(a);return b};for(b=0;b<a.length;b++){c=a[b].type.toLowerCase();d=a[b].id;f=a[b].getAttribute("maxlength")||100;lClasses=a[b].classList;for(e=
0;e<lClasses.length;e++)lClasses[e]=lClasses[e].toUpperCase();e="";if(d){switch(c){case "password":e=h(ycomm.dom._scratch.ch,6,15);break;case "textarea":e=h(ycomm.dom._scratch.t,1,15*f);break;case "email":e=h(ycomm.dom._scratch.mn,1,2)+"@"+h(ycomm.dom._scratch.d,1,1);break;case "date":e="{0}-{1}-{2}".format(g(1850,2050),g(1,12),g(1,28));break;case "color":case "datetime":case "datetime-local":case "month":e=g(1,12);break;case "number":case "range":e=g(1,100);break;case "search":case "tel":case "time":case "week":e=
g(1,52);break;case "url":e=h(ycomm.dom._scratch.p,1,1)+h(ycomm.dom._scratch.d,1,1)+".xyz";break;case "radio":case "checkbox":break;case "select-one":case "select-multi":break;default:e=k("cpf")?e.gerarCPF():k("cnpj")?e.gerarCNPJ():h(ycomm.dom._scratch.t,1,f),e=e.substr(0,f)}y$(d).value=e}}};
