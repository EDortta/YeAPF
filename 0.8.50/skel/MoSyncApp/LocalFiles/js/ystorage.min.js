...
c)},removeItem:function(c){if("function"==typeof a.onremove)a.onremove(a.getItem(c));localStorage.removeItem(a._dbTag_+"_item_"+c);c=a._list.indexOf(String(c));-1<c&&(a._list.splice(c,1),localStorage.setItem(a._dbTag_+"_list",JSON.stringify(a._list)))},cleanList:function(){var c=[],e=0,b;for(b in a._list)c[e++]=a._list[b];for(e=0;e<c.length;e++)a.removeItem(c[e])},init:function(c){a._dbTag_=c;console.log("ystorage: creating "+c);a._list=localStorage.getItem(a._dbTag_+"_list");"string"==typeof a._list&&
(a._list=JSON&&JSON.parse(a._list)||[]);a._list=a._list||[];return a}};return a.init(g)},console.log("ystorage ready!"));
