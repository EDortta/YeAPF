/* YeAPF 0.8.50-60 built on 2016-10-04 17:10 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.50-60 built on 2016-10-04 17:10 (-3 DST)");
...
ycomm.dom.testFormWithJunk=function(a){a=this.selectElements(a);var b,c,d,e,f,h=function(a,b,c){var d="";for(c=Math.floor(Math.random()*c+b);d.length<c;)b=Math.floor(Math.random()*a.length),d+=a[b];return d},g=function(a,b){return Math.floor(Math.random()*(b-a)+a)},k=function(a){var b=!1;a=a.toUpperCase();for(var c=0;c<lClasses.length;c++)b=b||0<=lClasses[c].indexOf(a);return b};for(b=0;b<a.length;b++){c=a[b].type.toLowerCase();d=a[b].id;f=a[b].getAttribute("maxlength")||100;lClasses=a[b].className.split(" ");
