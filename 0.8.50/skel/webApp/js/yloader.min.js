/* YeAPF 0.8.50-63 built on 2016-10-10 19:00 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.50-63 built on 2016-10-10 19:00 (-3 DST)");
...
g(1,52);break;case "url":e=h(ycomm.dom._scratch.p,1,1)+h(ycomm.dom._scratch.d,1,1)+".xyz";break;case "radio":case "checkbox":break;case "select-one":case "select-multi":break;default:e=k("cpf")?e.gerarCPF():k("cnpj")?e.gerarCNPJ():k("ie")?h(ycomm.dom._scratch.n,6,12):h(ycomm.dom._scratch.t,1,f),e=e.substr(0,f)}y$(d).value=e}}};
