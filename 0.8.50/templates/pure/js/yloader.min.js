/* YeAPF 0.8.47-25 built on 2016-02-02 16:38 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();
function getInternetExplorerVersion(){var a=-1;"Microsoft Internet Explorer"==navigator.appName&&null!=/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)&&(a=parseFloat(RegExp.$1));return a}function isInternetExplorer(){return 0<=getInternetExplorerVersion()}function isOnMobile(){var a=!1;"undefined"!=typeof mosync&&(a=mosync.isAndroid||mosync.isIOS||mosync.isWindowsPhone);return a}ydbg=function(){return{logLevel:0,logFlag:0}};
function _dump(){var a="",b;for(b=0;b<arguments.length;b++)""<a&&(a+=", "),a+=arguments[b];b=a;isOnMobile()?mosync.rlog(b):console.log(b);if("undefined"!=typeof jsDumpEnabled&&jsDumpEnabled){var a="<b>"+arguments.callee.caller.name+"</b> <small>"+a+"</small>",c=__getMainBody();"function"==typeof c.$&&null!=c.document.body?(b=c.y$("debug"),b||(b=c.document.createElement("div"),b.id="debug",b.className="debug",setOpacity(b,60),b.onmouseover=__debugMouseOver,b.onmouseout=__debugMouseOut,c.document.body.appendChild(b)),
""==b.innerHTML?b.innerHTML="<b>YeAPF!</b>":(c=b.innerHTML,c=c.split("<br>"),c=c.splice(Math.max(0,c.length-50)),c=c.join("<br>"),b.innerHTML=c),b.innerHTML+="<br>"+a,b.scrollTop=b.scrollHeight):(a=a.replace("<small>","\n    "),a=a.replace("</small>","\n"),a=a.replace("<b>",""),a=a.replace("</b>",""),alert(a))}}function _setLogLevel(a){}function _dumpY(a,b){for(var c="",d=2;d<arguments.length;d++)""<c&&(c+=", "),c+=arguments[d]}
...
(y$=function(a){var b=null;""<a&&("#"==a.substr(0,1)&&(a=a.substr(1)),(b=document.getElementById(a))||(b=document.getElementsByName(a)[0]),b||("."==a.substr(0,1)&&(a=a.substr(1)),a=getElementsByClassName(document,"*",a),0<a.length&&(b=a)));return b})();"undefined"==typeof $&&($=y$);
...
function $frameOwner(a,b){_searchFunctionInFrame_=function(a,b,c){var g;if(eval("typeof f."+a+"=='"+b+"'"))g=c;else{var h=0;if(c.frames)for(;h<c.frames.length&&void 0===g;)g=_searchFunctionInFrame_(a,b,c.frames[h++])}return g};var c=$frame("/");return _searchFunctionInFrame_(a,b,c)}
...
function getElementsByAttribute(a,b,c,d){a="*"==b&&a.all?a.all:a.getElementsByTagName(b);b=[];for(var e="undefined"!=typeof d?new RegExp("(^|\\s)"+d+"(\\s|$)","i"):null,f,g,h=0;h<a.length;h++)f=a[h],g=f.getAttribute&&f.getAttribute(c),"string"==typeof g&&0<g.length&&("undefined"==typeof d||e&&e.test(g))&&b.push(f);return b}
function getElementsByClassName(a,b,c){a="*"==b&&a.all?a.all:a.getElementsByTagName(b);b=[];for(var d,e=0;e<a.length;e++)(d=a[e])&&"function"==typeof d.hasClass&&d.hasClass(c)&&b.push(d);return b}var getClientSize=function(){var a=document&&document.documentElement?document.documentElement:{clientWidth:800,clientHeight:600},b=window?window:{innerWidth:800,innerHeight:600},c=Math.max(a.clientWidth,b.innerWidth||0),a=Math.max(a.clientHeight,b.innerHeight||0);return[c,a]};
...
function FDate2UDate(a){a=0<a.indexOf("/")?a.split("/"):a.split("-");var b=a[2],b=b.split(" ");a[2]=b[0];b=b[1];void 0===b&&(b="00:00:00");b=b.split(":");void 0===b[1]&&(b[1]=0);void 0===b[2]&&(b[2]=0);return pad(a[2],4)+"-"+pad(a[1],2)+"-"+pad(a[0],2)+" "+pad(b[0],2)+":"+pad(b[1],2)+":"+pad(b[2],2)}function UDate2JSDate(a){a=extractDateValues(a,"yyyymmddHHMMSS");var b=new Date;b.setFullYear(a.y);b.setMonth(a.m-1);b.setDate(a.d);b.setHours(a.H);b.setMinutes(a.M);return b}
function UDate2Date(a,b){"undefined"===typeof b&&(b="d/m/y");var c="",d=extractDateValues(a,"yyyymmddHHMMSS");d&&(c="");for(var e=0;e<b.length;e++)c=/^[d,m,y]+$/.test(b[e])?c+d[b[e]]:c+b[e];return c}function UDate2Time(a,b){"undefined"===typeof b&&(b="H:M:S");var c="",d=extractDateValues(a,"yyyymmddHHMMSS");if(d)for(var c="",e=0;e<b.length;e++)c=/^[H,M,S]+$/.test(b[e])?c+d[b[e]]:c+b[e];return c}
...
function timestamp2IBDate(a){a=timestamp2date(a);return a=date2IBDate(a)}var dateTransform=function(a,b,c){if(a){a=extractDateValues(a,b);b={};extractDateValues("111111111111",c,b);for(var d=0;d<b.elems.length;d++){var e=b.elems[d];if(null!==e[0]){for(var f=pad(a[e[2]],e[3]);c.length<e[0]+e[3];)c+=" ";c=c.substr(0,e[0])+f+c.substr(e[0]+e[3],c.length)}}return c}return null};function isInfinity(a){return void 0!==a?a.POSITIVE_INFINITY||a.NEGATIVE_INFINITY||"Infinity"==a:!0}
function isNumber(a){return!isNaN(parseFloat(a))&&isFinite(a)}var isArray=function(a){return a&&"object"===typeof a&&"number"===typeof a.length&&"function"===typeof a.splice&&!a.propertyIsEnumerable("length")};function isEmail(a){a=a&&a.unquote()||"";return/^(([^\*<>()[\]\\.,;:\s@\"]+(\.[^\*<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(a)}function pad(a,b){for(var c=""+a;c.length<b;)c="0"+c;return c}
...
function maskHTML(a){a=a||"";if("string"==typeof a){for(;0<=a.indexOf("<");)a=a.replace(/\</,"[");for(;0<=a.indexOf(">");)a=a.replace(/\>/,"]");for(;0<=a.indexOf("&");)a=a.replace("&","!!")}return a}function trim(a){return a.replace(/^\s+|\s+$/g,"")}function unparentesis(a){1<a.length&&("("==a.substring(0,1)||"["==a.substring(0,1)||"{"==a.substring(0,1))&&(a=a.substring(1,a.length-1));return a}
...
var xml2array=function(a){var b,c={};c.not_whitespace=new RegExp(/[^\s]/);c.parent_count=null;c.xml2array=function(a,e){var f,g,h,k="";e=e||{};a.nodeName&&"#"!=a.nodeName.charAt(0)&&1<a.childNodes.length&&(f={},k=a.nodeName);var t=a.nodeValue;a.parentNode&&a.parentNode.nodeName&&t&&c.not_whitespace.test(t)&&(f={},f[a.parentNode.nodeName]=t);if(a.childNodes.length)if(1==a.childNodes.length)f=c.xml2array(a.childNodes[0],e);else{f||(f=[]);for(var v=t=0;v<a.childNodes.length;v++)if(h=c.xml2array(a.childNodes[v],
e)){g=!1;var w=0,s=null;for(b in h)if(h.hasOwnProperty(b)&&(s=b,isNaN(b)&&(g=!0),w++,2<w))break;if(g&&1==w)if(f[s])e&&e[s]||(e[s]=0,g=f[s],f[s]={},f[s][0]=g),e[s]++,f[s][e[s]]=h[s];else{if(e[s]=0,f[s]=h[s],a.childNodes[v].attributes&&a.childNodes[v].attributes.length)for(h=0;h<a.childNodes[v].attributes.length;h++)if(g=a.childNodes[v].attributes[h].nodeName)f["attribute_"+s+"_"+g]=a.childNodes[v].attributes[h].value}else f[t]=h,t++}}k&&f&&(h=f,f={},f[k]=h);return f};return c.xml2array(a)},utf8_decode=
function(a){var b=[],c=0,d=0,e=0,f=0,g=0,h=0;for(a+="";c<a.length;)e=a.charCodeAt(c),191>=e?(b[d++]=String.fromCharCode(e),c++):223>=e?(f=a.charCodeAt(c+1),b[d++]=String.fromCharCode((e&31)<<6|f&63),c+=2):239>=e?(f=a.charCodeAt(c+1),g=a.charCodeAt(c+2),b[d++]=String.fromCharCode((e&15)<<12|(f&63)<<6|g&63),c+=3):(f=a.charCodeAt(c+1),g=a.charCodeAt(c+2),h=a.charCodeAt(c+3),e=(e&7)<<18|(f&63)<<12|(g&63)<<6|h&63,e-=65536,b[d++]=String.fromCharCode(55296|e>>10&1023),b[d++]=String.fromCharCode(56320|e&
1023),c+=4);return b.join("")},utf8_encode=function(a){if(null===a||"undefined"===typeof a)return"";a+="";var b="",c,d,e=0;c=d=0;for(var e=a.length,f=0;f<e;f++){var g=a.charCodeAt(f),h=null;if(128>g)d++;else if(127<g&&2048>g)h=String.fromCharCode(g>>6|192,g&63|128);else if(55296!=(g&63488))h=String.fromCharCode(g>>12|224,g>>6&63|128,g&63|128);else{if(55296!=(g&64512))throw new RangeError("Unmatched trail surrogate at "+f);h=a.charCodeAt(++f);if(56320!=(h&64512))throw new RangeError("Unmatched lead surrogate at "+
(f-1));g=((g&1023)<<10)+(h&1023)+65536;h=String.fromCharCode(g>>18|240,g>>12&63|128,g>>6&63|128,g&63|128)}null!==h&&(d>c&&(b+=a.slice(c,d)),b+=h,c=d=f+1)}d>c&&(b+=a.slice(c,e));return b},md5=function(a){var b=function(a,b){var c,e,d,f,g;d=a&2147483648;f=b&2147483648;c=a&1073741824;e=b&1073741824;g=(a&1073741823)+(b&1073741823);return c&e?g^2147483648^d^f:c|e?g&1073741824?g^3221225472^d^f:g^1073741824^d^f:g^d^f},c=function(a,c,e,d,f,g,h){a=b(a,b(b(c&e|~c&d,f),h));return b(a<<g|a>>>32-g,c)},d=function(a,
c,e,d,f,g,h){a=b(a,b(b(c&d|e&~d,f),h));return b(a<<g|a>>>32-g,c)},e=function(a,c,e,d,f,g,h){a=b(a,b(b(c^e^d,f),h));return b(a<<g|a>>>32-g,c)},f=function(a,c,e,d,f,g,h){a=b(a,b(b(e^(c|~d),f),h));return b(a<<g|a>>>32-g,c)},g=function(a){var b="",c="",e;for(e=0;3>=e;e++)c=a>>>8*e&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},h=[],k,t,v,w,s,m,p,l,q;a=this.utf8_encode(a);h=function(a){var b,c=a.length;b=c+8;for(var e=16*((b-b%64)/64+1),d=Array(e-1),f=0,g=0;g<c;)b=(g-g%4)/4,f=g%4*8,d[b]|=
a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;d[b]|=128<<g%4*8;d[e-2]=c<<3;d[e-1]=c>>>29;return d}(a);m=1732584193;p=4023233417;l=2562383102;q=271733878;a=h.length;for(k=0;k<a;k+=16)t=m,v=p,w=l,s=q,m=c(m,p,l,q,h[k+0],7,3614090360),q=c(q,m,p,l,h[k+1],12,3905402710),l=c(l,q,m,p,h[k+2],17,606105819),p=c(p,l,q,m,h[k+3],22,3250441966),m=c(m,p,l,q,h[k+4],7,4118548399),q=c(q,m,p,l,h[k+5],12,1200080426),l=c(l,q,m,p,h[k+6],17,2821735955),p=c(p,l,q,m,h[k+7],22,4249261313),m=c(m,p,l,q,h[k+8],7,1770035416),q=c(q,m,p,l,
h[k+9],12,2336552879),l=c(l,q,m,p,h[k+10],17,4294925233),p=c(p,l,q,m,h[k+11],22,2304563134),m=c(m,p,l,q,h[k+12],7,1804603682),q=c(q,m,p,l,h[k+13],12,4254626195),l=c(l,q,m,p,h[k+14],17,2792965006),p=c(p,l,q,m,h[k+15],22,1236535329),m=d(m,p,l,q,h[k+1],5,4129170786),q=d(q,m,p,l,h[k+6],9,3225465664),l=d(l,q,m,p,h[k+11],14,643717713),p=d(p,l,q,m,h[k+0],20,3921069994),m=d(m,p,l,q,h[k+5],5,3593408605),q=d(q,m,p,l,h[k+10],9,38016083),l=d(l,q,m,p,h[k+15],14,3634488961),p=d(p,l,q,m,h[k+4],20,3889429448),m=
d(m,p,l,q,h[k+9],5,568446438),q=d(q,m,p,l,h[k+14],9,3275163606),l=d(l,q,m,p,h[k+3],14,4107603335),p=d(p,l,q,m,h[k+8],20,1163531501),m=d(m,p,l,q,h[k+13],5,2850285829),q=d(q,m,p,l,h[k+2],9,4243563512),l=d(l,q,m,p,h[k+7],14,1735328473),p=d(p,l,q,m,h[k+12],20,2368359562),m=e(m,p,l,q,h[k+5],4,4294588738),q=e(q,m,p,l,h[k+8],11,2272392833),l=e(l,q,m,p,h[k+11],16,1839030562),p=e(p,l,q,m,h[k+14],23,4259657740),m=e(m,p,l,q,h[k+1],4,2763975236),q=e(q,m,p,l,h[k+4],11,1272893353),l=e(l,q,m,p,h[k+7],16,4139469664),
p=e(p,l,q,m,h[k+10],23,3200236656),m=e(m,p,l,q,h[k+13],4,681279174),q=e(q,m,p,l,h[k+0],11,3936430074),l=e(l,q,m,p,h[k+3],16,3572445317),p=e(p,l,q,m,h[k+6],23,76029189),m=e(m,p,l,q,h[k+9],4,3654602809),q=e(q,m,p,l,h[k+12],11,3873151461),l=e(l,q,m,p,h[k+15],16,530742520),p=e(p,l,q,m,h[k+2],23,3299628645),m=f(m,p,l,q,h[k+0],6,4096336452),q=f(q,m,p,l,h[k+7],10,1126891415),l=f(l,q,m,p,h[k+14],15,2878612391),p=f(p,l,q,m,h[k+5],21,4237533241),m=f(m,p,l,q,h[k+12],6,1700485571),q=f(q,m,p,l,h[k+3],10,2399980690),
l=f(l,q,m,p,h[k+10],15,4293915773),p=f(p,l,q,m,h[k+1],21,2240044497),m=f(m,p,l,q,h[k+8],6,1873313359),q=f(q,m,p,l,h[k+15],10,4264355552),l=f(l,q,m,p,h[k+6],15,2734768916),p=f(p,l,q,m,h[k+13],21,1309151649),m=f(m,p,l,q,h[k+4],6,4149444226),q=f(q,m,p,l,h[k+11],10,3174756917),l=f(l,q,m,p,h[k+2],15,718787259),p=f(p,l,q,m,h[k+9],21,3951481745),m=b(m,t),p=b(p,v),l=b(l,w),q=b(q,s);return(g(m)+g(p)+g(l)+g(q)).toLowerCase()};
if("object"==typeof window&&"undefined"==typeof _onLoadMethods){var _onLoadMethods=[];window.addOnLoadManager=function(a){_onLoadMethods[_onLoadMethods.length]=a};document.addEventListener("DOMContentLoaded",function(a){mTabNav&&mTabNav.init()});window.addEventListener("load",function(){for(var a=0;a<_onLoadMethods.length;a++)if(_onLoadMethods.hasOwnProperty(a)&&void 0!==_onLoadMethods[a])_onLoadMethods[a]()},!1);var addEvent=function(a,b,c){"string"==typeof a&&(a=y$(a));if(null!==a&&"undefined"!==
typeof a)if(isArray(a))for(var d=0;d<a.length;d++)addEvent(a[d],b,c);else{b=b.split(" ");for(var e,d=0;d<b.length;d++)e=b[d],a.addEventListener?a.addEventListener(e,c,!1):a.attachEvent?a.attachEvent("on"+e,c):a["on"+e]=c}}}_dump("ymisc");
function yAnalise(a,b){if(void 0!=a){a=unmaskHTML(a);for(var c=/%[+(\w)]|[]\(/gi,d,e="";0<=(d=a.search(c));){var e=a.slice(d).search(/\(/),f=a.slice(d+e+1,d+e+2);if('"'==f||"'"==f){var g,h=d+e+1;do h++,g=a.slice(h,h+1);while(g!=f&&h<a.length);f=h+a.slice(h).search(/\)/)-d}else f=a.slice(d).search(/\)/);var k=a.slice(d+1,d+e),e=g=a.slice(d+e+1,d+f);g=g.split(",");for(h=0;h<g.length;h++)g[h]=yAnalise(g[h],b);var e=void 0,h=g[0].toUpperCase(),t=g[0];if(void 0!=b)if(void 0==b[0])e=b[h]?yAnalise(b[h],
b):yAnalise(b[t],b);else for(var v=b.length-1;0<=v&&void 0==e;v--)void 0!=b[v][h]?e=yAnalise(b[v][h],b):void 0!=b[v][t]&&(e=yAnalise(b[v][t],b));else e="string"==eval("typeof "+t)?eval(t):yAnalise(t);void 0==e&&(e="");g[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":g=Math.max(0,parseInt(g[1]));e=parseFloat(e);e=e.toFixed(g);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;
case "tstime":e=timestamp2time(e);break;case "date":e=g[1]?UDate2Date(e,g[1]):UDate2Date(e);break;case "time":e=g[1]?UDate2Time(e,g[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");t=Math.max(0,str2int(g[1]));v=Math.max(k.length-1,str2int(g[2]));g=Math.max(0,str2int(g[3]));e="";for(h=t;h<t+v;h++){var w=onlyDefinedValue(k[h]);""<w&&(e+=" "+w)}0<g&&(e=wordwrap(e,g,"<br>",!0));break;case "quoted":e='"'+e+'"';break;case "condLabel":break;
default:if(""<k&&"function"==eval("typeof "+k)){e="";for(h=0;h<g.length;h++)""<e&&(e+=","),e+="'"+g[h]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}}else a="";return a}_dump("yanalise");
...
1;document.onselectstart=null;a.info.dragElement.ondragstart=null;a.highlight(null);b=a.info.dragElement;a.info.dragElement=null;_dump("mouse up over"+a.info.overElement.id);var c="yes"==a.info.overElement.getAttribute("droppable");if(c&&("function"==typeof a.info.overElement.ondragover&&(c=a.info.overElement.ondragover(b)),"function"==typeof a.info.overElement.ondrop&&c))a.info.overElement.ondrop(b)}}};"object"==typeof document&&(document.onmousedown=a.onMouseDown,document.onmouseup=a.onMouseUp,
document.onmousemove=a.onMouseMove);return a},ydragdrop=ydragdropBase();_dump("ydragdrop");
var tabNavBase=function(){var a={};if(isOnMobile()){var b=document.createEvent("Events");b.initEvent("tabchange");var c=document.createEvent("Events");c.initEvent("tabblur");var d=document.createEvent("Events");d.initEvent("tabfocus")}else"function"==typeof Event&&(b=new Event("tabchange"),c=new Event("tabblur"),d=new Event("tabfocus"));a.currentTabNdx=-1;a.currentContainerNdx=-1;a.containerList=[];a.tabList=[];a.storage=null;a.initialized=-1;a.lock={returnTabId:null,locked:!1};a.isContainer=function(a){var b=
!1;a&&(b=a.hasClass("tnContainer"));return b};a.isTab=function(a){var b=!1;a&&(b=a.hasClass("tnTab"));return b};a.getContainer=function(b){return a.containerList[b]};a.getCurrentContainer=function(){return a.getContainer(a.currentContainerNdx)};a.getContainerById=function(b){for(var c=null,d=0;d<a.containerList.length;d++)a.containerList[d].element.id==b&&(c=a.containerList[d]);return c};a.getTabContainer=function(b){var c=null;if(b)for(var d=0;d<a.containerList.length&&null==c;d++)for(var h=0;h<
a.containerList[d].childs.length&&null==c;h++)"string"==typeof b?a.containerList[d].childs[h].id==b&&(c=a.containerList[d]):a.containerList[d].childs[h]==b&&(c=a.containerList[d]);return c};a.getFirstTabInContainer=function(b){var c=null,d;"string"==typeof b&&(b=y$(b));a.isTab(b)?d=a.getTabContainer(b):(b=a.getContainerNdx(b),0<=b&&(d=a.containerList[b]));d&&(c=d.childs[0]);return c};a.getFirstChildTab=function(b){var c=null;"string"==typeof b&&(b=y$(b));if(a.isTab(b)){var d=b.getElementsByClassName("tnContainer");
d.hasOwnProperty("0")?(b=a.getContainerNdx(d[0]),0<=b&&(c=a.containerList[b].childs[0])):c=b}return c};a.getContainerFromParam=function(b,c){void 0==b?b=void 0==c?a.getCurrentContainer():a.getTabContainer(c):"string"==typeof b?b=a.getContainerById(b):isNumber(b)?b=a.getContainer(b):"object"!=typeof b&&(_dump("getContainerFromParam() parameter is not null, valid string, object nor a number"),b=null);return b};a.getCurrentTabNdx=function(b){var c=-1;if(b=a.getContainerFromParam(b))c=b.currentTabNdx;
return c};a.setCurrentContainer=function(b){0>a.initialized&&a.init();a.currentContainerNdx=b%a.containerList.length};a.getContainerNdx=function(b){for(var c=-1,d=0;d<a.containerList.length;d++)a.containerList[d].element==b&&(c=d);return c};a.addContainer=function(b){0>a.initialized&&a.init();if(b&&0>a.getContainerNdx(b)){a.currentContainerNdx=a.containerList.length;a.containerList[a.currentContainerNdx]={childs:[],element:b,currentTabNdx:-1};b=b.getElementsByClassName("tnTab");for(var c in b)b.hasOwnProperty(c)&&
"object"==typeof b[c]&&(a.containerList[a.currentContainerNdx].childs[a.containerList[a.currentContainerNdx].childs.length]=b[c])}};a.addTab=function(b){0>a.initialized&&a.init();if(b){var c=a.getCurrentContainer().childs;0>c.indexOf(b)&&(c[c.length]=b)}};a.init=function(b){if(0>a.initialized){a.initialized=0;b=y$(".tnContainer");var c=null,d=null,c=0;if(b)for(c=0;c<b.length;c++)d=b[c],a.addContainer(d);if(b=y$(".tnTab"))for(c=0;c<b.length;c++)a.hideTab(b[c]);0<a.containerList.length&&(c=a.containerList[0].childs[0],
a.displayTab(a.getFirstChildTab(c)));a.currentContainerNdx=0;a.initialized=1}ycomm&&ycomm.setWaitIconControl(a.waitIconControl);return a};a.currentTab=function(b){b=a.getCurrentContainer();return-1<b.currentTabNdx?b.childs[b.currentTabNdx]:null};a.createTab=function(b,c){var d=null;void 0==y$(c)&&(d=document.createElement("div"),d.className="tnTab",d.style.display="none",d.id=c,b.appendChild(d),a.addTab(d),a.hideTab(d));return d};a.delTab=function(a){};a.displayTab=function(c,f){if(!a.changingView){a.changingView=
!0;try{if(!a.locked()&&c){0>a.initialized&&a.init();_dumpY(64,1,"displayTab "+c.id);var g=!0,h=0;if(g=c.dispatchEvent(b)||g){var k=a.getContainerFromParam(f);if(k){_dumpY(64,1,"canchange");for(var g=-1,t=!1,h=0;h<k.childs.length;h++)k.childs[h]!=c?t|=!a.hideTab(k.childs[h],c,k):g=h;_dumpY(64,1,"readytochange "+!t);if(t)_dumpY(64,1,"freeze");else{a.setCurrentContainer(a.getContainerNdx(k));k.currentTabNdx=g;c.dispatchEvent(d);c.style.display="block";for(k=c;k&&k!=document.body;)k.style.display="block",
k=k.parentNode;for(var v=c.getElementsByTagName("*"),h=0;h<v.length;){if("checkbox"==v[h].type||"radio"==v[h].type||"password"==v[h].type||"hidden"==v[h].type||"text"==v[h].type||"select-one"==v[h].type||"textarea"==v[h].type){v[h].focus();break}h++}}}}_dumpY(64,1,"return")}}finally{a.changingView=!1}}};a.showWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display="block")};a.hideWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display="none")};a.waitIconControl=function(b){void 0!=
b&&(b?a.showWaitIcon():a.hideWaitIcon())};a.isInnerTab=function(a,b){var c=!1;if(a)for(var d=a;d&&d.parent!=d;)b==d&&(c=!0),d=d.parentNode;return c};a.hideTab=function(b,d,g){if(!a.locked()){_dumpY(64,1,"hideTab "+b.id);var h=!0;if(g=a.getContainerFromParam(g))if(g.childs.indexOf(b)==g.currentTabNdx){if(h=b.dispatchEvent(c)||h)g.currentTabNdx=-1}else h=!0;h&&"object"==typeof b&&!a.isInnerTab(d,b)&&(b.style.display="none");return h}};a.showNext=function(b){if(b=a.getContainerFromParam(b)){var c=b.currentTabNdx;
c<b.childs.length-1?a.displayTab(b.childs[c+1],b):a.displayTab(b.childs[0],b)}};a.showPrior=function(b){if(b=a.getContainerFromParam(b)){var c=b.currentTabNdx;0<c?a.displayTab(b.childs[c-1],b):a.displayTab(b.childs[b.childs.length-1],b)}};a.getCurrentTabId=function(b){var c=null;if(b=a.getContainerFromParam(b)){var d=b.currentTabNdx;-1<d&&(c=b.childs[d].id)}return c};a.showTab=function(b,c,d){if(!a.locked()){d=a.getContainerFromParam(d,b);void 0==b&&(b=d.childs[0].id);void 0==c&&(c=!1);var h=document.getElementById(b),
k="";h?(c&&(k=a.getCurrentTabId(d)),a.displayTab(h,d),c&&a.lockTab(b,k)):alert(b+" not found")}};a.locked=function(){return a.lock.locked};a.releaseLockedTabs=function(){for(var b=0;b<a.getCurrentContainer().childs.length;b++)a.getCurrentContainer().childs[b].locked&&(a.getCurrentContainer().childs[b].locked=!1);a.lock.locked=!1;a.lock.returnTabId=null};a.lockTab=function(b,c){a.locked()&&a.releaseLockedTabs();y$(b)&&(a.lock.locked=!0,y$(b).locked=!0,a.lock.returnTabId=y$(c)?c:null)};a.unlockTab=
function(b){a.locked()&&y$(b)&&y$(b).locked&&(b=a.lock.returnTabId,a.releaseLockedTabs(),null!=b&&a.showTab(b))};return a},mTabNav=tabNavBase();_dump("ytabnav");
...
c,e||"",d,f);return b+="&ts="+(new Date).getTime()},setWaitIconControl:function(b){a.waitIconControl=b||a._dummyWaitIconControl}};a.setWaitIconControl();return a},ycomm=ycommBase();
ycomm.pinger={canPing:!1,pingerWatchdog:null,pingCount:0,pingTimeout:5E3,pingInterleave:1500,onSuccess:null,onError:null,pong:function(a){this.pingerWatchdog&&clearTimeout(this.pingerWatchdog);_dump("pong answer");if(this.pingCount<=a.pingCount&&(this.pingCount=0,null!=this.onSuccess))this.onSuccess();this.canPing&&(this.pingerWatchdog=setTimeout("ycomm.pinger.ping()",this.pingInterleave))},notAnswer:function(){this.pingerWatchdog&&clearTimeout(this.pingerWatchdog);_dump("Not pong answer");if(null!=
this.onError)this.onError();else _dump("Not 'onError' event");this.canPing&&(this.pingerWatchdog=setTimeout("ycomm.pinger.ping()",this.pingInterleave/2))},ping:function(a,b){this.pingerWatchdog&&clearTimeout(this.pingerWatchdog);_dump("Prepare to ping");this.canPing=!0;this.onSuccess=a||this.onSuccess;this.onError=b||this.onError;this.pingCount++;ycomm.crave("yeapf","ping",{pingCount:this.pingCount},"ycomm.pinger.pong");this.pingerWatchdog=setTimeout("ycomm.pinger.notAnswer()",ycomm.pinger.pingTimeout)},
stopPing:function(){this.pingerWatchdog&&clearTimeout(this.pingerWatchdog);_dump("stop pinging");this.canPing=!1}};_dump("ycomm");
...
ycomm.explodeData=function(a){var b;a=xml2array(a).root||{};var c=a.dataContext||{},d=a.error||c.error||c.lastError,e=null,f=c.userMsg,g=c.sysMsg;if(g&&g.msg&&"logoff"==g.msg){ycomm.canReceiveMessages=!1;for(var h=window,k;h.opener;)k=h,h=h.opener,k.close();for(;h.parent!=h;)h=h.parent;g.banner&&(_dump(g.banner),alert(g.banner));h.document.location="body.php?s=yeapf&a=logoff"}if(ycomm.canReceiveMessages){if(c){var t;if(c.requiredFields)for(g=c.requiredFields.split(","),t=0;t<g.length;t++)fieldName=
g[t],y$(fieldName)&&y$(fieldName).addClass("fieldWarning");if(c.formError){g="";for(t in c.formError)c.formError.hasOwnProperty(t)&&(""<g&&(g+="\n"),g+=c.formError[t]);alert(g)}}if(a){void 0!=c.formID&&""==formID&&(formID=c.formID);c.firstRow=parseInt(c.firstRow);c.rowCount=parseInt(c.rowCount);c.requestedRows=parseInt(c.requestedRows);t=c.rowCount;b=a.data?a.data.row:a.row;1==t&&(b=Array(b));if(b)for(var v in b)if(b.hasOwnProperty(v))for(var w in b[v])b[v].hasOwnProperty(w)&&(b[v][w]=unmaskHTML(b[v][w]));
...
ycomm.invoke=function(a,b,c,d,e){"undefined"==typeof e&&(e=!0);if("object"==typeof a){var f=a;a=f.s;b=f.a;c=f.limits;d=f.callbackFunction}f="undefined"==typeof u?"":u;ycomm.waitIconControl(!0);a=this.buildCommonURL(a||"",b||"",c||{},f);"undefined"!=typeof xAjax?xAjax().Request(this.scriptName,{method:ycomm.defaultMethod,asynchronous:yloader.isWorker?!1:e,parameters:a,onTimeout:function(){console.log("XMLHttpRequest timeout")},onComplete:function(a){var b={data:null,geometry:null,dataContext:null,
error:null,userMsg:null},c=null;200==a.status?(a.responseXML?c=a.responseXML:"function"==typeof DOMparser&&(c=(new DOMParser).parseFromString(a.responseText,"application/xml")),null!==c&&(b=ycomm.explodeData(c))):console.log(a.statusText);ycomm.waitIconControl(!1);if(b.error)for(var e in b.error)b.error.hasOwnProperty(e)&&console.error(b.error[e]);"function"==typeof d&&(yloader.isWorker?d(a.responseText):d(a.status,b.error,b.data,b.userMsg,b.dataContext,b.geometry))}}):(console.log("Not ready to call "+
a),console.log("prototype library not loaded"))};_dump("ycomm-ajax");ycomm.setDataLocation=function(a){this._dataLocation_=a};ycomm.getDataLocation=function(){return this._dataLocation_};ycomm._scriptSequence=0;ycomm._maxScriptSequenceReceived=0;ycomm._CBSeq=1E3;ycomm._CBControl={};ycomm._load=0;ycomm._queue=0;ycomm._maxDirectCall=10;
ycomm._dataLocation_=function(){var a="object"==typeof document&&document.location&&document.location.href?document.location.href:"",b=a.lastIndexOf("/");return a.substr(0,b+1)+"rest.php"}();ycomm.getLoad=function(){return this._load};ycomm._removeJSONP=function(a,b){var c=document.head,d="rest_"+a,e=document.getElementById(d);void 0!==c&&void 0!==e?(c.removeChild(e),_dump("Clean "+d+" after call to "+b+"()")):_dump("Script not found: "+d+" adressed to "+b+"()");_dump(ycomm.getStatus())};
ycomm.rest_timeout=3500;
ycomm.bring=function(a){var b=document.head,c=document.createElement("script");_dump(a);var d=null,e=null,f=a.substr(a.indexOf("?")+1).split("&"),g;for(g in f)if(f.hasOwnProperty(g)){var h=f[g].split("=");"scriptSequence"==h[0]&&(d=h[1]);"callback"==h[0]&&(e=h[1])}ycomm._maxScriptSequenceReceived=Math.max(ycomm._maxScriptSequenceReceived,d);c.onload=function(){0<ycomm._load&&ycomm._load--};c.setAttribute("src",a);c.id="rest_"+d;b.appendChild(c);setTimeout("ycomm._removeJSONP("+d+",'"+e+"');",ycomm.rest_timeout)};
ycomm.crave=function(a,b,c,d,e){var f="undefined"==typeof u?"":u;"undefined"==typeof e&&(e=0);ycomm._scriptSequence++;if(this.getDataLocation()){var g;"function"==typeof d?(ycomm._CBSeq++,g="ycb"+ycomm._CBSeq,ycomm._CBControl[g]={ready:!1},window[g]=function(a,b,c,e,f,s){d(a,b,c,e,f,s);console.log(g)}):"string"==typeof d?g=d:console.error("param callBackFunction need to be function or string");""<g&&(ycomm._load++,a=this.buildCommonURL(a||"",b||"",c||{},f),a="{0}?{1}&callback={2}&callbackId={3}&scriptSequence={4}".format(this._dataLocation_,
a,d,e,ycomm._scriptSequence),ycomm.getLoad()<=ycomm._maxDirectCall?ycomm.bring(a):setTimeout("ycomm.bring('"+a+"');",250+500*(ycomm.getLoad()-ycomm._maxDirectCall)))}else console.error("You need to define dataLocation before 'crave' it")};ycomm.isIdle=function(){return ycomm._maxScriptSequenceReceived==ycomm._scriptSequence};ycomm.getStatus=function(){return"isIdle() = {0} getLoad() = {1}".format(this.isIdle(),this.getLoad())};_dump("ycomm-rest");ycomm.dom={};
ycomm.dom.fillElement=function(a,b,c,d){void 0===c&&(c={});void 0===d&&(d=!0);var e,f,g,h,k=y$(a);e=c.idFieldName||"id";var t=function(a){var d;p=0;"TR"==a.nodeName&&(a.style.backgroundColor=rowColorSpec.suggestRowColor(B));if(b[s][e])if(y$(b[s][e])){for(d=0;y$(b[s][e]+"_"+d);)d++;a.id=b[s][e]+"_"+d}else a.id=b[s][e];if("undefined"!=typeof c.inplaceData)for(var h=0;h<c.inplaceData.length;h++)f=c.inplaceData[h],d=b[s][f]||"",a.setAttribute("data_"+f,d);(c.onClick||c.onSelect)&&a.addEventListener("click",
c.onClick||c.onSelect,!1)},v=function(d){if(d!=e){var f=g.insertCell(p),k=null!==d?unmaskHTML(b[s][d]):unmaskHTML(b[s]);c.columns&&c.columns[d]&&(c.columns[d].align&&(f.style.textAlign=c.columns[d].align),c.columns[d].type&&(k=yAnalise("%"+c.columns[d].type+"("+k+")")));h||f.addClass("warning");f.innerHTML=0===k.length?"&nbsp;":k;f.style.verticalAlign="top";f.id=a+"_"+p+"_"+w.rows.length;f.setAttribute("colName",d);if("function"==typeof c.onNewItem)c.onNewItem(a,f,b[s]);p+=1}},w,s,m,p,l,q=(new Date).getTime()-
1447265735470;if(k)if("TABLE"==k.nodeName){w=0<k.getElementsByTagName("tbody").length?k.getElementsByTagName("tbody")[0]:k;0<w.getElementsByTagName("tbody").length&&(w=w.getElementsByTagName("tbody")[0]);if(d)for(;0<w.rows.length;)w.deleteRow(w.rows.length-1);var B=w.rows.length%2;p=null;for(s in b)if(b.hasOwnProperty(s)){B++;h=!0;if(!d&&b[s][e])for(k=0;h&&k<w.rows.length;k++)if(w.rows[k].id==b[s][e]){for(g=w.rows[k];0<g.cells.length;)g.deleteCell(0);h=!1;b[s].rowid=k}h&&(g=w.insertRow(w.rows.length));
q++;b[s].rowid=g.rowIndex||q+"";b[s]._elementid_=a;t(g);if("undefined"==typeof c.html&&"undefined"==typeof c.rows&&"undefined"==typeof c.columns)if("string"==typeof b[s])v(null);else for(f in b[s])b[s].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&v(f);else if("undefined"!=typeof c.columns)if(isArray(c.columns))for(m=0;m<c.columns.length;m++)v(c.columns[m]);else for(m in c.columns)c.columns.hasOwnProperty(m)&&v(m);else if("undefined"!=typeof c.html){if(l=g.insertCell(0),l.innerHTML=yAnalise(c.html,
b[s]),l.style.verticalAlign="top",l.id=a+"_"+p+"_"+w.rows.length,"function"==typeof c.onNewItem)c.onNewItem(a,l,b[s])}else if("undefined"!=typeof c.rows)for(k=!0,r=0;r<c.rows.length;r++){k||(g=w.insertRow(w.rows.length),t(g));g.innerHTML=yAnalise(c.rows[r],b[s]);if(!h)for(m=0;m<g.cells.length;m++)g.cells[m].style.borderLeft="solid 1px red";if("function"==typeof c.onNewItem)c.onNewItem(a,g,b[s]);k=!1}if("function"==typeof c.onNewRowReady)c.onNewRowReady(a,g)}}else if("UL"==k.nodeName){if(d)for(;k.firstChild;)k.removeChild(k.firstChild);
for(s in b)if(b.hasOwnProperty(s)){d=document.createElement("li");m="";v=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)m=m+yAnalise(c.rows[r],b[s])+"";v=!0}else if("string"==typeof c.html)m=m+yAnalise(c.html,b[s])+"",v=!0;else for(f in b[s])""===m&&b[s].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(m+=b[s][f]);t(d);v?d.innerHTML=m:d.appendChild(document.createTextNode(m));"string"==typeof c.beforeElement?(m=y$(c.beforeElement),k.insertBefore(d,m)):k.appendChild(d);if("function"==
typeof c.onNewItem)c.onNewItem(a,d,b[s])}}else if("LISTBOX"==k.nodeName){if(d)for(;0<k.childElementCount;)k.childNodes[0].remove();t=0;for(s in b)if(b.hasOwnProperty(s)){b[s]._elementid_=a;g=document.createElement("listitem");p=0;if("undefined"==typeof c.columns)if("string"==typeof b[s])_dump("ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[s]){if(b[s].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){l=document.createElement("listcell");l.innerHTML=b[s][f];l.id=a+"_"+p+"_"+
t;if("function"==typeof c.onNewItem)c.onNewItem(a,l,b[s]);p+=1;g.appendChild(l)}}else for(f in c.columns)if(f!=e){l=document.createElement("listcell");l.innerHTML=b[s][f];l.id=a+"_"+p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,l,b[s]);p+=1;g.appendChild(l)}k.appendChild(g);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d)for(;0<k.options.length;)k.options.remove(0);p=0;for(s in b)if(b.hasOwnProperty(s)){b[s]._elementid_=a;t="";if("undefined"==typeof c.columns)if("string"==
typeof b[s])_dump("ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[s])b[s].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=b[s][f]);else if(isArray(c.columns))for(m=0;m<c.columns.length;m++)t=t+b[s][c.columns[m]]+" ";else if("string"==typeof b[s])_dump("ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(t+=b[s][f]);d=document.createElement("option");"undefined"!=typeof b[s][e]&&(d.value=b[s][e]);d.innerHTML=t;d.id=a+"_"+p;if("function"==
typeof c.onNewItem)c.onNewItem(a,d,b[s]);k.appendChild(d);p++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var z,y;l=d?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(var A=b[0]||b,v=c.elementPrefixName||"",q=c.elementPostixName||"",k=0;k<l.length;k++){if(d=l[k].getAttribute("editMask"),m=l[k].getAttribute("storageMask"),t=l[k].getAttribute("valueType")||"text",z=suggestKeyName(A,l[k].name||l[k].id,v,q),f=c.columns&&suggestKeyName(c.columns,l[k].id)||
null,"undefined"!=typeof A[z]&&(y=unmaskHTML(A[z]),z=l[k].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(t=c.columns[f].type,d=c.columns[f].editMask||d,m=c.columns[f].storageMask||m);"text"!=t&&(""<d&&""<m?0<=t.indexOf("date")&&(y=dateTransform(y,m,d)):y=yAnalise("%"+t+"("+y+")"));switch(z){case "text":case "password":case "textarea":case "email":case "hidden":l[k].value=y;break;case "radio":case "checkbox":l[k].value==y&&(l[k].checked=l[k].value===y);break;case "select-one":case "select-multi":for(s=
0;s<l[k].options.length;s++)l[k].options[s].value==y&&(l[k].selectedIndex=s)}if("function"==typeof c.onNewItem)c.onNewItem(a,l[k],A)}}else 1<b.length&&console.log("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&b&&1===b.length){t="";d?k.innerHTML="":t=k.innerHTML;for(f in b[0])b[0].hasOwnProperty(f)&&(t+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,b[0][f]));k.innerHTML=t}};
...
ycomm.dom.selectElements=function(a,b){var c=[],d,e,f;if(d=y$(a))for(d=d.getElementsByTagName("*"),e=0;e<d.length;e++)if(d[e].type){f=d[e].type.toLowerCase();knownFieldType=!1;b&&0>b.indexOf(d[e].name||d[e].id)&&(f="--AVOID--");switch(f){case "text":case "password":case "textarea":case "hidden":case "email":case "radio":case "checkbox":case "select-one":case "select-multi":knownFieldType=!0}knownFieldType&&(c[c.length]=d[e])}return c};
...
1);break;case "ul":for(;a.firstChild;)a.removeChild(a.firstChild)}}else _dump("null element when calling cleanElement()")};ycomm.dom.cleanForm=function(a,b){var c,d;d=this.selectElements(a,b);for(c=0;c<d.length;c++)ycomm.dom.cleanElement(d[c]);return d};
ycomm.dom.getFormElements=function(a){var b={};a=this.selectElements(a);for(var c,d,e,f,g,h,k,t=0;t<a.length;t++)if(f=a[t].getAttribute("editMask")||"",g=a[t].getAttribute("storageMask")||"",h=a[t].getAttribute("valueType")||"text",k=!0,d=a[t].type.toLowerCase(),c=a[t].name||a[t].id,""<c){e="";if("radio"==d||"checkbox"==d)k=!1,"undefined"==typeof b[c]&&(b[c]="");switch(d){case "text":case "password":case "textarea":case "email":case "hidden":e=a[t].value.quoteString(!0);null!==e&&""<f&&""<g&&0<=h.indexOf("date")&&
(e=dateTransform(e.unquote(),f,g))&&(e=e.quoteString());break;case "radio":case "checkbox":e=a[t].checked?a[t].value.quoteString(!0):"";k=""!==e;break;case "select-one":case "select-multi":e=a[t].selectedIndex,a[t].options[e]&&(e=a[t].options[e].value)}k&&(b[c]=e)}return b};ycomm.dom.addFormElement=function(a,b,c){b=document.createElement(b);for(var d in c)c.hasOwnProperty(d)&&b.setAttribute(d,c[d]);a.appendChild(b);return b};
...
var ycommMsgBase=function(){return that={messagePeekerTimer:null,messageStack:[],msgProcs:[],_dbgFlag_noMessageProcessorPresent:!1,msgCount:0,serverOfflineFlag:0,grantMsgProc:function(a){if(void 0==a||0>=a)a=Math.min(2E4,2*messagePeekerInterval);void 0==that.messagePeekerTimer?(0==that.msgCount&&_dump("Configuring receivers interval to "+a+"ms"),that.messagePeekerTimer=setTimeout("ycomm.msg.peek()",a)):_dump("Receivers interval already defined")},feedBack:function(){if(0<dRowCount){that.msgCount++;
...
["L","P"];if(a=y$(b.cfg.divContainerName)){try{b.cfg.status=0;null!=b.cfg.callback&&b.cfg.callback(b,"DOMLocked",a);for(var e=null,f=null,g=null,h=null,k=null,t=null,v=null,w=2>b.cfg.view?864E5:6E4*b.cfg.dayEntryDivision,s=0,m=0,p="calDay"+d[b.cfg.view%2];a.hasChildNodes();)a.removeChild(a.lastChild);b.context.oCalTable=document.createElement("table");b.context.oCalTable.cellPadding=0;b.context.oCalTable.cellSpacing=0;var l=b.context.oCalTable.insertRow(-1),q=l.insertCell();q.className="calBand";
var d=!0,B=0,z={};null!=b.cfg.cellSize.height&&(z.height=parseInt(b.cfg.cellSize.height)+"px");null!=b.cfg.cellSize.width&&(z.width=parseInt(b.cfg.cellSize.width)+"px");var y=b.context.dateScope.first,A=b.context.dateScope.last;y.setHours(12);A.setHours(12);var D=function(){f=b.cfg.divContainerName+"_empty_"+B;var a=document.createElement("div");mergeObject(z,a.style);a.id=f;a.className=p+"Cell "+p+"EmptyCell";q.appendChild(a);0==b.cfg.orientation&&s++;B++;null!=b.cfg.callback&&b.cfg.callback(b,"getEmptyDayContent",
a)},C=function(a){0==a?(f=b.cfg.divContainerName+"_day_"+x.toUDate().substring(0,8),e=x.getDate()):(e=x.getHours()+":"+x.getMinutes(),f=b.cfg.divContainerName+"_day_"+x.toUDate().substring(0,12))},x=new Date(y),F=(A-x)/w+1;if(0===b.cfg.view)if(0==b.cfg.orientation)for(n=0;n<y.getDay();n++)D();else{x.setDate(x.getDate()-y.getDay());var G=[],E=new Date(x);for(n=0;n<b.context.nRows;n++)G[n]=new Date(E),E.setDate(E.getDate()+1)}for(;0<F;)d||(l=b.context.oCalTable.insertRow(-1),q=l.insertCell(),q.className=
"calBand",d=!0),e="",1==b.cfg.orientation?x<y||x>A?D():0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dump("Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dump("Not implemented")),""<e&&(g=p+"Cell",0===x.getDay()&&(g+=" "+p+"FreeCell"),x.getDate()==b.cfg.date.getDate()&&(g+=" "+p+"Highlight"),k=document.createElement("div"),mergeObject(z,k.style),k.id=f,k.className=g,mergeObject(z,k.style),k.date=x,t=document.createElement("span"),t.id=
f+"_tag",t.className="calTag",null!=b.cfg.callback&&(h=b.cfg.callback(b,"getTagContent",t)||"",""<h&&(e=h)),t.innerHTML=e,k.appendChild(t),null!=b.cfg.callback&&(v=b.cfg.callback(b,"getCellContent",k)||"",""<v&&(k.innerHTML+=v)),q.appendChild(k)),1==b.cfg.orientation?x.setTime(x.getTime()+w*b.context.nRows):x.setTime(x.getTime()+w),s++,s>=b.context.nCols&&(s=0,m++,d=!1,1==b.cfg.orientation&&(x=G[m])),F--;if(d){for(;s<b.context.nCols;)D();s=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dump("ERROR: "+
H.message)}b.cfg.status=1;null!=b.cfg.callback&&b.cfg.callback(b,"DOMReleased",a)}return b};b.build=function(a,d,e){b.cfg.orientation=e||b.cfg.orientation;b.cfg.view=d||b.cfg.view;b.cfg.date=a||b.cfg.date;if(y$(b.cfg.divContainerName)){a=new Date(b.cfg.date);d=null;var f=e=0;switch(b.cfg.view){case 0:e=7;f=5;a.setDate(1);d=new Date(a);d.setDate(a.daysInMonth());break;case 1:e=1;f=7;for(a=new Date(b.cfg.date);0<a.getDay();)a.setTime(a.getTime()-864E5);d=new Date(a);d.setTime(a.getTime()+5184E5);break;
case 2:e=1;f=Math.round(1440/b.cfg.dayEntryDivision);a.setHours(6);a.setMinutes(0);d=new Date(a);d.setHours(21);d.setMinutes(60-b.cfg.dayEntryDivision);break;default:_dump("Not implemented")}b.context.dateScope.first=a;b.context.dateScope.last=d;1===b.cfg.orientation?(b.context.nCols=f,b.context.nRows=e):(b.context.nCols=e,b.context.nRows=f);b.draw(b);_dump("Build calendar on "+b.cfg.date.toUDate()+" View: "+b.cfg.view+" Orientation: "+b.cfg.orientation+" cols: "+e+" rows: "+f)}else _dump("ERROR: "+
b.cfg.divContainerName+" not found on that page");return b};b.each=function(a){if("function"==typeof a&&b.context.oCalTable){var d=b.cfg.divContainerName+"_day_",e=function(e){e=b.context.oCalTable.getElementsByTagName(e);for(var g=0;g<e.length;g++)e[g].id.substr(0,d.length)==d&&a(e[g])};e("div");e("span")}return b};return b};_dump("ycalendar");
...
function dynTableCloneRow(a,b){for(;void 0!=a&&!(a instanceof HTMLTableRowElement);)a=a.parentNode;if(a){for(var c=a.parentNode,d=a.cloneNode(!0),e=0;e<d.cells.length;e++)for(var f=d.cells[e],g=0;g<f.childNodes.length;g++){var h=f.childNodes[g];if(""<h.id){for(var k=_dynExplodeTag(h.id),t=k[1],t=0;y$(k[0]+zeroPad(t,2));)t++;h.id=k[0]+zeroPad(t,2);h.name=h.id;h.onchange=b}h.value=null}return c.insertBefore(d,a.nextSibling)}alert("Your button is outside a table");return null}
...
function dynSetDisplay(a,b){for(var c=0;c<a.length;c++)a[c].style.display=b,_dump(a[c].id,a[c].style.display)}function dynSetVisibility(a,b){for(var c=0;c<a.length;c++)a[c].style.visibility=b,_dump(a[c].id,a[c].style.visibility)}function dynRemoveElements(a){for(var b=a.length-1;0<=b;b--)a[b].parentNode.removeChild(a[b])}function dynTablePrint(a,b,c){}
function calcGridAddItem(a,b,c,d,e,f,g,h,k,t){void 0==h&&(h=!1);void 0==k&&(k="");void 0==t&&(t="2");var v=!0,w=e.split(",");if(!h)for(var s in w)w.hasOwnProperty(s)&&void 0==b[w[s]]&&(v=!1);v?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=g,a[c].units=k,a[c].decimalPlaces=t):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
c[0])+"_"+c[1],y$(c)&&y$(c).click())}else console.log("O Valor n\ufffdo pode ser lan\ufffdado por n\ufffdo cumprir condi\ufffd\ufffdes de exist\ufffdncia"),window.alert("O valor n\ufffdo \ufffd consistente.\nRevise valores do campo pai e o pr\ufffdprio valor lan\ufffdado\nTente novamente"),y$(a).click()}}
...
d;e.openNextField=[];e.openNextField.name="openNextField";e.openNextField.type="hidden";e.openNextField.value=1;var a=getX(g)+parseInt(g.offsetWidth),t=getY(g)+parseInt(g.offsetHeight);e._position=[];e._position.name="_position";e._position.type="hidden";e._position.value={x:a,y:t};e._position.onChangesFuncName=f;askValue("/",'javascript:dynSetCellValue("'+c+"_"+b+'")',e)}:null)}
...
function fillTable(a,b,c,d,e,f,g,h,k){ycomm.invoke("yeapfDB","doSQL",{sql:'"'+b+'"'},function(b,h,k){console.log(b,a);b=c.split(",");h="";for(var s=0;s<b.length;s++)h+='<td><a href="{1}">%({0})</a></td>'.format(b[s],d);ycomm.dom.fillElement(a,k,{onNewItem:f,rows:[h],inplaceData:[e],onNewItem:f,onReady:g})})}function getCheckboxTable(a){return y$(a).parentElement?y$(a).parentElement.parentElement:null}
...
function $value(a,b){var c=y$(a);return c?c.value:b}function __saveFormInfo(a){var b=$value("s",""),c=$value("a",""),c="save"+c.ucFirst(),d=$value("id",""),e;"checkbox"==a.type?e=a.checked?a.value:"":"text"==a.type&&(e=a.value);var f=a.id,f=f.replace(".","_");_dump("u",u,"s",b,"a",c,"id",d,"eID",a.id,"v",e);_DO(b,c,"(id,"+f+")","("+d+","+e+")")}
function __dynOnChange__(a){void 0==a&&(a=window.event||arguments.callee.caller.arguments[0]);a.target&&(a=a.target);a.childOpenCondition&&console.log(a.childOpenCondition)}function __cbOnChange__(a,b){void 0==a&&(a=window.event||arguments.callee.caller.arguments[0]);a.target&&(a=a.target);void 0==b&&(b=a.dynSaveOnChange);_dump("check ",a.id,a.checked);void 0!=a.dynOnChange&&a.dynOnChange();b&&__saveFormInfo(a);dynCleanChilds(a,document)}_dump("ydyntable");