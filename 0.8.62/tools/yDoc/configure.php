...
*/
  ...
  echo "<div class=cpyrght><strong><big><I>tools/yDoc/configure.php</I></big></strong><br>
    YeAPF 0.8.62-2 built on 2019-03-22 10:21 (-3 DST)<br>
    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion"))
        if (("0.8.62") != yeapfVersion())
          die("<ul class=err>Your configure version is '0.8.62' while your installed version is '".yeapfVersion()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>");
