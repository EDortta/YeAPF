 ...
 **********************************************/
 ...
 console.log("YeAPF 0.8.62-214 built on 2019-06-03 17:33 (-3 DST)");
 /* START yopcontext.js */
     /***********************************************************************
      * First Version (C) 2014 - esteban daniel dortta - dortta@yahoo.com
      *
   ...
   that.loadLibrary = function (jsFileName, elementId, onload) {
     ...
     if (jsFileName>'') {
       if (that.selfLocation.substr(0,17)!='chrome-extension:')
         jsFileName = that.selfLocation+'/'+jsFileName+'?v=0.8.62';
       else {
         // chrome.runtime.id
 ...
 /* START ymisc.js */
     ...
     String.prototype.extenso = function(c) {
       var ex = [
         ["zero", "um", "dois", "trÃÂªs", "quatro", "cinco", "seis", "sete", "oito", "nove", "dez", "onze", "doze", "treze", "quatorze", "quinze", "dezesseis", "dezessete", "dezoito", "dezenove"],
         ["dez", "vinte", "trinta", "quarenta", "cinqÃÂ¼enta", "sessenta", "setenta", "oitenta", "noventa"],
         ["cem", "cento", "duzentos", "trezentos", "quatrocentos", "quinhentos", "seiscentos", "setecentos", "oitocentos", "novecentos"],
         ["mil", "milhÃÂ£o", "bilhÃÂ£o", "trilhÃÂ£o", "quadrilhÃÂ£o", "quintilhÃÂ£o", "sextilhÃÂ£o", "setilhÃÂ£o", "octilhÃÂ£o", "nonilhÃÂ£o", "decilhÃÂ£o", "undecilhÃÂ£o", "dodecilhÃÂ£o", "tredecilhÃÂ£o", "quatrodecilhÃÂ£o", "quindecilhÃÂ£o", "sedecilhÃÂ£o", "septendecilhÃÂ£o", "octencilhÃÂ£o", "nonencilhÃÂ£o"]
       ];
       ...
       for (var f = n.length - 1, l, j = -1, r = [], s = [], t = ""; ++j <= f; s = []) {
         ...
         for (a = -1, l = v.length; ++a < l; t = "") {
           ...
           s.push((i < 100 ? t : (!(i % 100)) ? ex[2][i == 100 ? 0 : i / 100 >> 0] : (ex[2][i / 100 >> 0] + e + t)) +
             ((t = l - a - 2) > -1 ? " " + (i > 1 && t > 0 ? ex[3][t].replace("ÃÂ£o", "ÃÂµes") : ex[3][t]) : ""));
         }
