...
!a.isWorker&&a.isChromeExtension&&!chrome.storage;a.loadLibrary=function(b,c,d){var e;if(""<b){if("chrome-extension:"!=a.selfLocation.substr(0,17))b=a.selfLocation+"/"+b+"?v=0.8.62";else{for(var f=a.selfLocation.split("/"),g="",h=3;h<f.length;h++)""<f[h]&&(""<g&&(g+="/"),g+=f[h]);b=g+"/"+b+"?v=0.8.34"}b=b.replace(/\/\//g,"/");b=b.replace("http:/","http://");b=b.replace("https:/","https://");f=b.split("/");0<f.length&&(e=f[f.length-1]);"function"==typeof importScripts?importScripts(b):(f=
...
e=getElementsByClassName(document,"*",e),0<e.length&&(b?a=e:(b=!1,a=array_intersect(a||[],e)));d=a}return d}})();"undefined"==typeof $&&($=y$);window.createDOMEvent=function(a){var b=null;isOnMobile()?(b=document.createEvent("Event"),b.initEvent(a,!0,!0)):b=new Event(a);return b};
...
-1,d=0;d<a.containerList.length;d++)a.containerList[d].element==b&&(c=d);return c};a.addContainer=function(b){0>a.initialized&&a.init();if(b){var c=a.getContainerNdx(b);0>c?(c=a.containerList.length,a.containerList[c]={childs:[],element:b,currentTabNdx:-1}):a.containerList[c].childs=[];b=b.getElementsByClassName("tnTab");for(var d in b)b.hasOwnProperty(d)&&"object"==typeof b[d]&&(a.containerList[c].childs[a.containerList[c].childs.length]=b[d],a.hideTab(b[d]));a.currentContainerNdx=c}};a.addTab=function(b){0>
a.initialized&&a.init();if(b){var c=a.getCurrentContainer().childs;0>c.indexOf(b)&&(c[c.length]=b)}};a.init=function(b){if(0>a.initialized){_dump("Initializing tabs");a.initialized=0;b=y$("tnContainer");var c=null,d=null,c=0;if(b)for(c=0;c<b.length;c++)d=b[c],a.addContainer(d);else _dump("ERROR: No containers defined. Use 'tnContainer' class on a DIV");if(b=y$("tnTab"))for(c=0;c<b.length;c++)a.hideTab(b[c]);else _dump("ERROR: No tabs defined. Use 'tnTab' class on a DIV");0<a.containerList.length&&
(c=a.containerList[0].childs[0],a.displayTab(a.getFirstChildTab(c)));a.currentContainerNdx=0;a.initialized=1}ycomm&&ycomm.setWaitIconControl(a.waitIconControl);return a};a.currentTabId=function(){return a._currentTab||""};a.currentTab=function(){return y$(a.currentTabId())};a.createTab=function(b,c){var d=null;void 0==y$(c)&&(d=document.createElement("div"),d.className="tnTab",d.style.display="none",d.id=c,b.appendChild(d),a.addTab(d),a.hideTab(d));return d};a.delTab=function(a){};a.displayTab=function(b,
c){if(!a.changingView){a.changingView=!0;try{if(!a.locked()&&b){0>a.initialized&&a.init();_dumpy(64,1,"displayTab "+b.id);var d=!0,e=0;if(d=b.dispatchEvent(a.tabchangeEvent)||d){var f=a.getContainerFromParam(c);if(f){_dumpy(64,1,"canchange");for(var d=-1,g=!1,e=0;e<f.childs.length;e++)f.childs[e]!=b?g|=!a.hideTab(f.childs[e],b,f):d=e;_dumpy(64,1,"readytochange "+!g);if(g)_dumpy(64,1,"freeze");else{a.setCurrentContainer(a.getContainerNdx(f));f.currentTabNdx=d;a._currentTab=b.id;b.dispatchEvent(a.tabfocusEvent);
