<?php
/*
    skel/webApp/templates/bs4-backup/configure.php
    YeAPF 0.8.62-213 built on 2019-05-29 11:47 (-3 DST)
    Copyright (C) 2004-2019 Esteban Daniel Dortta - dortta@yahoo.com
    2019-05-29 11:47:21 (-3 DST)
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.62-213 built on 2019-05-29 11:47 (-3 DST)\n");
  ...
  echo sayStep("<div style='border-left: solid 4px black; padding: 12px; background-color: #fff'>
    ...
    <h2><big><I>skel/webApp/templates/bs4-backup/configure.php</I></big></h2>
    <h3>YeAPF 0.8.62-213 built on 2019-05-29 11:47 (-3 DST)<br>
    Copyright (C) 2004-2019 Esteban Daniel Dortta - dortta@yahoo.com<br>
    Last modification: 2019-05-29 11:47:21 (-3 DST)</h3></div>");
  ...
  $ySearchPath="includes;YeAPF/includes;YeAPF/.distribution/0.8.62/includes;lib;lib/YeAPF;lib/YeAPF/includes";
  ...
  if ($canConfig) {
    ...
    if (function_exists("yeapfVersion")) {
      if (("%"."YEAPF_VERSION%")==yeapfVersion())
        ...
        if (("0.8.62") != yeapfVersion())
          dieConfig(sayStep("<span class=redDot></span><ul class=err>Your configure version is '0.8.62' while your installed version is '".yeapfVersion()." at ".yeapfBaseDir()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>"));
    }
                  ...
                  */
                  ...
                  if (function_exists("yeapfVersion"))
                    if (("%"."YEAPF_VERSION%")==yeapfVersion()) {
                      ...
                      if (("0.8.62") != yeapfVersion())
                        _yLoaderDie(true, "Your configure version is \'0.8.62\' while your installed version is \'".yeapfVersion()."\'");
                    }
                  if (!isset($appName))
                    $appName = "dummy";
