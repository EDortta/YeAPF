/* YeAPF 0.8.62-18 built on 2019-04-04 23:38 (-3 DST) Copyright (C) 2004-2019 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.62-18 built on 2019-04-04 23:38 (-3 DST)");
...
"$1.$2.$3-$4")}}String.prototype.isEmail||(String.prototype.isEmail=function(){return isEmail(this)});String.prototype.isCNPJ||(String.prototype.isCNPJ=function(){var a,b=[6,5,4,3,2,9,8,7,6,5,4,3,2],c=this;if(14!=(c=c.replace(/[^\d]/g,"").split("")).length)return!1;for(n=a=0;12>a;n+=c[a]*b[++a]);if(c[12]!=(2>(n%=11)?0:11-n))return!1;for(n=a=0;12>=a;n+=c[a]*b[a++]);return c[13]!=(2>(n%=11)?0:11-n)?!1:!0});
...
if("object"==typeof window&&"undefined"==typeof _onLoadMethods){var _onLoadMethods=[];window.addOnLoadManager=function(a){_onLoadMethods[_onLoadMethods.length]=a};document.addEventListener("DOMContentLoaded",function(a){mTabNav&&mTabNav.init()});__startup=function(){for(var a=0;a<_onLoadMethods.length;a++)if(_onLoadMethods.hasOwnProperty(a)&&void 0!==_onLoadMethods[a])_onLoadMethods[a]()};"object"==typeof cordova?document.addEventListener("deviceready",__startup,!1):window.addEventListener("load",
function(){__startup();if(!isOnMobile()){var a=new Event("deviceready");document.dispatchEvent(a)}},!1);var addEvent=function(a,b,c){"string"==typeof a&&(a=y$(a));if(null!==a&&"undefined"!==typeof a){var d;if("SELECT"!=a.nodeName&&(isArray(a)||"object"==typeof a&&"number"==typeof a.length))for(d=0;d<a.length;d++)addEvent(a[d],b,c);else{b=b.split(" ");var e;for(d=0;d<b.length;d++)e=b[d],a.addEventListener?a.addEventListener(e,c,"change"==e.toUpperCase()):a.attachEvent?a.attachEvent("on"+e,c):a["on"+
e]=c}}},removeEvent=function(a,b,c){"string"==typeof a&&(a=y$(a));if(null!==a&&"undefined"!==typeof a)if(isArray(a))for(b=0;b<a.length;b++)removeEvent(a[b],c);else{var d=b.split(" "),e;for(b=0;b<d.length;b++)e=d[b],a.addEventListener?a.removeEventListener(e,c,!1):a.detachEvent?a.detachEvent("on"+e,c):a["on"+e]=null}}}_dump("ymisc");
...
v(b[q]),t=null!==d?unmaskHTML(k[d]||""):unmaskHTML(k);c.columns&&c.columns[d]&&(c.columns[d].align&&(f.style.textAlign=c.columns[d].align),c.columns[d].type&&(t=yAnalise("%"+c.columns[d].type+"("+t+")")));h||f.addClass("warning");f.innerHTML=0===t.length?"&nbsp;":t;f.style.verticalAlign="top";f.id=a+"_"+C+"_"+p.rows.length;f.setAttribute("colName",d);if("function"==typeof c.onNewItem)c.onNewItem(a,f,k);C+=1}},p,q,t,C,E=(new Date).getTime()-1447265735470,y;"undefined"==typeof window._evtFilled&&(window._evtFilled=
