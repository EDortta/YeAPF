/* YeAPF 0.8.49-16 built on 2016-06-18 12:41 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
...
function getInternetExplorerVersion(){var a=-1;"Microsoft Internet Explorer"==navigator.appName&&null!=/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)&&(a=parseFloat(RegExp.$1));return a}function isInternetExplorer(){return 0<=getInternetExplorerVersion()}function isOnMobile(){var a=!1;return a="undefined"!=typeof mosync?mosync.isAndroid||mosync.isIOS||mosync.isWindowsPhone:/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}
ydbg=function(){return{logLevel:0,logFlag:0}};function __dump__(a){isOnMobile()?mosync.rlog(a):console.log(a)}function _dump(){for(var a="",b,c=0;c<arguments.length;c++)""<a&&(a+=", "),b=arguments[c],"object"==typeof b&&(b=b.toString()),a+=b;__dump__(a)}function _setLogFlagLevel(a,b){ydbg.logFlag=a;ydbg.logLevel=b}
function _dumpy(a,b){if(ydbg.logFlag&a&&ydbg.logLevel>=b){for(var c="",d,e=2;e<arguments.length;e++)""<c&&(c+=", "),d=arguments[e],"object"==typeof d&&(d=d.toString()),c+=d;__dump__(c)}}
...
(c|~e),f),h));return b(a<<g|a>>>32-g,c)},h=function(a){var b="",c="",d;for(d=0;3>=d;d++)c=a>>>8*d&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},g=[],k,s,t,w,v,l,m,p,q;a=this.utf8_encode(a);g=function(a){var b,c=a.length;b=c+8;for(var d=16*((b-b%64)/64+1),e=Array(d-1),f=0,g=0;g<c;)b=(g-g%4)/4,f=g%4*8,e[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;e[b]|=128<<g%4*8;e[d-2]=c<<3;e[d-1]=c>>>29;return e}(a);l=1732584193;m=4023233417;p=2562383102;q=271733878;a=g.length;for(k=0;k<a;k+=16)s=l,t=m,
w=p,v=q,l=c(l,m,p,q,g[k+0],7,3614090360),q=c(q,l,m,p,g[k+1],12,3905402710),p=c(p,q,l,m,g[k+2],17,606105819),m=c(m,p,q,l,g[k+3],22,3250441966),l=c(l,m,p,q,g[k+4],7,4118548399),q=c(q,l,m,p,g[k+5],12,1200080426),p=c(p,q,l,m,g[k+6],17,2821735955),m=c(m,p,q,l,g[k+7],22,4249261313),l=c(l,m,p,q,g[k+8],7,1770035416),q=c(q,l,m,p,g[k+9],12,2336552879),p=c(p,q,l,m,g[k+10],17,4294925233),m=c(m,p,q,l,g[k+11],22,2304563134),l=c(l,m,p,q,g[k+12],7,1804603682),q=c(q,l,m,p,g[k+13],12,4254626195),p=c(p,q,l,m,g[k+14],
17,2792965006),m=c(m,p,q,l,g[k+15],22,1236535329),l=d(l,m,p,q,g[k+1],5,4129170786),q=d(q,l,m,p,g[k+6],9,3225465664),p=d(p,q,l,m,g[k+11],14,643717713),m=d(m,p,q,l,g[k+0],20,3921069994),l=d(l,m,p,q,g[k+5],5,3593408605),q=d(q,l,m,p,g[k+10],9,38016083),p=d(p,q,l,m,g[k+15],14,3634488961),m=d(m,p,q,l,g[k+4],20,3889429448),l=d(l,m,p,q,g[k+9],5,568446438),q=d(q,l,m,p,g[k+14],9,3275163606),p=d(p,q,l,m,g[k+3],14,4107603335),m=d(m,p,q,l,g[k+8],20,1163531501),l=d(l,m,p,q,g[k+13],5,2850285829),q=d(q,l,m,p,g[k+
2],9,4243563512),p=d(p,q,l,m,g[k+7],14,1735328473),m=d(m,p,q,l,g[k+12],20,2368359562),l=e(l,m,p,q,g[k+5],4,4294588738),q=e(q,l,m,p,g[k+8],11,2272392833),p=e(p,q,l,m,g[k+11],16,1839030562),m=e(m,p,q,l,g[k+14],23,4259657740),l=e(l,m,p,q,g[k+1],4,2763975236),q=e(q,l,m,p,g[k+4],11,1272893353),p=e(p,q,l,m,g[k+7],16,4139469664),m=e(m,p,q,l,g[k+10],23,3200236656),l=e(l,m,p,q,g[k+13],4,681279174),q=e(q,l,m,p,g[k+0],11,3936430074),p=e(p,q,l,m,g[k+3],16,3572445317),m=e(m,p,q,l,g[k+6],23,76029189),l=e(l,m,p,
q,g[k+9],4,3654602809),q=e(q,l,m,p,g[k+12],11,3873151461),p=e(p,q,l,m,g[k+15],16,530742520),m=e(m,p,q,l,g[k+2],23,3299628645),l=f(l,m,p,q,g[k+0],6,4096336452),q=f(q,l,m,p,g[k+7],10,1126891415),p=f(p,q,l,m,g[k+14],15,2878612391),m=f(m,p,q,l,g[k+5],21,4237533241),l=f(l,m,p,q,g[k+12],6,1700485571),q=f(q,l,m,p,g[k+3],10,2399980690),p=f(p,q,l,m,g[k+10],15,4293915773),m=f(m,p,q,l,g[k+1],21,2240044497),l=f(l,m,p,q,g[k+8],6,1873313359),q=f(q,l,m,p,g[k+15],10,4264355552),p=f(p,q,l,m,g[k+6],15,2734768916),
m=f(m,p,q,l,g[k+13],21,1309151649),l=f(l,m,p,q,g[k+4],6,4149444226),q=f(q,l,m,p,g[k+11],10,3174756917),p=f(p,q,l,m,g[k+2],15,718787259),m=f(m,p,q,l,g[k+9],21,3951481745),l=b(l,s),m=b(m,t),p=b(p,w),q=b(q,v);return(h(l)+h(m)+h(p)+h(q)).toLowerCase()};
...
b):yAnalise(b[s],b);else for(var t=b.length-1;0<=t&&void 0==e;t--)void 0!=b[t][g]?e=yAnalise(b[t][g],b):void 0!=b[t][s]&&(e=yAnalise(b[t][s],b));else e="string"==eval("typeof "+s)?eval(s):yAnalise(s);void 0==e&&(e="");h[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":h=Math.max(0,parseInt(h[1]));e=parseFloat(e);e=e.toFixed(h);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;
case "tstime":e=timestamp2time(e);break;case "date":e=h[1]?UDate2Date(e,h[1]):UDate2Date(e);break;case "time":e=h[1]?UDate2Time(e,h[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");s=Math.max(0,str2int(h[1]));t=Math.max(k.length-1,str2int(h[2]));h=Math.max(0,str2int(h[3]));e="";for(g=s;g<s+t;g++){var w=onlyDefinedValue(k[g]);""<w&&(e+=" "+w)}0<h&&(e=wordwrap(e,h,"<br>",!0));break;case "quoted":e=('"'+e).trim()+'"';break;
...
var tabNavBase=function(){var a={};isOnMobile()?(a.tabchangeEvent=document.createEvent("Events"),a.tabchangeEvent.initEvent("tabchange"),a.tabblurEvent=document.createEvent("Events"),a.tabblurEvent.initEvent("tabblur"),a.tabfocusEvent=document.createEvent("Events"),a.tabfocusEvent.initEvent("tabfocus")):"function"==typeof Event&&(a.tabchangeEvent=new Event("tabchange"),a.tabblurEvent=new Event("tabblur"),a.tabfocusEvent=new Event("tabfocus"));a.currentTabNdx=-1;a.currentContainerNdx=-1;a.containerList=
[];a.tabList=[];a.storage=null;a.initialized=-1;a.lock={returnTabId:null,locked:!1};a.isContainer=function(a){var c=!1;a&&(c=a.hasClass("tnContainer"));return c};a.isTab=function(a){var c=!1;a&&(c=a.hasClass("tnTab"));return c};a.getContainer=function(b){return a.containerList[b]};a.getCurrentContainer=function(){return a.getContainer(a.currentContainerNdx)};a.getContainerById=function(b){for(var c=null,d=0;d<a.containerList.length;d++)a.containerList[d].element.id==b&&(c=a.containerList[d]);return c};
a.getTabContainer=function(b){var c=null;if(b)for(var d=0;d<a.containerList.length&&null==c;d++)for(var e=0;e<a.containerList[d].childs.length&&null==c;e++)"string"==typeof b?a.containerList[d].childs[e].id==b&&(c=a.containerList[d]):a.containerList[d].childs[e]==b&&(c=a.containerList[d]);return c};a.getFirstTabInContainer=function(b){var c=null,d;"string"==typeof b&&(b=y$(b));a.isTab(b)?d=a.getTabContainer(b):(b=a.getContainerNdx(b),0<=b&&(d=a.containerList[b]));d&&(c=d.childs[0]);return c};a.getFirstChildTab=
function(b){var c=null;"string"==typeof b&&(b=y$(b));if(a.isTab(b)){var d=b.getElementsByClassName("tnContainer");d.hasOwnProperty("0")?(b=a.getContainerNdx(d[0]),0<=b&&(c=a.containerList[b].childs[0])):c=b}return c};a.getContainerFromParam=function(b,c){void 0==b?b=void 0==c?a.getCurrentContainer():a.getTabContainer(c):"string"==typeof b?b=a.getContainerById(b):isNumber(b)?b=a.getContainer(b):"object"!=typeof b&&(_dump("getContainerFromParam() parameter is not null, valid string, object nor a number"),
b=null);return b};a.getCurrentTabNdx=function(b){var c=-1;if(b=a.getContainerFromParam(b))c=b.currentTabNdx;return c};a.setCurrentContainer=function(b){0>a.initialized&&a.init();a.currentContainerNdx=b%a.containerList.length};a.getContainerNdx=function(b){for(var c=-1,d=0;d<a.containerList.length;d++)a.containerList[d].element==b&&(c=d);return c};a.addContainer=function(b){0>a.initialized&&a.init();if(b&&0>a.getContainerNdx(b)){a.currentContainerNdx=a.containerList.length;a.containerList[a.currentContainerNdx]=
{childs:[],element:b,currentTabNdx:-1};b=b.getElementsByClassName("tnTab");for(var c in b)b.hasOwnProperty(c)&&"object"==typeof b[c]&&(a.containerList[a.currentContainerNdx].childs[a.containerList[a.currentContainerNdx].childs.length]=b[c])}};a.addTab=function(b){0>a.initialized&&a.init();if(b){var c=a.getCurrentContainer().childs;0>c.indexOf(b)&&(c[c.length]=b)}};a.init=function(b){if(0>a.initialized){a.initialized=0;b=y$(".tnContainer");var c=null,d=null,c=0;if(b)for(c=0;c<b.length;c++)d=b[c],a.addContainer(d);
if(b=y$(".tnTab"))for(c=0;c<b.length;c++)a.hideTab(b[c]);0<a.containerList.length&&(c=a.containerList[0].childs[0],a.displayTab(a.getFirstChildTab(c)));a.currentContainerNdx=0;a.initialized=1}ycomm&&ycomm.setWaitIconControl(a.waitIconControl);return a};a.currentTab=function(b){b=a.getCurrentContainer();return-1<b.currentTabNdx?b.childs[b.currentTabNdx]:null};a.createTab=function(b,c){var d=null;void 0==y$(c)&&(d=document.createElement("div"),d.className="tnTab",d.style.display="none",d.id=c,b.appendChild(d),
a.addTab(d),a.hideTab(d));return d};a.delTab=function(a){};a.displayTab=function(b,c){if(!a.changingView){a.changingView=!0;try{if(!a.locked()&&b){0>a.initialized&&a.init();_dumpy(64,1,"displayTab "+b.id);var d=!0,e=0;if(d=b.dispatchEvent(a.tabchangeEvent)||d){var f=a.getContainerFromParam(c);if(f){_dumpy(64,1,"canchange");for(var d=-1,h=!1,e=0;e<f.childs.length;e++)f.childs[e]!=b?h|=!a.hideTab(f.childs[e],b,f):d=e;_dumpy(64,1,"readytochange "+!h);if(h)_dumpy(64,1,"freeze");else{a.setCurrentContainer(a.getContainerNdx(f));
f.currentTabNdx=d;b.dispatchEvent(a.tabfocusEvent);b.style.display="block";for(f=b;f&&f!=document.body;)f.style.display="block",f=f.parentNode;for(var g=b.getElementsByTagName("*"),e=0;e<g.length;){if("checkbox"==g[e].type||"radio"==g[e].type||"password"==g[e].type||"hidden"==g[e].type||"text"==g[e].type||"select-one"==g[e].type||"textarea"==g[e].type){g[e].focus();break}e++}}}}_dumpy(64,1,"return")}}finally{a.changingView=!1}}};a.showWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display=
...
h[s],y$(fieldName)&&y$(fieldName).addClass("fieldWarning");if(c.formError){h="";for(s in c.formError)c.formError.hasOwnProperty(s)&&(""<h&&(h+="\n"),h+=c.formError[s]);alert(h)}}if(a){void 0!=c.formID&&""==formID&&(formID=c.formID);c.firstRow=parseInt(c.firstRow);c.rowCount=parseInt(c.rowCount);c.requestedRows=parseInt(c.requestedRows);s=c.rowCount;b=a.data?a.data.row:a.row;1==s&&(b=Array(b));if(b)for(var t in b)if(b.hasOwnProperty(t))for(var w in b[t])b[t].hasOwnProperty(w)&&(b[t][w]=unmaskHTML(b[t][w]));
...
typeof c.onNewItem)c.onNewItem(a,m,b[l])}}else if("LISTBOX"==k.nodeName){if(d)for(;0<k.childElementCount;)k.childNodes[0].remove();t=0;for(l in b)if(b.hasOwnProperty(l)){b[l]._elementid_=a;h=document.createElement("listitem");p=0;if("undefined"==typeof c.columns)if("string"==typeof b[l])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[l]){if(b[l].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){s=document.createElement("listcell");s.innerHTML=b[l][f];s.id=a+"_"+
p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,s,b[l]);p+=1;h.appendChild(s)}}else for(f in c.columns)if(f!=e){s=document.createElement("listcell");s.innerHTML=b[l][f];s.id=a+"_"+p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,s,b[l]);p+=1;h.appendChild(s)}k.appendChild(h);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d)for(;0<k.options.length;)k.options.remove(0);p=0;for(l in b)if(b.hasOwnProperty(l)){b[l]._elementid_=a;t="";if("undefined"==typeof c.columns)if("string"==
...
ycomm.dom.getFormElements=function(a,b){b=b||{};for(var c=b.elementPrefixName||"",d=b.elementPostixName||"",e={},f=this.selectElements(a),h,g,k,s,t,w,v,l=0;l<f.length;l++)if(s=f[l].getAttribute("editMask")||"",t=f[l].getAttribute("storageMask")||"",w=f[l].getAttribute("valueType")||"text",v=!0,g=f[l].type.toLowerCase(),h=f[l].name||f[l].id,h.substr(h.length,-d.length)==d&&h.substr(0,c.length)==c&&(h=h.substr(c.length),h=h.substr(0,h.length-d.length),""<h)){k="";if("radio"==g||"checkbox"==g)v=!1,"undefined"==
typeof e[h]&&(e[h]="");switch(g){case "text":case "password":case "textarea":case "email":case "hidden":k=f[l].value+"";""<s&&""<t&&0<=w.indexOf("date")&&(k=(k=dateTransform(k,s,t))?k+"":"");break;case "radio":case "checkbox":k=f[l].checked?f[l].value:"";v=""!==k;break;case "select-one":case "select-multi":k=f[l].selectedIndex,f[l].options[k]&&(k=f[l].options[k].value)}"string"==typeof k&&0<=k.indexOf(",")&&(k=encodeURIComponent(k));v&&(e[h]=k)}return e};
...
"calBand",d=!0),e="",1==b.cfg.orientation?x<y||x>A?D():0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented")),""<e&&(h=m+"Cell",0===x.getDay()&&(h+=" "+m+"FreeCell"),x.getDate()==b.cfg.date.getDate()&&(h+=" "+m+"Highlight"),k=document.createElement("div"),mergeObject(z,k.style),k.id=f,k.className=h,mergeObject(z,k.style),k.date=x,s=document.createElement("span"),
s.id=f+"_tag",s.className="calTag",null!=b.cfg.callback&&(g=b.cfg.callback(b,"getTagContent",s)||"",""<g&&(e=g)),s.innerHTML=e,k.appendChild(s),null!=b.cfg.callback&&(t=b.cfg.callback(b,"getCellContent",k)||"",""<t&&(k.innerHTML+=t)),q.appendChild(k)),1==b.cfg.orientation?x.setTime(x.getTime()+w*b.context.nRows):x.setTime(x.getTime()+w),v++,v>=b.context.nCols&&(v=0,l++,d=!1,1==b.cfg.orientation&&(x=G[l])),F--;if(d){for(;v<b.context.nCols;)D();v=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
...
function calcGridAddItem(a,b,c,d,e,f,h,g,k,s){void 0==g&&(g=!1);void 0==k&&(k="");void 0==s&&(s="2");var t=!0,w=e.split(",");if(!g)for(var v in w)w.hasOwnProperty(v)&&void 0==b[w[v]]&&(t=!1);t?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=h,a[c].units=k,a[c].decimalPlaces=s):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
function fillTable(a,b,c,d,e,f,h,g,k){ycomm.invoke("yeapfDB","doSQL",{sql:'"'+b+'"'},function(b,g,k){console.log(b,a);b=c.split(",");g="";for(var v=0;v<b.length;v++)g+='<td><a href="{1}">%({0})</a></td>'.format(b[v],d);ycomm.dom.fillElement(a,k,{onNewItem:f,rows:[g],inplaceData:[e],onNewItem:f,onReady:h})})}function getCheckboxTable(a){return y$(a).parentElement?y$(a).parentElement.parentElement:null}
