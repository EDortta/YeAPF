/* YeAPF 0.8.49-92 built on 2016-07-14 08:17 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.49-92 built on 2016-07-14 08:17 (-3 DST)");
...
ycomm._removeJSONP=function(a,b){var c=document.head,d="rest_"+a,e=document.getElementById(d);void 0!==c&&void 0!==e?(clearTimeout(e._whatchdog_),e.abort(),c.removeChild(e),_dumpy(4,1,"Clean "+d+" after call to "+b+"()")):_dumpy(4,1,"Script not found: "+d+" adressed to "+b+"()");_dumpy(4,1,ycomm.getStatus())};
ycomm.bring=function(a){var b=document.head,c=document.createElement("script");_dumpy(4,1,a);var d=null,e=null,f=a.substr(a.indexOf("?")+1).split("&"),h;for(h in f)if(f.hasOwnProperty(h)){var g=f[h].split("=");"scriptSequence"==g[0]&&(d=g[1]);"callback"==g[0]&&(e=g[1])}ycomm._maxScriptSequenceReceived=Math.max(ycomm._maxScriptSequenceReceived,d);c.UUID=generateUUID();c.maxWaitCount=ycomm.timeout/ycomm.wd_interval+2;c.callbackFunctionName=e;c.onload=function(){0<ycomm._load&&ycomm._load--};c.abort=
function(){_dumpy(4,1,"Calling {0}(404);".format(e));setTimeout("{0}(404,{message: 'Server do not respond'}, {})".format(e),100)};c.pool=function(){_dumpy(4,5,this.UUID+" : "+this.maxWaitCount);this.maxWaitCount--;0<this.maxWaitCount?this._whatchdog_=setTimeout(this.id+".pool()",ycomm.wd_interval):this.abort()};c.setAttribute("src",a);c.id="rest_"+d;try{_dumpy(4,2,"Creating {0} as {1}".format(c.UUID,c.src)),b.appendChild(c),setTimeout(c.id+".pool()",ycomm.wd_interval)}catch(k){_dumpy(4,0,"Exception: {0}".format(k.message))}setTimeout("ycomm._removeJSONP("+
d+",'"+e+"');",ycomm.timeout)};
ycomm.crave=function(a,b,c,d,e){var f="undefined"==typeof u?"":u;"undefined"==typeof e&&(e=0);ycomm._scriptSequence++;if(this.getDataLocation()){var h;"function"==typeof d?(ycomm._CBSeq++,h="ycb"+ycomm._CBSeq,ycomm._CBControl[h]={ready:!1},window[h]=function(a,b,c,e,f,v){d(a,b,c,e,f,v);_dumpy(4,1,h)}):"string"==typeof d?h=d:console.error("param callBackFunction need to be function or string");""<h&&(ycomm._load++,a=this.buildCommonURL(a||"",b||"",c||{},f),a="{0}?{1}&callback={2}&callbackId={3}&scriptSequence={4}&deviceId={5}".format(this._dataLocation_,a,
