/* YeAPF 0.8.49-34 built on 2016-06-27 10:46 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.49-34 built on 2016-06-27 10:46 (-3 DST)");
...
if("undefined"==typeof getElementsByClassName){var getElementsByClassName=function(a,b,c){console.log("getElementsByClassName('"+b+"', '"+c+"')");a=a.getElementsByTagName(b);b=[];for(var d,e=0;e<a.length;e++)(d=a[e])&&"function"==typeof d.hasClass&&d.hasClass(c)&&b.push(d);null==b&&(b=document.getElementsByClassName(c));return b};console.log("Using own 'getElementsByClassName()' function")}
