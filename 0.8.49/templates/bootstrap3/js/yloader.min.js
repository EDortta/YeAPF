/* YeAPF 0.8.49-123 built on 2016-08-17 12:55 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.49-123 built on 2016-08-17 12:55 (-3 DST)");
...
break;case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(g=0;g<h.length;g++)""<e&&(e+=","),e+="'"+h[g]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}c=!1;d="< > == != <= >=".split(" ");for(f=0;f<d.length;f++)c|=0<=a.indexOf(d[f]);c&&(a=eval(a))}else a="";return a}_dump("yanalise");
