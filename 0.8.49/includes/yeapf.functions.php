<?php
  ...
  */
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").globalSafeVarValue('_debugTag')." ".basename(__FILE__)." 0.8.49 ".": START\n",3,"logs/yeapf.loader.log");
  ...
  _recordWastedTime("STARTUP 0.8.49 -----------------------------------------");
  ...
  // indica se um dos arquivos processados È um XML e muda o cabeÁalho
  $xmlOutput=0;
  ...
  */
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." 0.8.49 ".": loading $user_IP config file\n",3,"logs/yeapf.loader.log");
    ...
    function _yLoaderDie($reconfigureLinkEnabled)
    {
      ...
      if (!$isXML) {
        if ($isCLI) {
          ...
          $copyrightNote='<small><em>YeAPF Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com</em></small>';
  ...
  */
  ...
  // parse_str($qs);
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.49 ".": publishing form request\n",3,"logs/yeapf.loader.log");
  ...
  if ($s=='y_msg')
    ...
    _dump("\n$_debugTag ===[".basename($_MYSELF_)."]========================= YeAPF 0.8.49");
    if ($yeapfLogFlags>0)
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.49 ".": function block #1\n",3,"logs/yeapf.loader.log");
  ...
  function _saveConfigFile()
  {
    ...
    if (lock('yeapfConfig')) {
      ...
      if ($f) {
        ...
        fputs($f," * YEAPF Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com\n");
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.49 ".": function block #2\n",3,"logs/yeapf.loader.log");
  ...
  {
    global $autoDocCurToken,$autoDocParamCounter, $autoDocLevel, $_ydb_ready;
  ...
  {
    global $autoDocCurToken,$autoDocParamCounter, $_ydb_ready;
...
//      echo "r=$r&#32;t=$t&#32;a=$a<br>";
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.49 ".": function block #3\n",3,"logs/yeapf.loader.log");
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.49 ".": function block #4\n",3,"logs/yeapf.loader.log");
...
//    echo "d=$diretorio<BR>hifen=$hifen<br>seed=$seed<br>funcao=$funcao<br>inicio=$incio<br>limite=$limite<br>";
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.49 ".": function block #?\n",3,"logs/yeapf.loader.log");
...
*/
      ...
      if (!isset($_IncludedFiles[$fileName])) {
        ...
        if ((substr($fileName,$p,5)=='.form') && ($podeProcessar))
          ...
          if (isset($yeapfConfig['context'])) {
            ...
            if (
                 (substr($rpFileName,0,strlen($yeapfConfig['context']))==$yeapfConfig['context']) ||
  ...
  if (file_exists("flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." 0.8.49 ".": yeapf.functions.php loaded and ready\n",3,"logs/yeapf.loader.log");

  _recordWastedTime("READY 0.8.49 ---------------------------------------- ");
