/* YeAPF 0.8.49-82 built on 2016-07-07 18:24 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.49-82 built on 2016-07-07 18:24 (-3 DST)");
...
ycomm._removeJSONP=function(a,b){var c=document.head,d="rest_"+a,e=document.getElementById(d);void 0!==c&&void 0!==e?(clearTimeout(e._whatchdog_),e.abort(),c.removeChild(e),_dumpy(4,1,"Clean "+d+" after call to "+b+"()")):_dumpy(4,1,"Script not found: "+d+" adressed to "+b+"()");_dumpy(4,1,ycomm.getStatus())};ycomm.rest_timeout=15E3;
ycomm.bring=function(a){var b=document.head,c=document.createElement("script");_dumpy(4,1,a);var d=null,e=null,f=a.substr(a.indexOf("?")+1).split("&"),h;for(h in f)if(f.hasOwnProperty(h)){var g=f[h].split("=");"scriptSequence"==g[0]&&(d=g[1]);"callback"==g[0]&&(e=g[1])}ycomm._maxScriptSequenceReceived=Math.max(ycomm._maxScriptSequenceReceived,d);c.UUID=generateUUID();c.maxWaitCount=ycomm.rest_timeout/250+2;c.callbackFunctionName=e;c.onload=function(){0<ycomm._load&&ycomm._load--};c.abort=function(){console.warn("Calling {0}(404);".format(e));
setTimeout("{0}(404,{message: 'Server do not respond'}, {})".format(e),100)};c.pool=function(){console.log(this.UUID+" : "+this.maxWaitCount);this.maxWaitCount--;0<this.maxWaitCount?this._whatchdog_=setTimeout(this.id+".pool()",250):this.abort()};c.setAttribute("src",a);c.id="rest_"+d;try{b.appendChild(c),setTimeout(c.id+".pool()",250)}catch(k){console.log(k.message)}setTimeout("ycomm._removeJSONP("+d+",'"+e+"');",ycomm.rest_timeout)};
