...
/*
    ...
    YeAPF 0.8.49-117 built on 2016-08-16 18:16 (-3 DST)
    Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com
    2016-08-16 18:16:16 (-3 DST)
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.49-117 built on 2016-08-16 18:16 (-3 DST)\n");
  ...
  echo echoStep("<div class=cpyrght><strong><big><I>skel/webSocket/configure.php</I></big></strong><br>
    YeAPF 0.8.49-117 built on 2016-08-16 18:16 (-3 DST)<br>
    Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com<br>
    2016-08-16 18:16:16 (-3 DST)</div>");
  ...
  $ySearchPath="includes;YeAPF/includes;YeAPF/.distribution/0.8.49/includes;lib;lib/YeAPF;lib/YeAPF/includes";
    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion")) {
        if (("%"."YEAPF_VERSION%")==yeapfVersion())
          ...
          if (("0.8.49") != yeapfVersion())
            die(echoStep("<ul class=err>Your configure version is '0.8.49' while your installed version is '".yeapfVersion()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>"));
      }
              ...
              */
              ...
              if (function_exists("yeapfVersion"))
                if (("%"."YEAPF_VERSION%")==yeapfVersion()) {
                  ...
                  if (("0.8.49") != yeapfVersion())
                    _yLoaderDie(true, "Your configure version is \'0.8.49\' while your installed version is \'".yeapfVersion()."\'");
                }
              if (!isset($appName))
                $appName = "dummy";
              ...
              echo echoStep("<div style='background: #90EE90; border-style: solid; border-width: 2px; border-color: #00BD00; padding: 32px'><big><u>YeAPF 0.8.49 well configured!</u></big><div style='padding-left: 16px'>Location: <b>$__PL__</b><br>DB config: <b>$sgugIni</b></div><br>Click <a href='$referer_uri'>here</a> to go back.<br> Click <a href='index.php'>here</a> to start your app.<br>$developLink<small style='margin: 16px'>If you wish to destroy database connection an recreate it, click <a href='configure.php?destroydb=yes'>here</a><br><i>It will preserve your database data but will remove all other definitions except the one contained in<em>yeapf.db.ini</em></i></small></div>");
