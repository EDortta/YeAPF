<?php
  ...
  */
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").globalSafeVarValue('_debugTag')." ".basename(__FILE__)." 0.8.60 ".": START\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
  ...
  _recordWastedTime("STARTUP 0.8.60 -----------------------------------------");
  ...
  */
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." 0.8.60 ".": loading $user_IP config file\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
  ...
  */
  ...
  // parse_str($qs);
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.60 ".": publishing form request\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
  ...
  if ($s=='y_msg')
    ...
    _dump("\n$_debugTag ===[".basename($_MYSELF_)."]========================= YeAPF 0.8.60");
    if ($yeapfLogFlags>0)
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.60 ".": function block #1\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.60 ".": function block #2\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
...
//      echo "r=$r&#32;t=$t&#32;a=$a<br>";
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.60 ".": function block #3\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.60 ".": function block #4\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
...
//    echo "d=$diretorio<BR>hifen=$hifen<br>seed=$seed<br>funcao=$funcao<br>inicio=$incio<br>limite=$limite<br>";
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." ".__LINE__." 0.8.60 ".": function block #?\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");
...
*/
  ...
  if (file_exists("$cfgMainFolder/flags/flag.dbgloader")) error_log(date("YmdHis ").$GLOBALS['_debugTag']." ".basename(__FILE__)." 0.8.60 ".": yeapf.functions.php loaded and ready\n",3,"$cfgCurrentFolder/logs/yeapf.loader.log");

  _recordWastedTime("READY 0.8.60 ---------------------------------------- ");
