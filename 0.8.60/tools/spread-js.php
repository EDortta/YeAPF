<?php
  ...
  function copyFile($srcFileName, $tgtFolder, $addHeader = false)
  {
    if (file_exists($srcFileName)) {
      ...
      if ($addHeader) {
        $auxFile = "/* YeAPF 0.8.60-24 built on 2018-05-15 18:13 (-3 DST) Copyright (C) 2004-2018 Esteban Daniel Dortta - dortta@yahoo.com */\n".$auxFile;
      }
  ...
  if (file_exists($minJS)) {
    ...
    $yeapf_minJS = "/* YeAPF 0.8.60-24 built on 2018-05-15 18:13 (-3 DST) Copyright (C) 2004-2018 Esteban Daniel Dortta - dortta@yahoo.com */\n".$yeapf_minJS;
  }
