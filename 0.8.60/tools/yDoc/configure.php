...
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.60-24 built on 2018-05-15 18:13 (-3 DST)\n");
  ...
  echo "<div class=cpyrght><strong><big><I>tools/yDoc/configure.php</I></big></strong><br>
    YeAPF 0.8.60-24 built on 2018-05-15 18:13 (-3 DST)<br>
  ...
  $ySearchPath="includes;YeAPF/includes;YeAPF/.distribution/0.8.60/includes;lib;lib/YeAPF;lib/YeAPF/includes";
    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion"))
        if (("0.8.60") != yeapfVersion())
          die("<ul class=err>Your configure version is '0.8.60' while your installed version is '".yeapfVersion()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>");
          ...
          */
          ...
          if ($yeapfDB_configured) {
            ...
            */
            ...
            if (function_exists("yeapfVersion"))
              if (("0.8.60") != yeapfVersion())
                _yLoaderDie(true, "Your configure version is \'0.8.60\' while your installed version is \'".yeapfVersion()."\'");
            if (!isset($appName))
              $appName = "dummy";
