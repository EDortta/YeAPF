 ...
 * modified at 13/oct/2011 by dortta@yahoo.com
 */
...
function OnMouseDown(e)
{
   ...
   if ((e.button == 1 && window.event != null || e.button == 0) && target.className == 'drag') {
    ...
    for (var i = 0; i < divList.length; i++) {
      var aDiv = divList[i];
      if ((aDiv.className=='drag') && (aDiv != target)) {
...
function OnMouseMove(e)
{
  ...
  _debug.innerHTML = '(' + _dragElement.style.left + ', ' + _dragElement.style.top + _dragElement.style.zIndex + ')';
}

function OnMouseUp(e)
{
  if (_dragElement != null) {
    _dragElement.style.zIndex = parseInt(_dragElement.style.zIndex)-1;
