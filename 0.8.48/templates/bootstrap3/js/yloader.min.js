/* YeAPF 0.8.48-103 built on 2016-05-24 18:54 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
...
typeof e[g]&&(e[g]="");switch(h){case "text":case "password":case "textarea":case "email":case "hidden":k=f[l].value+"";""<s&&""<t&&0<=w.indexOf("date")&&(k=(k=dateTransform(k.unquote(),s,t))?k+"":"");break;case "radio":case "checkbox":k=f[l].checked?f[l].value:"";v=""!==k;break;case "select-one":case "select-multi":k=f[l].selectedIndex,f[l].options[k]&&(k=f[l].options[k].value)}0<=k.indexOf(",")&&(k=encodeURIComponent(k));v&&(e[g]=k)}return e};
