/* YeAPF 0.8.48-99 built on 2016-05-23 11:06 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
...
typeof e[g]&&(e[g]="");switch(h){case "text":case "password":case "textarea":case "email":case "hidden":k=f[l].value+"";""<s&&""<t&&0<=w.indexOf("date")&&(k=(k=dateTransform(k.unquote(),s,t))?k+"":"");k=k.quote();break;case "radio":case "checkbox":k=f[l].checked?f[l].value.quoteString(!0):"";v=""!==k;break;case "select-one":case "select-multi":k=f[l].selectedIndex,f[l].options[k]&&(k=f[l].options[k].value)}v&&(e[g]=k)}return e};
