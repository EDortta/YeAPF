/* YeAPF 0.8.48-81 built on 2016-05-20 11:35 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
...
(c|~d),f),h));return b(a<<g|a>>>32-g,c)},g=function(a){var b="",c="",e;for(e=0;3>=e;e++)c=a>>>8*e&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},h=[],k,s,t,w,v,l,m,p,q;a=this.utf8_encode(a);h=function(a){var b,c=a.length;b=c+8;for(var e=16*((b-b%64)/64+1),d=Array(e-1),f=0,g=0;g<c;)b=(g-g%4)/4,f=g%4*8,d[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;d[b]|=128<<g%4*8;d[e-2]=c<<3;d[e-1]=c>>>29;return d}(a);l=1732584193;m=4023233417;p=2562383102;q=271733878;a=h.length;for(k=0;k<a;k+=16)s=l,t=m,
w=p,v=q,l=c(l,m,p,q,h[k+0],7,3614090360),q=c(q,l,m,p,h[k+1],12,3905402710),p=c(p,q,l,m,h[k+2],17,606105819),m=c(m,p,q,l,h[k+3],22,3250441966),l=c(l,m,p,q,h[k+4],7,4118548399),q=c(q,l,m,p,h[k+5],12,1200080426),p=c(p,q,l,m,h[k+6],17,2821735955),m=c(m,p,q,l,h[k+7],22,4249261313),l=c(l,m,p,q,h[k+8],7,1770035416),q=c(q,l,m,p,h[k+9],12,2336552879),p=c(p,q,l,m,h[k+10],17,4294925233),m=c(m,p,q,l,h[k+11],22,2304563134),l=c(l,m,p,q,h[k+12],7,1804603682),q=c(q,l,m,p,h[k+13],12,4254626195),p=c(p,q,l,m,h[k+14],
17,2792965006),m=c(m,p,q,l,h[k+15],22,1236535329),l=d(l,m,p,q,h[k+1],5,4129170786),q=d(q,l,m,p,h[k+6],9,3225465664),p=d(p,q,l,m,h[k+11],14,643717713),m=d(m,p,q,l,h[k+0],20,3921069994),l=d(l,m,p,q,h[k+5],5,3593408605),q=d(q,l,m,p,h[k+10],9,38016083),p=d(p,q,l,m,h[k+15],14,3634488961),m=d(m,p,q,l,h[k+4],20,3889429448),l=d(l,m,p,q,h[k+9],5,568446438),q=d(q,l,m,p,h[k+14],9,3275163606),p=d(p,q,l,m,h[k+3],14,4107603335),m=d(m,p,q,l,h[k+8],20,1163531501),l=d(l,m,p,q,h[k+13],5,2850285829),q=d(q,l,m,p,h[k+
2],9,4243563512),p=d(p,q,l,m,h[k+7],14,1735328473),m=d(m,p,q,l,h[k+12],20,2368359562),l=e(l,m,p,q,h[k+5],4,4294588738),q=e(q,l,m,p,h[k+8],11,2272392833),p=e(p,q,l,m,h[k+11],16,1839030562),m=e(m,p,q,l,h[k+14],23,4259657740),l=e(l,m,p,q,h[k+1],4,2763975236),q=e(q,l,m,p,h[k+4],11,1272893353),p=e(p,q,l,m,h[k+7],16,4139469664),m=e(m,p,q,l,h[k+10],23,3200236656),l=e(l,m,p,q,h[k+13],4,681279174),q=e(q,l,m,p,h[k+0],11,3936430074),p=e(p,q,l,m,h[k+3],16,3572445317),m=e(m,p,q,l,h[k+6],23,76029189),l=e(l,m,p,
q,h[k+9],4,3654602809),q=e(q,l,m,p,h[k+12],11,3873151461),p=e(p,q,l,m,h[k+15],16,530742520),m=e(m,p,q,l,h[k+2],23,3299628645),l=f(l,m,p,q,h[k+0],6,4096336452),q=f(q,l,m,p,h[k+7],10,1126891415),p=f(p,q,l,m,h[k+14],15,2878612391),m=f(m,p,q,l,h[k+5],21,4237533241),l=f(l,m,p,q,h[k+12],6,1700485571),q=f(q,l,m,p,h[k+3],10,2399980690),p=f(p,q,l,m,h[k+10],15,4293915773),m=f(m,p,q,l,h[k+1],21,2240044497),l=f(l,m,p,q,h[k+8],6,1873313359),q=f(q,l,m,p,h[k+15],10,4264355552),p=f(p,q,l,m,h[k+6],15,2734768916),
m=f(m,p,q,l,h[k+13],21,1309151649),l=f(l,m,p,q,h[k+4],6,4149444226),q=f(q,l,m,p,h[k+11],10,3174756917),p=f(p,q,l,m,h[k+2],15,718787259),m=f(m,p,q,l,h[k+9],21,3951481745),l=b(l,s),m=b(m,t),p=b(p,w),q=b(q,v);return(g(l)+g(m)+g(p)+g(q)).toLowerCase()};
...
function yAnalise(a,b){if(void 0!=a){a=unmaskHTML(a);for(var c=/%[+(\w)]|[]\(/gi,d,e="";0<=(d=a.search(c));){var e=a.slice(d).search(/\(/),f=a.slice(d+e+1,d+e+2);if('"'==f||"'"==f){var g,h=d+e+1;do h++,g=a.slice(h,h+1);while(g!=f&&h<a.length);f=h+a.slice(h).search(/\)/)-d}else f=a.slice(d).search(/\)/);var k=a.slice(d+1,d+e),e=g=a.slice(d+e+1,d+f);g=g.split(",");for(h=0;h<g.length;h++)g[h]=yAnalise(g[h],b);var e=void 0,h=g[0].toUpperCase(),s=g[0];if(void 0!=b)if(void 0==b[0])e=b[h]?yAnalise(b[h],
b):yAnalise(b[s],b);else for(var t=b.length-1;0<=t&&void 0==e;t--)void 0!=b[t][h]?e=yAnalise(b[t][h],b):void 0!=b[t][s]&&(e=yAnalise(b[t][s],b));else e="string"==eval("typeof "+s)?eval(s):yAnalise(s);void 0==e&&(e="");g[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":g=Math.max(0,parseInt(g[1]));e=parseFloat(e);e=e.toFixed(g);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;
case "tstime":e=timestamp2time(e);break;case "date":e=g[1]?UDate2Date(e,g[1]):UDate2Date(e);break;case "time":e=g[1]?UDate2Time(e,g[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");s=Math.max(0,str2int(g[1]));t=Math.max(k.length-1,str2int(g[2]));g=Math.max(0,str2int(g[3]));e="";for(h=s;h<s+t;h++){var w=onlyDefinedValue(k[h]);""<w&&(e+=" "+w)}0<g&&(e=wordwrap(e,g,"<br>",!0));break;case "quoted":e=('"'+e).trim()+'"';break;
case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(h=0;h<g.length;h++)""<e&&(e+=","),e+="'"+g[h]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}}else a="";return a}_dump("yanalise");
...
!0;try{if(!a.locked()&&c){0>a.initialized&&a.init();_dumpy(64,1,"displayTab "+c.id);var g=!0,h=0;if(g=c.dispatchEvent(b)||g){var k=a.getContainerFromParam(f);if(k){_dumpy(64,1,"canchange");for(var g=-1,s=!1,h=0;h<k.childs.length;h++)k.childs[h]!=c?s|=!a.hideTab(k.childs[h],c,k):g=h;_dumpy(64,1,"readytochange "+!s);if(s)_dumpy(64,1,"freeze");else{a.setCurrentContainer(a.getContainerNdx(k));k.currentTabNdx=g;c.dispatchEvent(d);c.style.display="block";for(k=c;k&&k!=document.body;)k.style.display="block",
...
ycomm.explodeData=function(a){var b;a=xml2array(a).root||{};var c=a.dataContext||{},d=a.error||c.error||c.lastError,e=null,f=c.userMsg,g=c.sysMsg;if(g&&g.msg&&"logoff"==g.msg){ycomm.canReceiveMessages=!1;for(var h=window,k;h.opener;)k=h,h=h.opener,k.close();for(;h.parent!=h;)h=h.parent;g.banner&&(_dumpy(4,1,g.banner),alert(g.banner));h.document.location="body.php?s=yeapf&a=logoff"}if(ycomm.canReceiveMessages){if(c){var s;if(c.requiredFields)for(g=c.requiredFields.split(","),s=0;s<g.length;s++)fieldName=
g[s],y$(fieldName)&&y$(fieldName).addClass("fieldWarning");if(c.formError){g="";for(s in c.formError)c.formError.hasOwnProperty(s)&&(""<g&&(g+="\n"),g+=c.formError[s]);alert(g)}}if(a){void 0!=c.formID&&""==formID&&(formID=c.formID);c.firstRow=parseInt(c.firstRow);c.rowCount=parseInt(c.rowCount);c.requestedRows=parseInt(c.requestedRows);s=c.rowCount;b=a.data?a.data.row:a.row;1==s&&(b=Array(b));if(b)for(var t in b)if(b.hasOwnProperty(t))for(var w in b[t])b[t].hasOwnProperty(w)&&(b[t][w]=unmaskHTML(b[t][w]));
...
ycomm.dom.fillInplaceData=function(a,b){for(var c in b)b.hasOwnProperty(c)&&a.setAttribute("data_"+c,b[c])};ycomm.dom.getInplaceData=function(a){};
ycomm.dom.fillElement=function(a,b,c,d){void 0===c&&(c={});void 0===d&&(d=!0);var e,f,g,h,k=y$(a),s="undefined"==typeof ycomm.dom._elem_templates[a];e=c.idFieldName||"id";var t=function(a){var d;p=0;"TR"==a.nodeName&&(a.style.backgroundColor=rowColorSpec.suggestRowColor(B));if(b[l][e])if(y$(b[l][e])){for(d=0;y$(b[l][e]+"_"+d);)d++;a.id=b[l][e]+"_"+d}else a.id=b[l][e];if("undefined"!=typeof c.inplaceData)for(var g=0;g<c.inplaceData.length;g++)f=c.inplaceData[g],d=b[l][f]||"",a.setAttribute("data_"+
...
typeof c.onNewItem)c.onNewItem(a,m,b[l])}}else if("LISTBOX"==k.nodeName){if(d)for(;0<k.childElementCount;)k.childNodes[0].remove();t=0;for(l in b)if(b.hasOwnProperty(l)){b[l]._elementid_=a;g=document.createElement("listitem");p=0;if("undefined"==typeof c.columns)if("string"==typeof b[l])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[l]){if(b[l].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){s=document.createElement("listcell");s.innerHTML=b[l][f];s.id=a+"_"+
p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,s,b[l]);p+=1;g.appendChild(s)}}else for(f in c.columns)if(f!=e){s=document.createElement("listcell");s.innerHTML=b[l][f];s.id=a+"_"+p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,s,b[l]);p+=1;g.appendChild(s)}k.appendChild(g);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d)for(;0<k.options.length;)k.options.remove(0);p=0;for(l in b)if(b.hasOwnProperty(l)){b[l]._elementid_=a;t="";if("undefined"==typeof c.columns)if("string"==
...
0;m<c.inplaceData.length;m++)"undefined"!==typeof b[l][c.inplaceData[m]]&&d.setAttribute("data_"+c.inplaceData[m],b[l][c.inplaceData[m]]);if("function"==typeof c.onNewItem)c.onNewItem(a,d,b[l]);k.appendChild(d);p++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var z,y,s=d?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(var A=b[0]||b,w=c.elementPrefixName||"",q=c.elementPostixName||"",k=0;k<s.length;k++){if(m=s[k].getAttribute("editMask"),d=s[k].getAttribute("storageMask"),
t=s[k].getAttribute("valueType")||"text",z=suggestKeyName(A,s[k].name||s[k].id,w,q),f=c.columns&&suggestKeyName(c.columns,s[k].id)||null,"undefined"!=typeof A[z]&&(y=unmaskHTML(A[z]),z=s[k].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(t=c.columns[f].type,m=c.columns[f].editMask||m,d=c.columns[f].storageMask||d);"text"!=t&&(""<m&&""<d?0<=t.indexOf("date")&&(y=dateTransform(y,d,m)):y=yAnalise("%"+t+"("+y+")"));switch(z){case "text":case "password":case "textarea":case "email":case "hidden":s[k].value=
y;break;case "radio":case "checkbox":s[k].value==y&&(s[k].checked=s[k].value===y);break;case "select-one":case "select-multi":for(l=0;l<s[k].options.length;l++)s[k].options[l].value==y&&(s[k].selectedIndex=l)}if("function"==typeof c.onNewItem)c.onNewItem(a,s[k],A)}}else 1<b.length&&console.log("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&b&&1===b.length){t="";d?k.innerHTML="":t=k.innerHTML;for(f in b[0])b[0].hasOwnProperty(f)&&(t+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,
...
ycomm.dom.getFormElements=function(a,b){b=b||{};for(var c=b.elementPrefixName||"",d=b.elementPostixName||"",e={},f=this.selectElements(a),g,h,k,s,t,w,v,l=0;l<f.length;l++)if(s=f[l].getAttribute("editMask")||"",t=f[l].getAttribute("storageMask")||"",w=f[l].getAttribute("valueType")||"text",v=!0,h=f[l].type.toLowerCase(),g=f[l].name||f[l].id,g.substr(g.length,-d.length)==d&&g.substr(0,c.length)==c&&(g=g.substr(c.length),g=g.substr(0,g.length-d.length),""<g)){k="";if("radio"==h||"checkbox"==h)v=!1,"undefined"==
typeof e[g]&&(e[g]="");switch(h){case "text":case "password":case "textarea":case "email":case "hidden":k=f[l].value.quoteString(!0);null!==k&&""<s&&""<t&&0<=w.indexOf("date")&&(k=dateTransform(k.unquote(),s,t))&&(k=k.quoteString());break;case "radio":case "checkbox":k=f[l].checked?f[l].value.quoteString(!0):"";v=""!==k;break;case "select-one":case "select-multi":k=f[l].selectedIndex,f[l].options[k]&&(k=f[l].options[k].value)}v&&(e[g]=k)}return e};
...
["L","P"];if(a=y$(b.cfg.divContainerName)){try{b.cfg.status=0;null!=b.cfg.callback&&b.cfg.callback(b,"DOMLocked",a);for(var e=null,f=null,g=null,h=null,k=null,s=null,t=null,w=2>b.cfg.view?864E5:6E4*b.cfg.dayEntryDivision,v=0,l=0,m="calDay"+d[b.cfg.view%2];a.hasChildNodes();)a.removeChild(a.lastChild);b.context.oCalTable=document.createElement("table");b.context.oCalTable.cellPadding=0;b.context.oCalTable.cellSpacing=0;var p=b.context.oCalTable.insertRow(-1),q=p.insertCell();q.className="calBand";
var d=!0,B=0,z={};null!=b.cfg.cellSize.height&&(z.height=parseInt(b.cfg.cellSize.height)+"px");null!=b.cfg.cellSize.width&&(z.width=parseInt(b.cfg.cellSize.width)+"px");var y=b.context.dateScope.first,A=b.context.dateScope.last;y.setHours(12);A.setHours(12);var D=function(){f=b.cfg.divContainerName+"_empty_"+B;var a=document.createElement("div");mergeObject(z,a.style);a.id=f;a.className=m+"Cell "+m+"EmptyCell";q.appendChild(a);0==b.cfg.orientation&&v++;B++;null!=b.cfg.callback&&b.cfg.callback(b,"getEmptyDayContent",
a)},C=function(a){0==a?(f=b.cfg.divContainerName+"_day_"+x.toUDate().substring(0,8),e=x.getDate()):(e=x.getHours()+":"+x.getMinutes(),f=b.cfg.divContainerName+"_day_"+x.toUDate().substring(0,12))},x=new Date(y),F=(A-x)/w+1;if(0===b.cfg.view)if(0==b.cfg.orientation)for(n=0;n<y.getDay();n++)D();else{x.setDate(x.getDate()-y.getDay());var G=[],E=new Date(x);for(n=0;n<b.context.nRows;n++)G[n]=new Date(E),E.setDate(E.getDate()+1)}for(;0<F;)d||(p=b.context.oCalTable.insertRow(-1),q=p.insertCell(),q.className=
"calBand",d=!0),e="",1==b.cfg.orientation?x<y||x>A?D():0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented")),""<e&&(g=m+"Cell",0===x.getDay()&&(g+=" "+m+"FreeCell"),x.getDate()==b.cfg.date.getDate()&&(g+=" "+m+"Highlight"),k=document.createElement("div"),mergeObject(z,k.style),k.id=f,k.className=g,mergeObject(z,k.style),k.date=x,s=document.createElement("span"),
s.id=f+"_tag",s.className="calTag",null!=b.cfg.callback&&(h=b.cfg.callback(b,"getTagContent",s)||"",""<h&&(e=h)),s.innerHTML=e,k.appendChild(s),null!=b.cfg.callback&&(t=b.cfg.callback(b,"getCellContent",k)||"",""<t&&(k.innerHTML+=t)),q.appendChild(k)),1==b.cfg.orientation?x.setTime(x.getTime()+w*b.context.nRows):x.setTime(x.getTime()+w),v++,v>=b.context.nCols&&(v=0,l++,d=!1,1==b.cfg.orientation&&(x=G[l])),F--;if(d){for(;v<b.context.nCols;)D();v=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
...
function dynTableCloneRow(a,b){for(;void 0!=a&&!(a instanceof HTMLTableRowElement);)a=a.parentNode;if(a){for(var c=a.parentNode,d=a.cloneNode(!0),e=0;e<d.cells.length;e++)for(var f=d.cells[e],g=0;g<f.childNodes.length;g++){var h=f.childNodes[g];if(""<h.id){for(var k=_dynExplodeTag(h.id),s=k[1],s=0;y$(k[0]+zeroPad(s,2));)s++;h.id=k[0]+zeroPad(s,2);h.name=h.id;h.onchange=b}h.value=null}return c.insertBefore(d,a.nextSibling)}alert("Your button is outside a table");return null}
...
function calcGridAddItem(a,b,c,d,e,f,g,h,k,s){void 0==h&&(h=!1);void 0==k&&(k="");void 0==s&&(s="2");var t=!0,w=e.split(",");if(!h)for(var v in w)w.hasOwnProperty(v)&&void 0==b[w[v]]&&(t=!1);t?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=g,a[c].units=k,a[c].decimalPlaces=s):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
d;e.openNextField=[];e.openNextField.name="openNextField";e.openNextField.type="hidden";e.openNextField.value=1;var a=getX(g)+parseInt(g.offsetWidth),s=getY(g)+parseInt(g.offsetHeight);e._position=[];e._position.name="_position";e._position.type="hidden";e._position.value={x:a,y:s};e._position.onChangesFuncName=f;askValue("/",'javascript:dynSetCellValue("'+c+"_"+b+'")',e)}:null)}
