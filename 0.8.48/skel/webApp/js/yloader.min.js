/* YeAPF 0.8.48-57 built on 2016-04-15 13:26 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
...
(function(){y$=function(a){var b=null;""<a&&("#"==a.substr(0,1)&&(a=a.substr(1)),(b=document.getElementById(a))||(b=document.getElementsByName(a)[0]),b||("."==a.substr(0,1)&&(a=a.substr(1)),a=getElementsByClassName(document,"*",a),0<a.length&&(b=a)));return b}})();"undefined"==typeof $&&($=y$);
...
function getElementsByClassName(a,b,c){console.log("getElementsByClassName()");a=a.getElementsByTagName(b);b=[];for(var d,e=0;e<a.length;e++)(d=a[e])&&"function"==typeof d.hasClass&&d.hasClass(c)&&b.push(d);return b}var getClientSize=function(){var a=document&&document.documentElement?document.documentElement:{clientWidth:800,clientHeight:600},b=window?window:{innerWidth:800,innerHeight:600},c=Math.max(a.clientWidth,b.innerWidth||0),a=Math.max(a.clientHeight,b.innerHeight||0);return[c,a]};
...
function timestamp2IBDate(a){a=timestamp2date(a);return a=date2IBDate(a)}var dateTransform=function(a,b,c){if(a){if(a=extractDateValues(a,b)){b={};extractDateValues("111111111111",c,b);var d=c;for(c=0;c<b.elems.length;c++){var e=b.elems[c];if(null!==e[0]){for(var f=pad(a[e[2]],e[3]);d.length<e[0]+e[3];)d+=" ";d=d.substr(0,e[0])+f+d.substr(e[0]+e[3],d.length)}}}return d}return null};function isInfinity(a){return void 0!==a?a.POSITIVE_INFINITY||a.NEGATIVE_INFINITY||"Infinity"==a:!0}
...
var xml2array=function(a){var b,c={};c.not_whitespace=new RegExp(/[^\s]/);c.parent_count=null;c.xml2array=function(a,e){var f,g,h,k="";e=e||{};a.nodeName&&"#"!=a.nodeName.charAt(0)&&1<a.childNodes.length&&(f={},k=a.nodeName);var q=a.nodeValue;a.parentNode&&a.parentNode.nodeName&&q&&c.not_whitespace.test(q)&&(f={},f[a.parentNode.nodeName]=q);if(a.childNodes.length)if(1==a.childNodes.length)f=c.xml2array(a.childNodes[0],e);else{f||(f=[]);for(var t=q=0;t<a.childNodes.length;t++)if(h=c.xml2array(a.childNodes[t],
e)){g=!1;var w=0,v=null;for(b in h)if(h.hasOwnProperty(b)&&(v=b,isNaN(b)&&(g=!0),w++,2<w))break;if(g&&1==w)if(f[v])e&&e[v]||(e[v]=0,g=f[v],f[v]={},f[v][0]=g),e[v]++,f[v][e[v]]=h[v];else{if(e[v]=0,f[v]=h[v],a.childNodes[t].attributes&&a.childNodes[t].attributes.length)for(h=0;h<a.childNodes[t].attributes.length;h++)if(g=a.childNodes[t].attributes[h].nodeName)f["attribute_"+v+"_"+g]=a.childNodes[t].attributes[h].value}else f[q]=h,q++}}k&&f&&(h=f,f={},f[k]=h);return f};return c.xml2array(a)},utf8_decode=
...
g|a>>>32-g,c)},g=function(a){var b="",c="",e;for(e=0;3>=e;e++)c=a>>>8*e&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},h=[],k,q,t,w,v,l,m,p,s;a=this.utf8_encode(a);h=function(a){var b,c=a.length;b=c+8;for(var e=16*((b-b%64)/64+1),d=Array(e-1),f=0,g=0;g<c;)b=(g-g%4)/4,f=g%4*8,d[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;d[b]|=128<<g%4*8;d[e-2]=c<<3;d[e-1]=c>>>29;return d}(a);l=1732584193;m=4023233417;p=2562383102;s=271733878;a=h.length;for(k=0;k<a;k+=16)q=l,t=m,w=p,v=s,l=c(l,m,p,s,h[k+0],
7,3614090360),s=c(s,l,m,p,h[k+1],12,3905402710),p=c(p,s,l,m,h[k+2],17,606105819),m=c(m,p,s,l,h[k+3],22,3250441966),l=c(l,m,p,s,h[k+4],7,4118548399),s=c(s,l,m,p,h[k+5],12,1200080426),p=c(p,s,l,m,h[k+6],17,2821735955),m=c(m,p,s,l,h[k+7],22,4249261313),l=c(l,m,p,s,h[k+8],7,1770035416),s=c(s,l,m,p,h[k+9],12,2336552879),p=c(p,s,l,m,h[k+10],17,4294925233),m=c(m,p,s,l,h[k+11],22,2304563134),l=c(l,m,p,s,h[k+12],7,1804603682),s=c(s,l,m,p,h[k+13],12,4254626195),p=c(p,s,l,m,h[k+14],17,2792965006),m=c(m,p,s,
l,h[k+15],22,1236535329),l=d(l,m,p,s,h[k+1],5,4129170786),s=d(s,l,m,p,h[k+6],9,3225465664),p=d(p,s,l,m,h[k+11],14,643717713),m=d(m,p,s,l,h[k+0],20,3921069994),l=d(l,m,p,s,h[k+5],5,3593408605),s=d(s,l,m,p,h[k+10],9,38016083),p=d(p,s,l,m,h[k+15],14,3634488961),m=d(m,p,s,l,h[k+4],20,3889429448),l=d(l,m,p,s,h[k+9],5,568446438),s=d(s,l,m,p,h[k+14],9,3275163606),p=d(p,s,l,m,h[k+3],14,4107603335),m=d(m,p,s,l,h[k+8],20,1163531501),l=d(l,m,p,s,h[k+13],5,2850285829),s=d(s,l,m,p,h[k+2],9,4243563512),p=d(p,s,
l,m,h[k+7],14,1735328473),m=d(m,p,s,l,h[k+12],20,2368359562),l=e(l,m,p,s,h[k+5],4,4294588738),s=e(s,l,m,p,h[k+8],11,2272392833),p=e(p,s,l,m,h[k+11],16,1839030562),m=e(m,p,s,l,h[k+14],23,4259657740),l=e(l,m,p,s,h[k+1],4,2763975236),s=e(s,l,m,p,h[k+4],11,1272893353),p=e(p,s,l,m,h[k+7],16,4139469664),m=e(m,p,s,l,h[k+10],23,3200236656),l=e(l,m,p,s,h[k+13],4,681279174),s=e(s,l,m,p,h[k+0],11,3936430074),p=e(p,s,l,m,h[k+3],16,3572445317),m=e(m,p,s,l,h[k+6],23,76029189),l=e(l,m,p,s,h[k+9],4,3654602809),s=
e(s,l,m,p,h[k+12],11,3873151461),p=e(p,s,l,m,h[k+15],16,530742520),m=e(m,p,s,l,h[k+2],23,3299628645),l=f(l,m,p,s,h[k+0],6,4096336452),s=f(s,l,m,p,h[k+7],10,1126891415),p=f(p,s,l,m,h[k+14],15,2878612391),m=f(m,p,s,l,h[k+5],21,4237533241),l=f(l,m,p,s,h[k+12],6,1700485571),s=f(s,l,m,p,h[k+3],10,2399980690),p=f(p,s,l,m,h[k+10],15,4293915773),m=f(m,p,s,l,h[k+1],21,2240044497),l=f(l,m,p,s,h[k+8],6,1873313359),s=f(s,l,m,p,h[k+15],10,4264355552),p=f(p,s,l,m,h[k+6],15,2734768916),m=f(m,p,s,l,h[k+13],21,1309151649),
l=f(l,m,p,s,h[k+4],6,4149444226),s=f(s,l,m,p,h[k+11],10,3174756917),p=f(p,s,l,m,h[k+2],15,718787259),m=f(m,p,s,l,h[k+9],21,3951481745),l=b(l,q),m=b(m,t),p=b(p,w),s=b(s,v);return(g(l)+g(m)+g(p)+g(s)).toLowerCase()};
...
typeof a){var d;if(isArray(a))for(d=0;d<a.length;d++)addEvent(a[d],b,c);else{b=b.split(" ");var e;for(d=0;d<b.length;d++)e=b[d],a.addEventListener?a.addEventListener(e,c,!1):a.attachEvent?a.attachEvent("on"+e,c):a["on"+e]=c}}}}_dump("ymisc");
function yAnalise(a,b){if(void 0!=a){a=unmaskHTML(a);for(var c=/%[+(\w)]|[]\(/gi,d,e="";0<=(d=a.search(c));){var e=a.slice(d).search(/\(/),f=a.slice(d+e+1,d+e+2);if('"'==f||"'"==f){var g,h=d+e+1;do h++,g=a.slice(h,h+1);while(g!=f&&h<a.length);f=h+a.slice(h).search(/\)/)-d}else f=a.slice(d).search(/\)/);var k=a.slice(d+1,d+e),e=g=a.slice(d+e+1,d+f);g=g.split(",");for(h=0;h<g.length;h++)g[h]=yAnalise(g[h],b);var e=void 0,h=g[0].toUpperCase(),q=g[0];if(void 0!=b)if(void 0==b[0])e=b[h]?yAnalise(b[h],
b):yAnalise(b[q],b);else for(var t=b.length-1;0<=t&&void 0==e;t--)void 0!=b[t][h]?e=yAnalise(b[t][h],b):void 0!=b[t][q]&&(e=yAnalise(b[t][q],b));else e="string"==eval("typeof "+q)?eval(q):yAnalise(q);void 0==e&&(e="");g[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":g=Math.max(0,parseInt(g[1]));e=parseFloat(e);e=e.toFixed(g);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;
case "tstime":e=timestamp2time(e);break;case "date":e=g[1]?UDate2Date(e,g[1]):UDate2Date(e);break;case "time":e=g[1]?UDate2Time(e,g[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");q=Math.max(0,str2int(g[1]));t=Math.max(k.length-1,str2int(g[2]));g=Math.max(0,str2int(g[3]));e="";for(h=q;h<q+t;h++){var w=onlyDefinedValue(k[h]);""<w&&(e+=" "+w)}0<g&&(e=wordwrap(e,g,"<br>",!0));break;case "quoted":e='"'+e+'"';break;case "condLabel":break;
...
!0;try{if(!a.locked()&&c){0>a.initialized&&a.init();_dumpy(64,1,"displayTab "+c.id);var g=!0,h=0;if(g=c.dispatchEvent(b)||g){var k=a.getContainerFromParam(f);if(k){_dumpy(64,1,"canchange");for(var g=-1,q=!1,h=0;h<k.childs.length;h++)k.childs[h]!=c?q|=!a.hideTab(k.childs[h],c,k):g=h;_dumpy(64,1,"readytochange "+!q);if(q)_dumpy(64,1,"freeze");else{a.setCurrentContainer(a.getContainerNdx(k));k.currentTabNdx=g;c.dispatchEvent(d);c.style.display="block";for(k=c;k&&k!=document.body;)k.style.display="block",
k=k.parentNode;for(var t=c.getElementsByTagName("*"),h=0;h<t.length;){if("checkbox"==t[h].type||"radio"==t[h].type||"password"==t[h].type||"hidden"==t[h].type||"text"==t[h].type||"select-one"==t[h].type||"textarea"==t[h].type){t[h].focus();break}h++}}}}_dumpy(64,1,"return")}}finally{a.changingView=!1}}};a.showWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display="block")};a.hideWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display="none")};a.waitIconControl=function(b){void 0!=
...
ycomm.explodeData=function(a){var b;a=xml2array(a).root||{};var c=a.dataContext||{},d=a.error||c.error||c.lastError,e=null,f=c.userMsg,g=c.sysMsg;if(g&&g.msg&&"logoff"==g.msg){ycomm.canReceiveMessages=!1;for(var h=window,k;h.opener;)k=h,h=h.opener,k.close();for(;h.parent!=h;)h=h.parent;g.banner&&(_dumpy(4,1,g.banner),alert(g.banner));h.document.location="body.php?s=yeapf&a=logoff"}if(ycomm.canReceiveMessages){if(c){var q;if(c.requiredFields)for(g=c.requiredFields.split(","),q=0;q<g.length;q++)fieldName=
g[q],y$(fieldName)&&y$(fieldName).addClass("fieldWarning");if(c.formError){g="";for(q in c.formError)c.formError.hasOwnProperty(q)&&(""<g&&(g+="\n"),g+=c.formError[q]);alert(g)}}if(a){void 0!=c.formID&&""==formID&&(formID=c.formID);c.firstRow=parseInt(c.firstRow);c.rowCount=parseInt(c.rowCount);c.requestedRows=parseInt(c.requestedRows);q=c.rowCount;b=a.data?a.data.row:a.row;1==q&&(b=Array(b));if(b)for(var t in b)if(b.hasOwnProperty(t))for(var w in b[t])b[t].hasOwnProperty(w)&&(b[t][w]=unmaskHTML(b[t][w]));
...
ycomm._dataLocation_=function(){var a="object"==typeof document&&document.location&&document.location.href?document.location.href:"",b=a.lastIndexOf("/");return a.substr(0,b+1)+"rest.php"}();ycomm.getLoad=function(){return this._load};ycomm._removeJSONP=function(a,b){var c=document.head,d="rest_"+a,e=document.getElementById(d);void 0!==c&&void 0!==e?(c.removeChild(e),_dumpy(4,1,"Clean "+d+" after call to "+b+"()")):_dumpy(4,1,"Script not found: "+d+" adressed to "+b+"()");_dumpy(4,1,ycomm.getStatus())};
ycomm.rest_timeout=3500;
ycomm.bring=function(a){var b=document.head,c=document.createElement("script");_dumpy(4,1,a);var d=null,e=null,f=a.substr(a.indexOf("?")+1).split("&"),g;for(g in f)if(f.hasOwnProperty(g)){var h=f[g].split("=");"scriptSequence"==h[0]&&(d=h[1]);"callback"==h[0]&&(e=h[1])}ycomm._maxScriptSequenceReceived=Math.max(ycomm._maxScriptSequenceReceived,d);c.onload=function(){0<ycomm._load&&ycomm._load--};c.setAttribute("src",a);c.id="rest_"+d;b.appendChild(c);setTimeout("ycomm._removeJSONP("+d+",'"+e+"');",
ycomm.rest_timeout)};
ycomm.crave=function(a,b,c,d,e){var f="undefined"==typeof u?"":u;"undefined"==typeof e&&(e=0);ycomm._scriptSequence++;if(this.getDataLocation()){var g;"function"==typeof d?(ycomm._CBSeq++,g="ycb"+ycomm._CBSeq,ycomm._CBControl[g]={ready:!1},window[g]=function(a,b,c,e,f,v){d(a,b,c,e,f,v);console.log(g)}):"string"==typeof d?g=d:console.error("param callBackFunction need to be function or string");""<g&&(ycomm._load++,a=this.buildCommonURL(a||"",b||"",c||{},f),a="{0}?{1}&callback={2}&callbackId={3}&scriptSequence={4}".format(this._dataLocation_,a,
g,e,ycomm._scriptSequence),ycomm.getLoad()<=ycomm._maxDirectCall?ycomm.bring(a):setTimeout("ycomm.bring('"+a+"');",250+500*(ycomm.getLoad()-ycomm._maxDirectCall)))}else console.error("You need to define dataLocation before 'crave' it")};ycomm.isIdle=function(){return ycomm._maxScriptSequenceReceived==ycomm._scriptSequence};ycomm.getStatus=function(){return"isIdle() = {0} getLoad() = {1}".format(this.isIdle(),this.getLoad())};_dump("ycomm-rest");ycomm.dom={_elem_templates:[]};
ycomm.dom.fillElement=function(a,b,c,d){void 0===c&&(c={});void 0===d&&(d=!0);var e,f,g,h,k=y$(a),q="undefined"==typeof ycomm.dom._elem_templates[a];e=c.idFieldName||"id";var t=function(a){var d;p=0;"TR"==a.nodeName&&(a.style.backgroundColor=rowColorSpec.suggestRowColor(B));if(b[l][e])if(y$(b[l][e])){for(d=0;y$(b[l][e]+"_"+d);)d++;a.id=b[l][e]+"_"+d}else a.id=b[l][e];if("undefined"!=typeof c.inplaceData)for(var h=0;h<c.inplaceData.length;h++)f=c.inplaceData[h],d=b[l][f]||"",a.setAttribute("data_"+
f,d);(c.onClick||c.onSelect)&&a.addEventListener("click",c.onClick||c.onSelect,!1)},w=function(d){if(d!=e){var f=g.insertCell(p),k=null!==d?unmaskHTML(b[l][d]):unmaskHTML(b[l]);c.columns&&c.columns[d]&&(c.columns[d].align&&(f.style.textAlign=c.columns[d].align),c.columns[d].type&&(k=yAnalise("%"+c.columns[d].type+"("+k+")")));h||f.addClass("warning");f.innerHTML=0===k.length?"&nbsp;":k;f.style.verticalAlign="top";f.id=a+"_"+p+"_"+v.rows.length;f.setAttribute("colName",d);if("function"==typeof c.onNewItem)c.onNewItem(a,
f,b[l]);p+=1}},v,l,m,p,s=(new Date).getTime()-1447265735470;if(k)if("TABLE"==k.nodeName){v=0<k.getElementsByTagName("tbody").length?k.getElementsByTagName("tbody")[0]:k;0<v.getElementsByTagName("tbody").length&&(v=v.getElementsByTagName("tbody")[0]);if(q)if("undefined"==typeof(c.columns||c.rows||c.html))for(ycomm.dom._elem_templates[a]={},ycomm.dom._elem_templates[a].rows=[],k=0;k<v.rows.length;k++)ycomm.dom._elem_templates[a].rows[k]=v.rows[k].innerHTML;else ycomm.dom._elem_templates[a]={},ycomm.dom._elem_templates[a].columns=
c.columns,ycomm.dom._elem_templates[a].rows=c.rows,ycomm.dom._elem_templates[a].html=c.html;mergeObject(ycomm.dom._elem_templates[a],c,!0);if(d)for(;0<v.rows.length;)v.deleteRow(v.rows.length-1);var B=v.rows.length%2;p=null;for(l in b)if(b.hasOwnProperty(l)){B++;h=!0;if(!d&&b[l][e])for(k=0;h&&k<v.rows.length;k++)if(v.rows[k].id==b[l][e]){for(g=v.rows[k];0<g.cells.length;)g.deleteCell(0);h=!1;b[l].rowid=k}h&&(g=v.insertRow(v.rows.length));s++;b[l].rowid="undefined"!==typeof g.rowIndex?g.rowIndex:s+
"";b[l]._elementid_=a;t(g);if("undefined"==typeof c.html&&"undefined"==typeof c.rows&&"undefined"==typeof c.columns)if("string"==typeof b[l])w(null);else for(f in b[l])b[l].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&w(f);else if("undefined"!=typeof c.columns)if(isArray(c.columns))for(m=0;m<c.columns.length;m++)w(c.columns[m]);else for(m in c.columns)c.columns.hasOwnProperty(m)&&w(m);else if("undefined"!=typeof c.html){if(q=g.insertCell(0),q.innerHTML=yAnalise(c.html,b[l]),q.style.verticalAlign=
"top",q.id=a+"_"+p+"_"+v.rows.length,"function"==typeof c.onNewItem)c.onNewItem(a,q,b[l])}else if("undefined"!=typeof c.rows)for(k=!0,r=0;r<c.rows.length;r++){k||(g=v.insertRow(v.rows.length),t(g));g.innerHTML=yAnalise(c.rows[r],b[l]);if(!h)for(m=0;m<g.cells.length;m++)g.cells[m].style.borderLeft="solid 1px red";if("function"==typeof c.onNewItem)c.onNewItem(a,g,b[l]);k=!1}if("function"==typeof c.onNewRowReady)c.onNewRowReady(a,g)}}else if("UL"==k.nodeName){if(d)for(;k.firstChild;)k.removeChild(k.firstChild);
for(l in b)if(b.hasOwnProperty(l)){m=document.createElement("li");d="";w=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)d=d+yAnalise(c.rows[r],b[l])+"";w=!0}else if("string"==typeof c.html)d=d+yAnalise(c.html,b[l])+"",w=!0;else for(f in b[l])""===d&&b[l].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(d+=b[l][f]);t(m);w?m.innerHTML=d:m.appendChild(document.createTextNode(d));"string"==typeof c.beforeElement?(d=y$(c.beforeElement),k.insertBefore(m,d)):k.appendChild(m);if("function"==
typeof c.onNewItem)c.onNewItem(a,m,b[l])}}else if("LISTBOX"==k.nodeName){if(d)for(;0<k.childElementCount;)k.childNodes[0].remove();t=0;for(l in b)if(b.hasOwnProperty(l)){b[l]._elementid_=a;g=document.createElement("listitem");p=0;if("undefined"==typeof c.columns)if("string"==typeof b[l])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[l]){if(b[l].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){q=document.createElement("listcell");q.innerHTML=b[l][f];q.id=a+"_"+
p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,q,b[l]);p+=1;g.appendChild(q)}}else for(f in c.columns)if(f!=e){q=document.createElement("listcell");q.innerHTML=b[l][f];q.id=a+"_"+p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,q,b[l]);p+=1;g.appendChild(q)}k.appendChild(g);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d)for(;0<k.options.length;)k.options.remove(0);p=0;for(l in b)if(b.hasOwnProperty(l)){b[l]._elementid_=a;t="";if("undefined"==typeof c.columns)if("string"==
typeof b[l])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[l])b[l].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=b[l][f]);else if(isArray(c.columns))for(m=0;m<c.columns.length;m++)t=t+b[l][c.columns[m]]+" ";else if("string"==typeof b[l])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(t+=b[l][f]);d=document.createElement("option");"undefined"!=typeof b[l][e]&&(d.value=b[l][e]);d.innerHTML=t;d.id=a+"_"+p;for(m=
0;m<c.inplaceData.length;m++)"undefined"!==typeof b[l][c.inplaceData[m]]&&d.setAttribute("data_"+c.inplaceData[m],b[l][c.inplaceData[m]]);if("function"==typeof c.onNewItem)c.onNewItem(a,d,b[l]);k.appendChild(d);p++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var z,y,q=d?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(var A=b[0]||b,w=c.elementPrefixName||"",s=c.elementPostixName||"",k=0;k<q.length;k++){if(m=q[k].getAttribute("editMask"),d=q[k].getAttribute("storageMask"),
t=q[k].getAttribute("valueType")||"text",z=suggestKeyName(A,q[k].name||q[k].id,w,s),f=c.columns&&suggestKeyName(c.columns,q[k].id)||null,"undefined"!=typeof A[z]&&(y=unmaskHTML(A[z]),z=q[k].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(t=c.columns[f].type,m=c.columns[f].editMask||m,d=c.columns[f].storageMask||d);"text"!=t&&(""<m&&""<d?0<=t.indexOf("date")&&(y=dateTransform(y,d,m)):y=yAnalise("%"+t+"("+y+")"));switch(z){case "text":case "password":case "textarea":case "email":case "hidden":q[k].value=
y;break;case "radio":case "checkbox":q[k].value==y&&(q[k].checked=q[k].value===y);break;case "select-one":case "select-multi":for(l=0;l<q[k].options.length;l++)q[k].options[l].value==y&&(q[k].selectedIndex=l)}if("function"==typeof c.onNewItem)c.onNewItem(a,q[k],A)}}else 1<b.length&&console.log("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&b&&1===b.length){t="";d?k.innerHTML="":t=k.innerHTML;for(f in b[0])b[0].hasOwnProperty(f)&&(t+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,
b[0][f]));k.innerHTML=t}};ycomm.dom.getRowId=function(a,b){if(a)for(;a&&a.parentNode;)a=a.parentNode};ycomm.dom.getRowByRowNo=function(a,b){var c=document.getElementById(a);return c?c.rows[b]:null};ycomm.dom.getTableRowId=function(a,b){var c=ycomm.dom.getRowByRowNo(a,b);return c?c.id:null};
...
ycomm.dom.getFormElements=function(a){var b={};a=this.selectElements(a);for(var c,d,e,f,g,h,k,q=0;q<a.length;q++)if(f=a[q].getAttribute("editMask")||"",g=a[q].getAttribute("storageMask")||"",h=a[q].getAttribute("valueType")||"text",k=!0,d=a[q].type.toLowerCase(),c=a[q].name||a[q].id,""<c){e="";if("radio"==d||"checkbox"==d)k=!1,"undefined"==typeof b[c]&&(b[c]="");switch(d){case "text":case "password":case "textarea":case "email":case "hidden":e=a[q].value.quoteString(!0);null!==e&&""<f&&""<g&&0<=h.indexOf("date")&&
(e=dateTransform(e.unquote(),f,g))&&(e=e.quoteString());break;case "radio":case "checkbox":e=a[q].checked?a[q].value.quoteString(!0):"";k=""!==e;break;case "select-one":case "select-multi":e=a[q].selectedIndex,a[q].options[e]&&(e=a[q].options[e].value)}k&&(b[c]=e)}return b};ycomm.dom.addFormElement=function(a,b,c){b=document.createElement(b);for(var d in c)c.hasOwnProperty(d)&&b.setAttribute(d,c[d]);a.appendChild(b);return b};
...
["L","P"];if(a=y$(b.cfg.divContainerName)){try{b.cfg.status=0;null!=b.cfg.callback&&b.cfg.callback(b,"DOMLocked",a);for(var e=null,f=null,g=null,h=null,k=null,q=null,t=null,w=2>b.cfg.view?864E5:6E4*b.cfg.dayEntryDivision,v=0,l=0,m="calDay"+d[b.cfg.view%2];a.hasChildNodes();)a.removeChild(a.lastChild);b.context.oCalTable=document.createElement("table");b.context.oCalTable.cellPadding=0;b.context.oCalTable.cellSpacing=0;var p=b.context.oCalTable.insertRow(-1),s=p.insertCell();s.className="calBand";
var d=!0,B=0,z={};null!=b.cfg.cellSize.height&&(z.height=parseInt(b.cfg.cellSize.height)+"px");null!=b.cfg.cellSize.width&&(z.width=parseInt(b.cfg.cellSize.width)+"px");var y=b.context.dateScope.first,A=b.context.dateScope.last;y.setHours(12);A.setHours(12);var D=function(){f=b.cfg.divContainerName+"_empty_"+B;var a=document.createElement("div");mergeObject(z,a.style);a.id=f;a.className=m+"Cell "+m+"EmptyCell";s.appendChild(a);0==b.cfg.orientation&&v++;B++;null!=b.cfg.callback&&b.cfg.callback(b,"getEmptyDayContent",
a)},C=function(a){0==a?(f=b.cfg.divContainerName+"_day_"+x.toUDate().substring(0,8),e=x.getDate()):(e=x.getHours()+":"+x.getMinutes(),f=b.cfg.divContainerName+"_day_"+x.toUDate().substring(0,12))},x=new Date(y),F=(A-x)/w+1;if(0===b.cfg.view)if(0==b.cfg.orientation)for(n=0;n<y.getDay();n++)D();else{x.setDate(x.getDate()-y.getDay());var G=[],E=new Date(x);for(n=0;n<b.context.nRows;n++)G[n]=new Date(E),E.setDate(E.getDate()+1)}for(;0<F;)d||(p=b.context.oCalTable.insertRow(-1),s=p.insertCell(),s.className=
"calBand",d=!0),e="",1==b.cfg.orientation?x<y||x>A?D():0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented")),""<e&&(g=m+"Cell",0===x.getDay()&&(g+=" "+m+"FreeCell"),x.getDate()==b.cfg.date.getDate()&&(g+=" "+m+"Highlight"),k=document.createElement("div"),mergeObject(z,k.style),k.id=f,k.className=g,mergeObject(z,k.style),k.date=x,q=document.createElement("span"),
q.id=f+"_tag",q.className="calTag",null!=b.cfg.callback&&(h=b.cfg.callback(b,"getTagContent",q)||"",""<h&&(e=h)),q.innerHTML=e,k.appendChild(q),null!=b.cfg.callback&&(t=b.cfg.callback(b,"getCellContent",k)||"",""<t&&(k.innerHTML+=t)),s.appendChild(k)),1==b.cfg.orientation?x.setTime(x.getTime()+w*b.context.nRows):x.setTime(x.getTime()+w),v++,v>=b.context.nCols&&(v=0,l++,d=!1,1==b.cfg.orientation&&(x=G[l])),F--;if(d){for(;v<b.context.nCols;)D();v=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
...
function dynTableCloneRow(a,b){for(;void 0!=a&&!(a instanceof HTMLTableRowElement);)a=a.parentNode;if(a){for(var c=a.parentNode,d=a.cloneNode(!0),e=0;e<d.cells.length;e++)for(var f=d.cells[e],g=0;g<f.childNodes.length;g++){var h=f.childNodes[g];if(""<h.id){for(var k=_dynExplodeTag(h.id),q=k[1],q=0;y$(k[0]+zeroPad(q,2));)q++;h.id=k[0]+zeroPad(q,2);h.name=h.id;h.onchange=b}h.value=null}return c.insertBefore(d,a.nextSibling)}alert("Your button is outside a table");return null}
...
function calcGridAddItem(a,b,c,d,e,f,g,h,k,q){void 0==h&&(h=!1);void 0==k&&(k="");void 0==q&&(q="2");var t=!0,w=e.split(",");if(!h)for(var v in w)w.hasOwnProperty(v)&&void 0==b[w[v]]&&(t=!1);t?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=g,a[c].units=k,a[c].decimalPlaces=q):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
d;e.openNextField=[];e.openNextField.name="openNextField";e.openNextField.type="hidden";e.openNextField.value=1;var a=getX(g)+parseInt(g.offsetWidth),q=getY(g)+parseInt(g.offsetHeight);e._position=[];e._position.name="_position";e._position.type="hidden";e._position.value={x:a,y:q};e._position.onChangesFuncName=f;askValue("/",'javascript:dynSetCellValue("'+c+"_"+b+'")',e)}:null)}
...
function fillTable(a,b,c,d,e,f,g,h,k){ycomm.invoke("yeapfDB","doSQL",{sql:'"'+b+'"'},function(b,h,k){console.log(b,a);b=c.split(",");h="";for(var v=0;v<b.length;v++)h+='<td><a href="{1}">%({0})</a></td>'.format(b[v],d);ycomm.dom.fillElement(a,k,{onNewItem:f,rows:[h],inplaceData:[e],onNewItem:f,onReady:g})})}function getCheckboxTable(a){return y$(a).parentElement?y$(a).parentElement.parentElement:null}
