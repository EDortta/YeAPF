/* YeAPF 0.8.48-23 built on 2016-03-17 11:06 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
...
g|a>>>32-g,c)},g=function(a){var b="",c="",e;for(e=0;3>=e;e++)c=a>>>8*e&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},h=[],k,t,v,w,s,m,p,l,q;a=this.utf8_encode(a);h=function(a){var b,c=a.length;b=c+8;for(var e=16*((b-b%64)/64+1),d=Array(e-1),f=0,g=0;g<c;)b=(g-g%4)/4,f=g%4*8,d[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;d[b]|=128<<g%4*8;d[e-2]=c<<3;d[e-1]=c>>>29;return d}(a);m=1732584193;p=4023233417;l=2562383102;q=271733878;a=h.length;for(k=0;k<a;k+=16)t=m,v=p,w=l,s=q,m=c(m,p,l,q,h[k+0],
7,3614090360),q=c(q,m,p,l,h[k+1],12,3905402710),l=c(l,q,m,p,h[k+2],17,606105819),p=c(p,l,q,m,h[k+3],22,3250441966),m=c(m,p,l,q,h[k+4],7,4118548399),q=c(q,m,p,l,h[k+5],12,1200080426),l=c(l,q,m,p,h[k+6],17,2821735955),p=c(p,l,q,m,h[k+7],22,4249261313),m=c(m,p,l,q,h[k+8],7,1770035416),q=c(q,m,p,l,h[k+9],12,2336552879),l=c(l,q,m,p,h[k+10],17,4294925233),p=c(p,l,q,m,h[k+11],22,2304563134),m=c(m,p,l,q,h[k+12],7,1804603682),q=c(q,m,p,l,h[k+13],12,4254626195),l=c(l,q,m,p,h[k+14],17,2792965006),p=c(p,l,q,
m,h[k+15],22,1236535329),m=d(m,p,l,q,h[k+1],5,4129170786),q=d(q,m,p,l,h[k+6],9,3225465664),l=d(l,q,m,p,h[k+11],14,643717713),p=d(p,l,q,m,h[k+0],20,3921069994),m=d(m,p,l,q,h[k+5],5,3593408605),q=d(q,m,p,l,h[k+10],9,38016083),l=d(l,q,m,p,h[k+15],14,3634488961),p=d(p,l,q,m,h[k+4],20,3889429448),m=d(m,p,l,q,h[k+9],5,568446438),q=d(q,m,p,l,h[k+14],9,3275163606),l=d(l,q,m,p,h[k+3],14,4107603335),p=d(p,l,q,m,h[k+8],20,1163531501),m=d(m,p,l,q,h[k+13],5,2850285829),q=d(q,m,p,l,h[k+2],9,4243563512),l=d(l,q,
m,p,h[k+7],14,1735328473),p=d(p,l,q,m,h[k+12],20,2368359562),m=e(m,p,l,q,h[k+5],4,4294588738),q=e(q,m,p,l,h[k+8],11,2272392833),l=e(l,q,m,p,h[k+11],16,1839030562),p=e(p,l,q,m,h[k+14],23,4259657740),m=e(m,p,l,q,h[k+1],4,2763975236),q=e(q,m,p,l,h[k+4],11,1272893353),l=e(l,q,m,p,h[k+7],16,4139469664),p=e(p,l,q,m,h[k+10],23,3200236656),m=e(m,p,l,q,h[k+13],4,681279174),q=e(q,m,p,l,h[k+0],11,3936430074),l=e(l,q,m,p,h[k+3],16,3572445317),p=e(p,l,q,m,h[k+6],23,76029189),m=e(m,p,l,q,h[k+9],4,3654602809),q=
e(q,m,p,l,h[k+12],11,3873151461),l=e(l,q,m,p,h[k+15],16,530742520),p=e(p,l,q,m,h[k+2],23,3299628645),m=f(m,p,l,q,h[k+0],6,4096336452),q=f(q,m,p,l,h[k+7],10,1126891415),l=f(l,q,m,p,h[k+14],15,2878612391),p=f(p,l,q,m,h[k+5],21,4237533241),m=f(m,p,l,q,h[k+12],6,1700485571),q=f(q,m,p,l,h[k+3],10,2399980690),l=f(l,q,m,p,h[k+10],15,4293915773),p=f(p,l,q,m,h[k+1],21,2240044497),m=f(m,p,l,q,h[k+8],6,1873313359),q=f(q,m,p,l,h[k+15],10,4264355552),l=f(l,q,m,p,h[k+6],15,2734768916),p=f(p,l,q,m,h[k+13],21,1309151649),
m=f(m,p,l,q,h[k+4],6,4149444226),q=f(q,m,p,l,h[k+11],10,3174756917),l=f(l,q,m,p,h[k+2],15,718787259),p=f(p,l,q,m,h[k+9],21,3951481745),m=b(m,t),p=b(p,v),l=b(l,w),q=b(q,s);return(g(m)+g(p)+g(l)+g(q)).toLowerCase()};
...
ycomm.explodeData=function(a){var b;a=xml2array(a).root||{};var c=a.dataContext||{},d=a.error||c.error||c.lastError,e=null,f=c.userMsg,g=c.sysMsg;if(g&&g.msg&&"logoff"==g.msg){ycomm.canReceiveMessages=!1;for(var h=window,k;h.opener;)k=h,h=h.opener,k.close();for(;h.parent!=h;)h=h.parent;g.banner&&(_dumpy(4,1,g.banner),alert(g.banner));h.document.location="body.php?s=yeapf&a=logoff"}if(ycomm.canReceiveMessages){if(c){var t;if(c.requiredFields)for(g=c.requiredFields.split(","),t=0;t<g.length;t++)fieldName=
...
ycomm.rest_timeout)};
ycomm.crave=function(a,b,c,d,e){var f="undefined"==typeof u?"":u;"undefined"==typeof e&&(e=0);ycomm._scriptSequence++;if(this.getDataLocation()){var g;"function"==typeof d?(ycomm._CBSeq++,g="ycb"+ycomm._CBSeq,ycomm._CBControl[g]={ready:!1},window[g]=function(a,b,c,e,f,s){d(a,b,c,e,f,s);console.log(g)}):"string"==typeof d?g=d:console.error("param callBackFunction need to be function or string");""<g&&(ycomm._load++,a=this.buildCommonURL(a||"",b||"",c||{},f),a="{0}?{1}&callback={2}&callbackId={3}&scriptSequence={4}".format(this._dataLocation_,a,
...
typeof c.onNewItem)c.onNewItem(a,d,b[s])}}else if("LISTBOX"==k.nodeName){if(d)for(;0<k.childElementCount;)k.childNodes[0].remove();t=0;for(s in b)if(b.hasOwnProperty(s)){b[s]._elementid_=a;g=document.createElement("listitem");p=0;if("undefined"==typeof c.columns)if("string"==typeof b[s])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[s]){if(b[s].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){l=document.createElement("listcell");l.innerHTML=b[s][f];l.id=a+"_"+
p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,l,b[s]);p+=1;g.appendChild(l)}}else for(f in c.columns)if(f!=e){l=document.createElement("listcell");l.innerHTML=b[s][f];l.id=a+"_"+p+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,l,b[s]);p+=1;g.appendChild(l)}k.appendChild(g);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d)for(;0<k.options.length;)k.options.remove(0);p=0;for(s in b)if(b.hasOwnProperty(s)){b[s]._elementid_=a;t="";if("undefined"==typeof c.columns)if("string"==
typeof b[s])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in b[s])b[s].hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=b[s][f]);else if(isArray(c.columns))for(m=0;m<c.columns.length;m++)t=t+b[s][c.columns[m]]+" ";else if("string"==typeof b[s])_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(t+=b[s][f]);d=document.createElement("option");"undefined"!=typeof b[s][e]&&(d.value=b[s][e]);d.innerHTML=t;d.id=a+"_"+p;if("function"==
...
"calBand",d=!0),e="",1==b.cfg.orientation?x<y||x>A?D():0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented")),""<e&&(g=p+"Cell",0===x.getDay()&&(g+=" "+p+"FreeCell"),x.getDate()==b.cfg.date.getDate()&&(g+=" "+p+"Highlight"),k=document.createElement("div"),mergeObject(z,k.style),k.id=f,k.className=g,mergeObject(z,k.style),k.date=x,t=document.createElement("span"),
t.id=f+"_tag",t.className="calTag",null!=b.cfg.callback&&(h=b.cfg.callback(b,"getTagContent",t)||"",""<h&&(e=h)),t.innerHTML=e,k.appendChild(t),null!=b.cfg.callback&&(v=b.cfg.callback(b,"getCellContent",k)||"",""<v&&(k.innerHTML+=v)),q.appendChild(k)),1==b.cfg.orientation?x.setTime(x.getTime()+w*b.context.nRows):x.setTime(x.getTime()+w),s++,s>=b.context.nCols&&(s=0,m++,d=!1,1==b.cfg.orientation&&(x=G[m])),F--;if(d){for(;s<b.context.nCols;)D();s=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
