/* YeAPF 0.8.48-78 built on 2016-05-17 17:01 (-3 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
...
case "tstime":e=timestamp2time(e);break;case "date":e=g[1]?UDate2Date(e,g[1]):UDate2Date(e);break;case "time":e=g[1]?UDate2Time(e,g[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");s=Math.max(0,str2int(g[1]));t=Math.max(k.length-1,str2int(g[2]));g=Math.max(0,str2int(g[3]));e="";for(h=s;h<s+t;h++){var w=onlyDefinedValue(k[h]);""<w&&(e+=" "+w)}0<g&&(e=wordwrap(e,g,"<br>",!0));break;case "quoted":e='"'+e+'"';break;case "condLabel":break;
