...
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.58-87 built on 2017-06-27 12:36 (-3 DST)\n");
  ...
  echo sayStep("<div class=cpyrght><strong><big><I>skel/workbench/www/configure.php</I></big></strong><br>
    YeAPF 0.8.58-87 built on 2017-06-27 12:36 (-3 DST)<br>
    Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com<br>
    2017-06-27 12:36:03 (-3 DST)</div>");
      ...
      if (function_exists("yeapfVersion")) {
        if (("%"."YEAPF_VERSION%")==yeapfVersion())
          ...
          if (("0.8.58") != yeapfVersion())
            die(sayStep("<ul class=err>Your configure version is '0.8.58' while your installed version is '".yeapfVersion()." at ".yeapfBaseDir()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>"));
      }
