/* YeAPF 0.8.58-63 built on 2017-06-23 08:54 (-3 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.58-63 built on 2017-06-23 08:54 (-3 DST)");
...
!a.isWorker&&a.isChromeExtension&&!chrome.storage;a.loadLibrary=function(b,c,d){var e;if(""<b){if("chrome-extension:"!=a.selfLocation.substr(0,17))b=a.selfLocation+"/"+b+"?v=0.8.58";else{for(var f=a.selfLocation.split("/"),h="",g=3;g<f.length;g++)""<f[g]&&(""<h&&(h+="/"),h+=f[g]);b=h+"/"+b+"?v=0.8.34"}b=b.replace(/\/\//g,"/");b=b.replace("http:/","http://");b=b.replace("https:/","https://");f=b.split("/");0<f.length&&(e=f[f.length-1]);"function"==typeof importScripts?importScripts(b):(f=
document.getElementsByTagName("head")[0],0>b.indexOf(".css")?(c=document.createElement("script"),c.type=0<b.indexOf(".js")?"text/javascript":"text/text",c.onload=d,c.src=b,f.appendChild(c)):(h=document.createElement("link"),h.id=c||e,h.rel="stylesheet",h.type="text/css",h.media="all",h.onload=d,h.href=b,f.appendChild(h)));_dump(e+" added")}};a.isWorker||window.addEventListener("load",function(){var a="CSS1Compat"===document.compatMode?document.documentElement:document.body,c=document.getElementById("screen");
...
"*",e),0<e.length&&(b?a=e:(b=!1,a=array_intersect(a||[],e)));d=a}return d}})();"undefined"==typeof $&&($=y$);function $frame(a){"./"==a.substr(0,2)&&(a=a.substr(2));var b;"../"==a.substr(0,3)?(b=parent,a=a.substr(3)):"/"==a?(a="",b=top):"/"==a.substr(0,1)?(b=top,a=a.substr(1)):b=self;if(""<a){a=a.split("/");for(var c=0;c<a.length;c++)b=b.frames[a[c]]}return b}
...
String.prototype.abbreviate||(String.prototype.abbreviate=function(a,b){var c=function(){""<v&&(g.length+k.length+v.length+(0<g.length?1:0<0+k.length?1:0)<a?(k=trim(v+" "+k),w++):g.length+k.length+1<a&&(k=trim(v.substr(0,1)+"."+k),w++))},d=function(){""<l&&(g.length+k.length+l.length+(0<g.length?1:0<0+k.length?1:0)<a?(g=trim(g+" "+l),w++):g.length+k.length+1<a&&(g=trim(g+" "+l.substr(0,1)+"."),w++))};b=b||!1;a=str2int(a);if(0<this.indexOf(" ")){for(var e,f,h=this.toString(),g="",k="",l,v,w;g.length+
k.length+1<=a&&(h=trim(h),e=h.indexOf(" "),0>e&&(e=h.length),f=h.lastIndexOf(" "),l=trim(h.substr(0,e)),v="",e<f&&(v=trim(h.substr(f)),h=trim(h.substr(0,f))),h=trim(h.substr(e)),w=0,b?d():c(),l!=v&&(b?c():d()),0!==w););return trim(g+" "+k)}return this.substr(0,a)});String.prototype.ucFirst||(String.prototype.ucFirst=function(){return this.charAt(0).toUpperCase()+this.slice(1)});String.prototype.lcFirst||(String.prototype.lcFirst=function(){return this.charAt(0).toLowerCase()+this.slice(1)});
...
Math.random()),d=Math.round(9*Math.random()),e=Math.round(9*Math.random()),f=Math.round(9*Math.random()),h=Math.round(9*Math.random()),g=Math.round(9*Math.random()),k;k=_mod_(5*a+4*b+3*c+2*d+9*e+8*f+7*h+6*g+2,11);var l=2>k?0:11-k;k=_mod_(6*a+5*b+4*c+3*d+2*e+9*f+8*h+7*g+3+2*l,11);return""+a+b+"."+c+d+e+"."+f+h+g+"/0001-"+l+(2>k?0:11-k)};String.prototype.gerarCPF=function(){var a=Math.round(9*Math.random()),b=Math.round(9*Math.random()),c=Math.round(9*Math.random()),d=Math.round(9*Math.random()),e=
Math.round(9*Math.random()),f=Math.round(9*Math.random()),h=Math.round(9*Math.random()),g=Math.round(9*Math.random()),k=Math.round(9*Math.random()),l;l=_mod_(10*a+9*b+8*c+7*d+6*e+5*f+4*h+3*g+2*k,11);var v=2>l?0:11-l;l=_mod_(11*a+10*b+9*c+8*d+7*e+6*f+5*h+4*g+3*k+2*v,11);return""+a+b+c+"."+d+e+f+"."+h+g+k+"-"+v+(2>l?0:11-l)}}String.prototype.isEmail||(String.prototype.isEmail=function(){return isEmail(this)});
...
function wordwrap(a,b,c,d){c=c||"\n";b=b||75;return a?a.match(RegExp(".{1,"+b+"}(\\s|$)"+(d?"|.{"+b+"}|.+$":"|\\S+?(\\s|$)"),"g")).join(c):a}function nl2br(a){var b="";void 0!==a&&(b=a.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2"));return b}function dec2deg(a,b){b=b||!0;var c=0<Math.sign(a),d,e,f;a=Math.abs(a);d=parseInt(a);f=60*(a-1*d);e=f-1*parseInt(f);f=parseInt(f);e=parseInt(60*e);return d+"&deg; "+f+"' "+e+"'' "+(b?c?"N":"S":c?"E":"W")}
...
function brighterColor(a,b){b=b||50;a=decomposeColor(a);var c=parseInt(a[0]),d=parseInt(a[1]),e=parseInt(a[2]);return"#"+(0|256+c+(256-c)*b/100).toString(16).substr(1)+(0|256+d+(256-d)*b/100).toString(16).substr(1)+(0|256+e+(256-e)*b/100).toString(16).substr(1)}
...
b.saturation=Math.round(b.saturation);return b},HSV2RGB:function(a,b){b=b||!0;var c={},d={};if(0==a.saturation)c.r=c.g=c.b=Math.round(2.55*a.value);else{a.hue/=60;a.saturation/=100;a.value/=100;var e=Math.floor(a.hue),f=a.hue-e,h=a.value*(1-a.saturation),g=a.value*(1-a.saturation*f),f=a.value*(1-a.saturation*(1-f));switch(e){case 0:c.r=a.value;c.g=f;c.b=h;break;case 1:c.r=g;c.g=a.value;c.b=h;break;case 2:c.r=h;c.g=a.value;c.b=f;break;case 3:c.r=h;c.g=g;c.b=a.value;break;case 4:c.r=f;c.g=h;c.b=a.value;
break;default:c.r=a.value,c.g=h,c.b=g}c.r=Math.round(255*c.r);c.g=Math.round(255*c.g);c.b=Math.round(255*c.b)}b?(d[0]=c.r,d[1]=c.g,d[2]=c.b):d=c;return d}}},hsmColor=hsmColorBase(),xml2array=function(a){var b,c={};c.not_whitespace=new RegExp(/[^\s]/);c.parent_count=null;c.xml2array=function(a,e){var f,h,g,k="";e=e||{};a.nodeName&&"#"!=a.nodeName.charAt(0)&&1<a.childNodes.length&&(f={},k=a.nodeName);var l=a.nodeValue;a.parentNode&&a.parentNode.nodeName&&l&&c.not_whitespace.test(l)&&(f={},f[a.parentNode.nodeName]=
l);if(a.childNodes.length)if(1==a.childNodes.length)f=c.xml2array(a.childNodes[0],e);else{f||(f=[]);for(var v=l=0;v<a.childNodes.length;v++)if(g=c.xml2array(a.childNodes[v],e)){h=!1;var w=0,t=null;for(b in g)if(g.hasOwnProperty(b)&&(t=b,isNaN(b)&&(h=!0),w++,2<w))break;if(h&&1==w)if(f[t])e&&e[t]||(e[t]=0,h=f[t],f[t]={},f[t][0]=h),e[t]++,f[t][e[t]]=g[t];else{if(e[t]=0,f[t]=g[t],a.childNodes[v].attributes&&a.childNodes[v].attributes.length)for(g=0;g<a.childNodes[v].attributes.length;g++)if(h=a.childNodes[v].attributes[g].nodeName)f["attribute_"+
t+"_"+h]=a.childNodes[v].attributes[g].value}else f[l]=g,l++}}k&&f&&(g=f,f={},f[k]=g);return f};return c.xml2array(a)},utf8_decode=function(a){var b=[],c=0,d=0,e=0,f=0,h=0,g=0;for(a+="";c<a.length;)e=a.charCodeAt(c),191>=e?(b[d++]=String.fromCharCode(e),c++):223>=e?(f=a.charCodeAt(c+1),b[d++]=String.fromCharCode((e&31)<<6|f&63),c+=2):239>=e?(f=a.charCodeAt(c+1),h=a.charCodeAt(c+2),b[d++]=String.fromCharCode((e&15)<<12|(f&63)<<6|h&63),c+=3):(f=a.charCodeAt(c+1),h=a.charCodeAt(c+2),g=a.charCodeAt(c+
3),e=(e&7)<<18|(f&63)<<12|(h&63)<<6|g&63,e-=65536,b[d++]=String.fromCharCode(55296|e>>10&1023),b[d++]=String.fromCharCode(56320|e&1023),c+=4);return b.join("")},utf8_encode=function(a){if(null===a||"undefined"===typeof a)return"";a+="";var b="",c,d,e=0;c=d=0;for(var e=a.length,f=0;f<e;f++){var h=a.charCodeAt(f),g=null;if(128>h)d++;else if(127<h&&2048>h)g=String.fromCharCode(h>>6|192,h&63|128);else if(55296!=(h&63488))g=String.fromCharCode(h>>12|224,h>>6&63|128,h&63|128);else{if(55296!=(h&64512))throw new RangeError("Unmatched trail surrogate at "+
f);g=a.charCodeAt(++f);if(56320!=(g&64512))throw new RangeError("Unmatched lead surrogate at "+(f-1));h=((h&1023)<<10)+(g&1023)+65536;g=String.fromCharCode(h>>18|240,h>>12&63|128,h>>6&63|128,h&63|128)}null!==g&&(d>c&&(b+=a.slice(c,d)),b+=g,c=d=f+1)}d>c&&(b+=a.slice(c,e));return b};function utf8_to_ascii(a){var b="",c,d=a.length,e;for(c=0;c<d;c++)128>a.charCodeAt(c)?b+=a.charAt(c):(e=""+a.charCodeAt(c).toString(16),b+="\\u"+(2===e.length?"00"+e:3===e.length?"0"+e:e));return b}
...
var generateSmallSessionUniqueId=function(){var a=[0,0,0],b="8i7u6y5t4r3e2w1q9o0p".split(""),c=b.length;return function(){var d=a[0],e=a[1],f=a[2],h=b[d]+b[e]+b[f],d=++d%c;d||(e=++e%c)||(f=++f%c);a=[d,e,f];return h}}(),md5=function(a){var b=function(a,b){var c,d,e,f,g;e=a&2147483648;f=b&2147483648;c=a&1073741824;d=b&1073741824;g=(a&1073741823)+(b&1073741823);return c&d?g^2147483648^e^f:c|d?g&1073741824?g^3221225472^e^f:g^1073741824^e^f:g^e^f},c=function(a,c,d,e,f,g,h){a=b(a,b(b(c&d|~c&e,f),h));return b(a<<
...
p,m,g[k+4],20,3889429448),m=d(m,q,s,p,g[k+9],5,568446438),p=d(p,m,q,s,g[k+14],9,3275163606),s=d(s,p,m,q,g[k+3],14,4107603335),q=d(q,s,p,m,g[k+8],20,1163531501),m=d(m,q,s,p,g[k+13],5,2850285829),p=d(p,m,q,s,g[k+2],9,4243563512),s=d(s,p,m,q,g[k+7],14,1735328473),q=d(q,s,p,m,g[k+12],20,2368359562),m=e(m,q,s,p,g[k+5],4,4294588738),p=e(p,m,q,s,g[k+8],11,2272392833),s=e(s,p,m,q,g[k+11],16,1839030562),q=e(q,s,p,m,g[k+14],23,4259657740),m=e(m,q,s,p,g[k+1],4,2763975236),p=e(p,m,q,s,g[k+4],11,1272893353),s=
e(s,p,m,q,g[k+7],16,4139469664),q=e(q,s,p,m,g[k+10],23,3200236656),m=e(m,q,s,p,g[k+13],4,681279174),p=e(p,m,q,s,g[k+0],11,3936430074),s=e(s,p,m,q,g[k+3],16,3572445317),q=e(q,s,p,m,g[k+6],23,76029189),m=e(m,q,s,p,g[k+9],4,3654602809),p=e(p,m,q,s,g[k+12],11,3873151461),s=e(s,p,m,q,g[k+15],16,530742520),q=e(q,s,p,m,g[k+2],23,3299628645),m=f(m,q,s,p,g[k+0],6,4096336452),p=f(p,m,q,s,g[k+7],10,1126891415),s=f(s,p,m,q,g[k+14],15,2878612391),q=f(q,s,p,m,g[k+5],21,4237533241),m=f(m,q,s,p,g[k+12],6,1700485571),
...
b,c){"string"==typeof a&&(a=y$(a));if(null!==a&&"undefined"!==typeof a){var d;if(isArray(a))for(d=0;d<a.length;d++)addEvent(a[d],b,c);else{b=b.split(" ");var e;for(d=0;d<b.length;d++)e=b[d],a.addEventListener?a.addEventListener(e,c,"change"==e.toUpperCase()):a.attachEvent?a.attachEvent("on"+e,c):a["on"+e]=c}}},removeEvent=function(a,b,c){"string"==typeof a&&(a=y$(a));if(null!==a&&"undefined"!==typeof a)if(isArray(a))for(b=0;b<a.length;b++)removeEvent(a[b],c);else{var d=b.split(" "),e;for(b=0;b<d.length;b++)e=
d[b],a.addEventListener?a.removeEventListener(e,c,!1):a.detachEvent?a.detachEvent("on"+e,c):a["on"+e]=null}}}_dump("ymisc");
function yAnalise(a,b){if(void 0!==a){a=unmaskHTML(a);var c=/\%(|\w+)\(/gi,d,e,f,h,g;for(e="";"string"==typeof a&&0<=(d=a.search(c));)if(e=a.slice(d).search(/\(/),0<=e){f=a.slice(d+e+1,d+e+2);if('"'==f||"'"==f){g=d+e+1;do g++,h=a.slice(g,g+1);while(h!=f&&g<a.length);f=g+a.slice(g).search(/\)/)-d}else f=a.slice(d).search(/\)/);var k=a.slice(d+1,d+e);e=h=a.slice(d+e+1,d+f);h=h.split(",");for(g=0;g<h.length;g++)h[g]=yAnalise(h[g],b);e=void 0;g=h[0].toUpperCase();var l=h[0];if(void 0!==b)if(void 0==b[0])e=
b[g]?yAnalise(b[g],b):yAnalise(b[l],b);else for(var v=b.length-1;0<=v&&void 0==e;v--)void 0!=b[v][g]?e=yAnalise(b[v][g],b):void 0!=b[v][l]&&(e=yAnalise(b[v][l],b));else e="string"==eval("typeof "+l)?eval(l):yAnalise(l);void 0==e&&(e="");h[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":h=Math.max(0,parseInt(h[1]));e=str2double(e);e=e.toFixed(h);break;case "lon2deg":e=dec2deg(e,!1);break;case "lat2deg":e=dec2deg(e,
!0);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;case "tstime":e=timestamp2time(e);break;case "date":e=h[1]?UDate2Date(e,h[1]):UDate2Date(e);break;case "time":e=h[1]?UDate2Time(e,h[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "abbreviate":e=e.abbreviate(h[1]||20,h[2]||!1);break;case "words":k=e.split(" ");l=Math.max(0,str2int(h[1]));v=Math.max(k.length-1,str2int(h[2]));h=Math.max(0,str2int(h[3]));e="";
for(g=l;g<l+v;g++){var w=onlyDefinedValue(k[g]);""<w&&(e+=" "+w)}0<h&&(e=wordwrap(e,h,"<br>",!0));break;case "quoted":e=('"'+e).trim()+'"';break;case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(g=0;g<h.length;g++)""<e&&(e+=","),e+="'"+h[g]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}else{console.log("HALTING yAnalise as entering in loop");break}}else a="";return a}
...
if(b.pos<b.buf.length){if("/"==a&&"*"!=b.oneChar(1))b.oneChar(1);var e=b.optable[a];if(void 0===e)switch(b._whatis(a)){case b._ALPHA:d=b._process_identifier();a=String(d.token_string).toUpperCase();if("AND"==a||"OR"==a||"LIKE"==a)d.token_string=a,d.type="OPERATOR";break;case b._DIGIT:d=b._process_number();break;case b._QUOTE:d=b._process_quote()}else{var d=a,f=b.oneChar(1),h=b.voidToken,g=b.pos;if(b.optable[a+f])a+=f,e=b.optable[a],d=a;else if(0<="-+".indexOf(a)){var k=b.priorToken.type;if(null===
k||"OPERATOR"==k&&"L_PAREN"==b.priorToken.token)f=b._whatis(f),f==b._DIGIT?h=b._process_number():f==b._ALPHA&&(h=b._process_identifier())}d={type:h.type||"OPERATOR",token:h.token||e,pos:g,token_string:h.token_string||d};b.pos+=a.length}}else d.type="EOF",d.token=null;return b.priorToken=d},tokenTypeIs:function(a,b){return 0<=(","+b+",").indexOf(","+a.type+",")},getExpectedToken:function(a){var d=b.pos,e=b.getToken();if(b.tokenTypeIs(e,a))return e;b.pos=d;return!1},_analiseText:function(){var a,d=
b.voidToken,e,f,h;do if(h=!1,(a=b.getToken())&&"EOF"!=a.type){0<b.symStack.length&&(d=b.symStack[b.symStack.length-1]);d=d||b.voidToken;if("OPERATOR"==a.type)if(e=b.opprecedence[a.token_string]||99,f=b.opprecedence[d.token_string]||10,e<=f)d=b.symStack.pop(),b.symStack.push(a),d&&"("!=d.token_string&&b.postFixStack.push(d),h=!0;else if(")"==a.token_string){do(d=b.symStack.pop())&&"("!=d.token_string&&b.postFixStack.push(d);while(d&&"("!=d.token_string);h=!0}h||a&&("OPERATOR"==a.type?b.symStack.push(a):
b.postFixStack.push(a))}while("ERROR"!=a.type&&"EOF"!=a.type);do(d=b.symStack.pop())&&"EOF"!=d.type&&b.postFixStack.push(d);while(d&&"EOF"!=d.type)},solve:function(a){var d,e=[],f,h,g,k;for(d=0;d<b.postFixStack.length;d++)if(g=!1,f=b.postFixStack[d]){if("NUMBER"==f.type||"LITERAL"==f.type)h=f.token_string,isNumber(h)||(h=String(h).toUpperCase()),g=!0;"IDENTIFIER"==f.type&&(h=a[f.token_string],"undefined"==typeof h?(h="'"+f.token_string+"' is not defined on data",console.warn(h),h=!1):"string"==typeof h&&
(h=String(h).toUpperCase()),g=!0);if(g)e.push(h);else{k=e.pop();g=e.pop();switch((""+f.token_string).toUpperCase()){case "+":f=g+k;break;case "-":f=g-k;break;case "*":f=g*k;break;case "/":f=g/k;break;case "^":f=Math.pow(g,k);break;case ">":f=g>k;break;case "<":f=g<k;break;case ">=":f=g>=k;break;case "<=":f=g<=k;break;case "==":f=g==k;break;case "AND":case "&&":f=g&&k;break;case "OR":case "||":f=g||k;break;case "LIKE":g=String(g).toUpperCase();k=String(k).toUpperCase();f=k.replace(/\%/g,"");f="%"!=
k.substr(0,1)?"%"!=k.substr(k.length-1)?g==k:g.substr(0,f.length)==f:"%"==k.substr(k.length-1,1)?0<=g.indexOf(f):g.substr(g.length-f.length)==f;break;default:throw h="'"+f.token_string+"' is not a recognized operator",console.error(h),Error();}null!==f&&e.push(f)}}return f=e.pop()},showStack:function(a){for(var b="\t",e=0;e<a.length;e++)b+=a[e].token_string+" ";console.log(b)},parse:function(){b.reset();b._analiseText();return b.stack},reset:function(){b.pos=0;b.symStack=[];b.postFixStack=[];b.priorToken=
...
function(a){};a.displayTab=function(b,c){if(!a.changingView){a.changingView=!0;try{if(!a.locked()&&b){0>a.initialized&&a.init();_dumpy(64,1,"displayTab "+b.id);var d=!0,e=0;if(d=b.dispatchEvent(a.tabchangeEvent)||d){var f=a.getContainerFromParam(c);if(f){_dumpy(64,1,"canchange");for(var d=-1,h=!1,e=0;e<f.childs.length;e++)f.childs[e]!=b?h|=!a.hideTab(f.childs[e],b,f):d=e;_dumpy(64,1,"readytochange "+!h);if(h)_dumpy(64,1,"freeze");else{a.setCurrentContainer(a.getContainerNdx(f));f.currentTabNdx=d;
a._currentTab=b.id;b.dispatchEvent(a.tabfocusEvent);b.style.display="block";for(f=b;f&&f!=document.body;)f.style.display="block",f=f.parentNode;for(var g=b.getElementsByTagName("*"),e=0;e<g.length;){if("checkbox"==g[e].type||"radio"==g[e].type||"password"==g[e].type||"hidden"==g[e].type||"text"==g[e].type||"select-one"==g[e].type||"textarea"==g[e].type){g[e].focus();break}e++}window.dispatchEvent(a.tabshowEvent)}}}_dumpy(64,1,"return")}}finally{a.changingView=!1}}};a.showWaitIcon=function(){y$("waitIcon")&&
...
ycomm.explodeData=function(a){var b,c;a=xml2array(a).root||{};var d=a.dataContext||{},e=a.error||d.error||d.lastError,f=null,h=d.userMsg,g=d.sysMsg;if(g&&g.msg&&"logoff"==g.msg){ycomm.canReceiveMessages=!1;for(var k=window,l;k.opener;)l=k,k=k.opener,l.close();for(;k.parent!=k;)k=k.parent;g.banner&&(_dumpy(4,1,g.banner),alert(g.banner));k.document.location="body.php?s=yeapf&a=logoff"}if(ycomm.canReceiveMessages){if(d){if(d.requiredFields)for(g=d.requiredFields.split(","),b=0;b<g.length;b++)fieldName=
...
unmaskHTML(b[v][w]))}}void 0!==a.data&&(f=a.data.geometry)}}return{data:c,geometry:f,dataContext:d,error:e,userMsg:h}};ycomm.text2data=function(a){var b={};"function"==typeof DOMParser&&(a=(new DOMParser).parseFromString(a,"application/xml"),b=ycomm.explodeData(a));return b};
...
ycomm.dom.fillElement=function(a,b,c,d){if(void 0===c||null===c)c={};"boolean"==typeof d&&(d={deleteRows:d});d=d||{};"undefined"==typeof d.deleteRows&&(d.deleteRows=!0);"undefined"==typeof d.paintRows&&(d.paintRows=!0);var e,f,h,g,k=y$(a),l="undefined"==typeof ycomm.dom._elem_templates[a];e=c.idFieldName||"id";"boolean"==typeof d.unlearn&&(l=d.unlearn);var v=function(a){a.doc&&a.id&&a.value&&(a=a.doc);return a},w=function(a,b){if("undefined"!=typeof c.inplaceData)for(var d=0;d<c.inplaceData.length;d++)if("undefined"!==
typeof b[c.inplaceData[d]]){var e=c.inplaceData[d];a.setAttribute("data-"+e,b[e]||"")}},t=function(a){var f,g=v(b[s]);z=0;"TR"==a.nodeName&&d.paintRows&&(a.style.backgroundColor=rowColorSpec.suggestRowColor(D));if(g[e])if(y$(g[e])){for(f=0;y$(g[e]+"_"+f);)f++;a.id=g[e]+"_"+f}else a.id=g[e];w(a,g);(c.onClick||c.onSelect)&&a.addEventListener("click",c.onClick||c.onSelect,!1)},m=function(d){if(d!=e){var f=h.insertCell(z),k=v(b[s]),l=null!==d?unmaskHTML(k[d]):unmaskHTML(k);c.columns&&c.columns[d]&&(c.columns[d].align&&
(f.style.textAlign=c.columns[d].align),c.columns[d].type&&(l=yAnalise("%"+c.columns[d].type+"("+l+")")));g||f.addClass("warning");f.innerHTML=0===l.length?"&nbsp;":l;f.style.verticalAlign="top";f.id=a+"_"+z+"_"+q.rows.length;f.setAttribute("colName",d);if("function"==typeof c.onNewItem)c.onNewItem(a,f,k);z+=1}},q,s,p,z,x,A=(new Date).getTime()-1447265735470;if(k)if("TABLE"==k.nodeName){q=0<k.getElementsByTagName("tbody").length?k.getElementsByTagName("tbody")[0]:k;0<q.getElementsByTagName("tbody").length&&
...
v(b[s]);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,l);p=document.createElement("li");w(p,l);m="";A=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)m=m+yAnalise(c.rows[r],l)+"";A=!0}else if("string"==typeof c.html)m=m+yAnalise(c.html,l)+"",A=!0;else for(f in l)""===m&&l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(m+=l[f]);t(p);A?p.innerHTML=m:p.appendChild(document.createTextNode(m));"string"==typeof c.beforeElement?(m=y$(c.beforeElement),k.insertBefore(p,m)):
...
e&&"rowid"!=f&&"_elementid_"!=f){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;h.appendChild(x)}}else for(f in c.columns)if(f!=e){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;h.appendChild(x)}w(h,l);k.appendChild(h);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);
z=0;for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);l._elementid_=a;if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,l);t="";if("undefined"==typeof c.columns)if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in l)l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=l[f]);else if(m=c.sep||"",isArray(c.columns))for(p=0;p<c.columns.length;p++)""<t&&(t+=m),t+=l[c.columns[p]];else if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");
else for(f in c.columns)f!=e&&(t=t+l[f]+m);p=document.createElement("option");"undefined"!=typeof l[e]&&("DATALIST"==k.nodeName?p.setAttribute("data-"+e,l[e]):p.value=l[e]);p.innerHTML=t;p.id=a+"_"+z;w(p,l);if("function"==typeof c.onNewItem)c.onNewItem(a,p,l);k.appendChild(p);z++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var C,B,y,l=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length){t=v(b[0]||b);w(k,t);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,
...
B&&(l[k].selectedIndex=s)}if("function"==typeof c.onNewItem)c.onNewItem(a,l[k],t)}}else 1<b.length&&_dump("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&(d.deleteRows&&(k.innerHTML=""),t=k.innerHTML,b)){for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);w(k,l);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,l);if(c.html)t+=yAnalise(c.html,l);else for(f in l)l.hasOwnProperty(f)&&(t+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,
...
ycomm.dom.testFormWithJunk=function(a){a=this.selectElements(a);var b,c,d,e,f,h=function(a,b,c){var d="",e;c=Math.floor(Math.random()*c+b);for(e=0;e<c;)b=Math.floor(Math.random()*a.length),d+=a[b],e++;return d},g=function(a,b){return Math.floor(Math.random()*(b-a)+a)},k=function(a){var b=!1;a=a.toUpperCase();for(var c=0;c<lClasses.length;c++)b=b||0<=lClasses[c].indexOf(a);return b};for(b=0;b<a.length;b++){c=a[b].type.toLowerCase();d=a[b].id;f=a[b].getAttribute("maxlength")||100;lClasses=a[b].className.split(" ");
for(e=0;e<lClasses.length;e++)lClasses[e]=lClasses[e].toUpperCase();e="";if(d){switch(c){case "password":e=h(ycomm.dom._scratch.ch,6,15);break;case "textarea":e=h(ycomm.dom._scratch.t,1,15*f);break;case "email":e=h(ycomm.dom._scratch.mn,2,3)+"@"+h(ycomm.dom._scratch.d,1,1);break;case "date":e=g(-22089816E5,25560648E5);e=new Date(e);e=e.toISOString().substr(0,10);break;case "color":case "datetime":case "datetime-local":case "month":e=g(1,12);break;case "number":case "range":e=g(1,100);break;case "search":case "tel":case "time":case "week":e=
g(1,52);break;case "url":e=h(ycomm.dom._scratch.p,1,1)+h(ycomm.dom._scratch.d,1,1)+".xyz";break;case "radio":case "checkbox":break;case "select-one":case "select-multi":break;case "hidden":fielValue="";break;default:e=k("cpf")?e.gerarCPF():k("cnpj")?e.gerarCNPJ():k("ie")?h(ycomm.dom._scratch.n,6,12):h(ycomm.dom._scratch.t,1,f),e=e.substr(0,f)}y$(d).value=e}}};
ycomm.dom.getFormElements=function(a,b,c){b=b||{};var d=b.elementPrefixName||b.prefix||"";b=b.elementPostixName||b.postfix||"";var e={};a=this.selectElements(a);for(var f,h,g,k,l,v,w=0,t,m=0;m<a.length;m++)if(a[m].getAttribute?(k=a[m].getAttribute("editMask")||"",l=a[m].getAttribute("storageMask")||"",v=a[m].getAttribute("valueType")||"text"):(l=k="",v="text"),t=!0,h=a[m].type.toLowerCase(),f=a[m].name||a[m].id,f.substr(f.length,-b.length)==b&&f.substr(0,d.length)==d&&(f=f.substr(d.length),f=f.substr(0,
f.length-b.length),""<f)){g="";if("radio"==h||"checkbox"==h)t=!1,"undefined"==typeof e[f]&&(e[f]="");switch(h){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "search":case "tel":case "time":case "url":case "week":g=a[m].value+"";""<k&&""<l&&0<=v.indexOf("date")&&(g=(g=dateTransform(g,k,l))?g+"":"");break;case "number":case "range":g=a[m].value;isNumber(g)&&(g=g.toFloat());break;case "radio":case "checkbox":g=
a[m].checked?a[m].value:"";t=""!==g;break;case "select-one":case "select-multi":g=a[m].selectedIndex;a[m].options[g]&&(g=a[m].options[g].value);break;case "file":"function"==typeof c?(h=new FileReader,w++,h._fieldName=f,h.addEventListener("load",function(){e[this._fieldName]=this.result;w--;0>=w&&c(e)}),h.readAsDataURL(a[m].files[0]),t=!1):g="aOnReady() not present in js call to getFormElements()"}"string"==typeof g&&0<=g.indexOf(",")&&(g=encodeURIComponent(g));t&&(e[f]=g)}return e};
...
var ycommSSEBase=function(a,b,c,d,e){var f={pollTimeout:Math.min(6E4,Math.max("number"==typeof d?d:1E3,1E3)),prefGateway:(e||"SSE").toUpperCase(),getLocation:function(){return"object"==typeof document&&document.location&&document.location.href?document.location.href:""},getFolder:function(a){var b=a.lastIndexOf("/");return a.substr(0,b+1)},rpc:function(a,b){b=b||{};"undefined"!=typeof f.sse_session_id&&(b.sse_session_id=f.sse_session_id);return new Promise(function(c,d){f.rpcMethod("_sse",a,b,function(a,
b,e){200==a?c(e):d(a)},!1)})},poll:function(){f.pollEnabled&&f.rpc("peekMessage").then(function(a){if(a){console.log("SSE: data: "+JSON.stringify(a));for(var b=0;b<a.length;b++)f.dispatchEvent(a[b].event,{data:a[b].data})||f.message({data:a[b].data})}setTimeout(f.poll,f.pollTimeout)})},userAlive:function(){var a=function(a){console.log("SSE: User logged out");f.close(a)};f.rpc("userAlive").then(function(b){var c=!1;b&&b[0]&&(c="CLOSE"==(b[0].event||"").toUpperCase());c?a():(console.log("SSE: User is alive"),
setTimeout(f.userAlive,f.userAliveInterval))}).catch(a)},attachUser:function(b){f.rpc("attachUser",{w:a,user:f.user}).then(function(c){c&&c[0]&&c[0].ok&&(f.w=a,f.sse_session_id=c[0].sse_session_id,f.userAliveInterval=Math.min(6E4,1E3*c[0].userAliveInterval),b())})},addEventListener:function(a,b){"undefined"==typeof f.events&&(f.events={});"undefined"==typeof f.events[a]&&(f.events[a]=[]);f.events[a].push([f.state,b]);1==f.state&&(f.pollEnabled||f.evtSource.addEventListener(a,b),"ready"==trim(a.toLowerCase())&&
f.dispatchEvent("ready"));return f},dispatchEvent:function(a,b){var c=!1;if("undefined"!==typeof f.events)for(var d=0;d<(f.events[a]||[]).length;d++)f.events[a][d][1](b),c|=1;eventName1=a;eventName2="on_"+a;"function"==typeof f[eventName1]?(f[eventName1](b),c|=1):"function"==typeof f[eventName2]?(f[eventName2](b),c|=1):c|=0;return c},startPolling:function(){f.pollEnabled=!0;f.state=1;f.dispatchEvent("ready",{gateway:"Polling"});setTimeout(f.poll,125);console.log("SSE: polling for messages. pollTimeout: {0}ms".format(f.pollTimeout))},
guardianTimeout:function(a){clearTimeout(f.evtGuardian);f.evtSource.close();f.evtSource=void 0;f.startPolling()},close:function(a){f.closing||(f.closing=!0,console.log("SSE: CLOSE"),f.state=-1,f.pollEnabled=!1,f.dispatchEvent("onclose"),f.evtSource&&f.evtSource.close(),f.closing=!1)},open:function(a){console.log("SSE: OPEN");f.dispatchEvent("onopen")},error:function(a){console.error("SSE: ERROR using SSE");f.dispatchEvent("onerror")},message:function(a){clearTimeout(f.evtGuardian);console.log("SSE: MESSAGE");
if(0===f.state){f.state=1;for(var b in f.events)if(f.events.hasOwnProperty(b))for(var c=0;c<f.events[b].length;c++){var d=f.events[b][c];1>d[0]&&(d[0]=1,f.evtSource.addEventListener(b,d[1]))}f.dispatchEvent("onready",{gateway:"SSE"});console.log("SSE: userAliveInterval: {0}ms".format(f.userAliveInterval));setTimeout(f.userAlive,f.userAliveInterval/2)}if("function"==typeof f.onmessage)f.onmessage(a.data)},init:function(){f.state=-1;f._dataLocation_="undefined"==typeof c||null===c?function(){var a=
f.getLocation(),b=a.lastIndexOf("/");return a.substr(0,b+1)+"sse.php"}():c;if("file:"==f._dataLocation_.substr(0,5))console.error("SSE: '"+f._dataLocation_+"' is not a correct data location");else{f.user=null!==b&&"undefined"!=typeof b?b:generateUUID();var a=f.getFolder(f.getLocation()),d=f.getFolder(f._dataLocation_);f.rpcMethod=a==d?ycomm.invoke:ycomm.crave;f.attachUser(function(){f.state=0;"SSE"==f.prefGateway&&"function"==typeof window.EventSource?(f.evtSource=new EventSource(f._dataLocation_+
"?si="+md5(f.sse_session_id)),f.evtSource.addEventListener("open",f.open,!1),f.evtSource.addEventListener("error",f.error,!1),f.evtSource.addEventListener("message",f.message,!1),f.evtSource.addEventListener("close",f.close,!1),f.evtGuardian=setTimeout(f.guardianTimeout,1500)):f.startPolling()})}return f}};return f.init()};_dump("ycomm-sse");
...
a)},B=function(a){0==a?(f=b.cfg.divContainerName+"_day_"+y.toUDate().substring(0,8),e=y.getDate()):(e=y.getHours()+":"+y.getMinutes(),f=b.cfg.divContainerName+"_day_"+y.toUDate().substring(0,12))},y=new Date(A),F=(D-y)/w+1;if(0===b.cfg.view)if(0==b.cfg.orientation)for(n=0;n<A.getDay();n++)C();else{y.setDate(y.getDate()-A.getDay());var G=[],E=new Date(y);for(n=0;n<b.context.nRows;n++)G[n]=new Date(E),E.setDate(E.getDate()+1)}for(;0<F;)d||(s=b.context.oCalTable.insertRow(-1),p=s.insertCell(),p.className=
"calBand",d=!0),e="",1==b.cfg.orientation?y<A||y>D?C():0===b.cfg.view||1===b.cfg.view?B(0):2===b.cfg.view?B(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?B(0):2===b.cfg.view?B(1):_dumpy(8,1,"Not implemented")),""<e&&(h=q+"Cell",0===y.getDay()&&(h+=" "+q+"FreeCell"),y.getDate()==b.cfg.date.getDate()&&(h+=" "+q+"Highlight"),k=document.createElement("div"),mergeObject(x,k.style),k.id=f,k.className=h,mergeObject(x,k.style),k.date=y,l=document.createElement("span"),
l.id=f+"_tag",l.className="calTag",null!=b.cfg.callback&&(g=b.cfg.callback(b,"getTagContent",l)||"",""<g&&(e=g)),l.innerHTML=e,k.appendChild(l),null!=b.cfg.callback&&(v=b.cfg.callback(b,"getCellContent",k)||"",""<v&&(k.innerHTML+=v)),p.appendChild(k)),1==b.cfg.orientation?y.setTime(y.getTime()+w*b.context.nRows):y.setTime(y.getTime()+w),t++,t>=b.context.nCols&&(t=0,m++,d=!1,1==b.cfg.orientation&&(y=G[m])),F--;if(d){for(;t<b.context.nCols;)C();t=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
...
function dynTableCloneRow(a,b){for(;void 0!=a&&!(a instanceof HTMLTableRowElement);)a=a.parentNode;if(a){for(var c=a.parentNode,d=a.cloneNode(!0),e=0;e<d.cells.length;e++)for(var f=d.cells[e],h=0;h<f.childNodes.length;h++){var g=f.childNodes[h];if(""<g.id){for(var k=_dynExplodeTag(g.id),l=k[1],l=0;y$(k[0]+zeroPad(l,2));)l++;g.id=k[0]+zeroPad(l,2);g.name=g.id;g.onchange=b}g.value=null}return c.insertBefore(d,a.nextSibling)}alert("Your button is outside a table");return null}
...
function calcGridAddItem(a,b,c,d,e,f,h,g,k,l){void 0==g&&(g=!1);void 0==k&&(k="");void 0==l&&(l="2");var v=!0,w=e.split(",");if(!g)for(var t in w)w.hasOwnProperty(t)&&void 0==b[w[t]]&&(v=!1);v?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=h,a[c].units=k,a[c].decimalPlaces=l):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
d;e.openNextField=[];e.openNextField.name="openNextField";e.openNextField.type="hidden";e.openNextField.value=1;var a=getX(h)+parseInt(h.offsetWidth),l=getY(h)+parseInt(h.offsetHeight);e._position=[];e._position.name="_position";e._position.type="hidden";e._position.value={x:a,y:l};e._position.onChangesFuncName=f;askValue("/",'javascript:dynSetCellValue("'+c+"_"+b+'")',e)}:null)}
