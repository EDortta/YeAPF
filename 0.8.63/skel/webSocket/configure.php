...
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.63-113 built on 2019-07-12 15:23 (-3 DST)\n");
...
<meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />";
  ...
  echo sayStep("<div style='border-left: solid 4px black; padding: 12px; background-color: #fff'>
    ...
    <h3>YeAPF 0.8.63-113 built on 2019-07-12 15:23 (-3 DST)<br>
    Copyright (C) 2004-2019 Esteban Daniel Dortta - dortta@yahoo.com - MIT License<br>
    Last modification: 2019-07-12 15:23:24 (-3 DST)</h3></div>");
