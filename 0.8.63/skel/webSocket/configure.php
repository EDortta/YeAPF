...
function openConfigFile() {
	...
	if ($configFile) {
		...
		fwrite($configFile, " * YeAPF 0.8.63-259 built on 2020-02-26 11:44 (-3 DST)\n");
...
echo sayStep("<div style='border-left: solid 4px black; padding: 12px; background-color: #fff'>
    ...
    <h3>YeAPF 0.8.63-259 built on 2020-02-26 11:44 (-3 DST)<br>
    Copyright (C) 2004-2020 Esteban Daniel Dortta - dortta@yahoo.com - MIT License<br>
    Last modification: 2020-02-26 11:44:34 (-3 DST)</h3></div>");
...
$ySearchPath = "includes;YeAPF/includes;.distribution/0.8.63/includes;YeAPF/.distribution/0.8.63/includes;lib;lib/YeAPF;lib/YeAPF/includes";
...
if ($canConfig) {
	...
	if (function_exists("yeapfVersion")) {
		...
		if (("0.8.63") != yeapfVersion()) {
			dieConfig(sayStep("<span class=redDot></span><ul class=err>Your configure version is '0.8.63' while your installed version is '" . yeapfVersion() . " at " . yeapfBaseDir() . "'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>"));
		}
