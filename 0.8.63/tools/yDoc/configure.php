...
*/
  ...
  echo "<div class=cpyrght><strong><big><I>tools/yDoc/configure.php</I></big></strong><br>
    YeAPF 0.8.63-54 built on 2019-07-02 19:38 (-3 DST)<br>
    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion"))
        if (("0.8.63") != yeapfVersion())
          die("<ul class=err>Your configure version is '0.8.63' while your installed version is '".yeapfVersion()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>");
