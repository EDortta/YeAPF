/* YeAPF 0.8.56-103 built on 2017-05-05 11:06 (-3 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.56-103 built on 2017-05-05 11:06 (-3 DST)");
...
function grayColor(a){a=decomposeColor(a);a=(32*Math.floor(a[0]/32)+32*Math.floor(a[1]/32)+32*Math.floor(a[2]/32))/3;a=dec2hex(a);return a+a+a}function rgb2hex(a){return"undefined"===typeof a.b?dec2hex(dc[0])+dec2hex(dc[1])+dec2hex(dc[2]):dec2hex(dc.r)+dec2hex(dc.g)+dec2hex(dc.b)}
