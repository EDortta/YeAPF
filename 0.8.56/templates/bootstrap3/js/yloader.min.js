/* YeAPF 0.8.56-101 built on 2017-05-05 10:59 (-3 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.56-101 built on 2017-05-05 10:59 (-3 DST)");
...
!a.isWorker&&a.isChromeExtension&&!chrome.storage;a.loadLibrary=function(b,c){var d;if(""<b){if("chrome-extension:"!=a.selfLocation.substr(0,17))b=a.selfLocation+"/"+b+"?v=0.8.56";else{for(var e=a.selfLocation.split("/"),f="",h=3;h<e.length;h++)""<e[h]&&(""<f&&(f+="/"),f+=e[h]);b=f+"/"+b+"?v=0.8.34"}b=b.replace(/\/\//g,"/");b=b.replace("http:/","http://");e=b.split("/");0<e.length&&(d=e[e.length-1]);"function"==typeof importScripts?importScripts(b):(e=document.getElementsByTagName("head")[0],
0>b.indexOf(".css")?(f=document.createElement("script"),f.type=0<b.indexOf(".js")?"text/javascript":"text/text",f.src=b):(f=document.createElement("link"),f.id=c||d,f.rel="stylesheet",f.type="text/css",f.href=b,f.media="all"),e.appendChild(f));_dump(d+" added")}};a.isWorker||window.addEventListener("load",function(){var a="CSS1Compat"===document.compatMode?document.documentElement:document.body,c=document.getElementById("screen");c&&(c.style.width=a.clientWidth+"px")});return a};_dump("R1");
...
var hsmColorBase=function(){return{HueShift:function(a,b){for(a+=b;360<=a;)a-=360;for(;0>a;)a+=360;return a},RGB2HSV:function(a){var b={};"undefined"==typeof a.r&&(a={r:a[0],g:a[1],b:a[2]});var c=a.r,d=a.g,e=a.b,c=NaN-(c<d?c<e?c:e:d<e?d:e);b.saturation=100*c/NaN;0===b.saturation?b.hue=0:void 0==a.r?b.hue=60*(a.g-a.b)/c:void 0==a.g?b.hue=120+60*(a.b-a.r)/c:void 0==a.b&&(b.hue=240+60*(a.r-a.g)/c);0>b.hue&&(b.hue+=360);b.value=Math.round(NaN);b.hue=Math.round(b.hue);b.saturation=Math.round(b.saturation);
return b},HSV2RGB:function(a,b){b=b||!0;var c={},d={};if(0==a.saturation)c.r=c.g=c.b=Math.round(2.55*a.value);else{a.hue/=60;a.saturation/=100;a.value/=100;var e=Math.floor(a.hue),f=a.hue-e,h=a.value*(1-a.saturation),g=a.value*(1-a.saturation*f),f=a.value*(1-a.saturation*(1-f));switch(e){case 0:c.r=a.value;c.g=f;c.b=h;break;case 1:c.r=g;c.g=a.value;c.b=h;break;case 2:c.r=h;c.g=a.value;c.b=f;break;case 3:c.r=h;c.g=g;c.b=a.value;break;case 4:c.r=f;c.g=h;c.b=a.value;break;default:c.r=a.value,c.g=h,c.b=
g}c.r=Math.round(255*c.r);c.g=Math.round(255*c.g);c.b=Math.round(255*c.b)}b?(d[0]=c.r,d[1]=c.g,d[2]=c.b):d=c;return d}}},hsmColor=hsmColorBase(),xml2array=function(a){var b,c={};c.not_whitespace=new RegExp(/[^\s]/);c.parent_count=null;c.xml2array=function(a,e){var f,h,g,k="";e=e||{};a.nodeName&&"#"!=a.nodeName.charAt(0)&&1<a.childNodes.length&&(f={},k=a.nodeName);var l=a.nodeValue;a.parentNode&&a.parentNode.nodeName&&l&&c.not_whitespace.test(l)&&(f={},f[a.parentNode.nodeName]=l);if(a.childNodes.length)if(1==
