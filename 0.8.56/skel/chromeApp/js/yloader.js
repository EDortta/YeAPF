 ...
 **********************************************/
 ...
 console.log("YeAPF 0.8.56-103 built on 2017-05-05 11:06 (-3 DST)");
 /* START yopcontext.js */
     /***********************************************************************
      * First Version (C) 2014 - esteban daniel dortta - dortta@yahoo.com
      *
   ...
   that.loadLibrary = function (jsFileName, elementId) {
     ...
     if (jsFileName>'') {
       if (that.selfLocation.substr(0,17)!='chrome-extension:')
         jsFileName = that.selfLocation+'/'+jsFileName+'?v=0.8.56';
       else {
         // chrome.runtime.id
     ...
     */
     ...
     function rgb2hex (rgb) {
       ...
       if (typeof rgb.b ==='undefined') {
         res=dec2hex(dc[0])+dec2hex(dc[1])+dec2hex(dc[2]);
       } else {
         res=dec2hex(dc.r)+dec2hex(dc.g)+dec2hex(dc.b);
       }
       return res;
     }
