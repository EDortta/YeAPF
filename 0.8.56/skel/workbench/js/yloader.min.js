/* YeAPF 0.8.56-92 built on 2017-04-21 15:10 (-3 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.56-92 built on 2017-04-21 15:10 (-3 DST)");
...
String.prototype.abreviated||(String.prototype.abreviated=function(a){a=str2int(a);if(0<this.indexOf(" ")){for(var b,c,d=this.toString(),e="",f="",h,g;e.length+f.length+1<=a&&(d=trim(d),b=d.indexOf(" "),0>b&&(b=d.length),c=d.lastIndexOf(" "),h=trim(d.substr(0,b)),g="",b<c&&(g=trim(d.substr(c)),d=trim(d.substr(0,c))),d=trim(d.substr(b)),b=0,""<h&&(e.length+f.length+h.length+(0<e.length?1:0<0+f.length?1:0)<a?(e=trim(e+" "+h),b++):e.length+f.length+1<a&&(e=trim(e+" "+h.substr(0,1)+"."),b++)),h!=g&&""<
g&&(e.length+f.length+g.length+(0<e.length?1:0<0+f.length?1:0)<a?(f=trim(g+" "+f),b++):e.length+f.length+1<a&&(f=trim(g.substr(0,1)+"."+f),b++)),0!=b););return trim(e+" "+f)}return this.substr(0,a)});String.prototype.ucFirst||(String.prototype.ucFirst=function(){return this.charAt(0).toUpperCase()+this.slice(1)});String.prototype.lcFirst||(String.prototype.lcFirst=function(){return this.charAt(0).toLowerCase()+this.slice(1)});
