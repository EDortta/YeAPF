/* YeAPF 0.8.56-88 built on 2017-04-07 09:34 (-3 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.56-88 built on 2017-04-07 09:34 (-3 DST)");
...
function getStyleRuleValue(a,b){for(var c=0;c<document.styleSheets.length;c++)for(var d=document.styleSheets[c],d=d.cssRules?d.cssRules:d.rules,e=0;e<d.length;e++)if(d[e].selectorText&&d[e].selectorText.toLowerCase()===a)return"string"==typeof b?d[e].style[b]:d[e]}
