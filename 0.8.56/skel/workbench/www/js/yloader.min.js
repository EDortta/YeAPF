/* YeAPF 0.8.56-91 built on 2017-04-21 14:02 (-3 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.56-91 built on 2017-04-21 14:02 (-3 DST)");
...
String.prototype.abreviated||(String.prototype.abreviated=function(a){a=str2int(a);if(0<this.indexOf(" ")){for(var b=this.substr(0,this.indexOf(" ")),c=this.substr(this.lastIndexOf(" "));""<c&&b.length+c.length>a;)c=c.substr(0,c.length-1);return b+" "+c}return this.substr(0,a)});String.prototype.ucFirst||(String.prototype.ucFirst=function(){return this.charAt(0).toUpperCase()+this.slice(1)});String.prototype.lcFirst||(String.prototype.lcFirst=function(){return this.charAt(0).toLowerCase()+this.slice(1)});
