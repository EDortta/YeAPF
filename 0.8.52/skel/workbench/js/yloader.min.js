/* YeAPF 0.8.52-136 built on 2016-12-10 11:19 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.52-136 built on 2016-12-10 11:19 (-2 DST)");
...
Math.random()),d=Math.round(9*Math.random()),e=Math.round(9*Math.random()),f=Math.round(9*Math.random()),h=Math.round(9*Math.random()),g=Math.round(9*Math.random()),k;k=_mod_(5*a+4*b+3*c+2*d+9*e+8*f+7*h+6*g+2,11);var p=2>k?0:11-k;k=_mod_(6*a+5*b+4*c+3*d+2*e+9*f+8*h+7*g+3+2*p,11);return""+a+b+"."+c+d+e+"."+f+h+g+"/0001-"+p+(2>k?0:11-k)};String.prototype.gerarCPF=function(){var a=Math.round(9*Math.random()),b=Math.round(9*Math.random()),c=Math.round(9*Math.random()),d=Math.round(9*Math.random()),e=
Math.round(9*Math.random()),f=Math.round(9*Math.random()),h=Math.round(9*Math.random()),g=Math.round(9*Math.random()),k=Math.round(9*Math.random()),p;p=_mod_(10*a+9*b+8*c+7*d+6*e+5*f+4*h+3*g+2*k,11);var w=2>p?0:11-p;p=_mod_(11*a+10*b+9*c+8*d+7*e+6*f+5*h+4*g+3*k+2*w,11);return""+a+b+c+"."+d+e+f+"."+h+g+k+"-"+w+(2>p?0:11-p)}}String.prototype.isEmail||(String.prototype.isEmail=function(){return isEmail(this)});
...
g|a>>>32-g,c)},d=function(a,c,d,e,f,g,h){a=b(a,b(b(c&e|d&~e,f),h));return b(a<<g|a>>>32-g,c)},e=function(a,c,d,e,f,g,h){a=b(a,b(b(c^d^e,f),h));return b(a<<g|a>>>32-g,c)},f=function(a,c,d,e,f,g,h){a=b(a,b(b(d^(c|~e),f),h));return b(a<<g|a>>>32-g,c)},h=function(a){var b="",c="",d;for(d=0;3>=d;d++)c=a>>>8*d&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b},g=[],k,p,w,v,t,l,q,m,s;a=this.utf8_encode(a);g=function(a){var b,c=a.length;b=c+8;for(var d=16*((b-b%64)/64+1),e=Array(d-1),f=0,g=0;g<
c;)b=(g-g%4)/4,f=g%4*8,e[b]|=a.charCodeAt(g)<<f,g++;b=(g-g%4)/4;e[b]|=128<<g%4*8;e[d-2]=c<<3;e[d-1]=c>>>29;return e}(a);l=1732584193;q=4023233417;m=2562383102;s=271733878;a=g.length;for(k=0;k<a;k+=16)p=l,w=q,v=m,t=s,l=c(l,q,m,s,g[k+0],7,3614090360),s=c(s,l,q,m,g[k+1],12,3905402710),m=c(m,s,l,q,g[k+2],17,606105819),q=c(q,m,s,l,g[k+3],22,3250441966),l=c(l,q,m,s,g[k+4],7,4118548399),s=c(s,l,q,m,g[k+5],12,1200080426),m=c(m,s,l,q,g[k+6],17,2821735955),q=c(q,m,s,l,g[k+7],22,4249261313),l=c(l,q,m,s,g[k+
8],7,1770035416),s=c(s,l,q,m,g[k+9],12,2336552879),m=c(m,s,l,q,g[k+10],17,4294925233),q=c(q,m,s,l,g[k+11],22,2304563134),l=c(l,q,m,s,g[k+12],7,1804603682),s=c(s,l,q,m,g[k+13],12,4254626195),m=c(m,s,l,q,g[k+14],17,2792965006),q=c(q,m,s,l,g[k+15],22,1236535329),l=d(l,q,m,s,g[k+1],5,4129170786),s=d(s,l,q,m,g[k+6],9,3225465664),m=d(m,s,l,q,g[k+11],14,643717713),q=d(q,m,s,l,g[k+0],20,3921069994),l=d(l,q,m,s,g[k+5],5,3593408605),s=d(s,l,q,m,g[k+10],9,38016083),m=d(m,s,l,q,g[k+15],14,3634488961),q=d(q,m,
s,l,g[k+4],20,3889429448),l=d(l,q,m,s,g[k+9],5,568446438),s=d(s,l,q,m,g[k+14],9,3275163606),m=d(m,s,l,q,g[k+3],14,4107603335),q=d(q,m,s,l,g[k+8],20,1163531501),l=d(l,q,m,s,g[k+13],5,2850285829),s=d(s,l,q,m,g[k+2],9,4243563512),m=d(m,s,l,q,g[k+7],14,1735328473),q=d(q,m,s,l,g[k+12],20,2368359562),l=e(l,q,m,s,g[k+5],4,4294588738),s=e(s,l,q,m,g[k+8],11,2272392833),m=e(m,s,l,q,g[k+11],16,1839030562),q=e(q,m,s,l,g[k+14],23,4259657740),l=e(l,q,m,s,g[k+1],4,2763975236),s=e(s,l,q,m,g[k+4],11,1272893353),m=
e(m,s,l,q,g[k+7],16,4139469664),q=e(q,m,s,l,g[k+10],23,3200236656),l=e(l,q,m,s,g[k+13],4,681279174),s=e(s,l,q,m,g[k+0],11,3936430074),m=e(m,s,l,q,g[k+3],16,3572445317),q=e(q,m,s,l,g[k+6],23,76029189),l=e(l,q,m,s,g[k+9],4,3654602809),s=e(s,l,q,m,g[k+12],11,3873151461),m=e(m,s,l,q,g[k+15],16,530742520),q=e(q,m,s,l,g[k+2],23,3299628645),l=f(l,q,m,s,g[k+0],6,4096336452),s=f(s,l,q,m,g[k+7],10,1126891415),m=f(m,s,l,q,g[k+14],15,2878612391),q=f(q,m,s,l,g[k+5],21,4237533241),l=f(l,q,m,s,g[k+12],6,1700485571),
s=f(s,l,q,m,g[k+3],10,2399980690),m=f(m,s,l,q,g[k+10],15,4293915773),q=f(q,m,s,l,g[k+1],21,2240044497),l=f(l,q,m,s,g[k+8],6,1873313359),s=f(s,l,q,m,g[k+15],10,4264355552),m=f(m,s,l,q,g[k+6],15,2734768916),q=f(q,m,s,l,g[k+13],21,1309151649),l=f(l,q,m,s,g[k+4],6,4149444226),s=f(s,l,q,m,g[k+11],10,3174756917),m=f(m,s,l,q,g[k+2],15,718787259),q=f(q,m,s,l,g[k+9],21,3951481745),l=b(l,p),q=b(q,w),m=b(m,v),s=b(s,t);return(h(l)+h(q)+h(m)+h(s)).toLowerCase()};
...
function yAnalise(a,b){if(void 0!==a){a=unmaskHTML(a);var c=/\%(|\w+)\(/gi,d,e,f,h,g;for(e="";"string"==typeof a&&0<=(d=a.search(c));)if(e=a.slice(d).search(/\(/),0<=e){f=a.slice(d+e+1,d+e+2);if('"'==f||"'"==f){g=d+e+1;do g++,h=a.slice(g,g+1);while(h!=f&&g<a.length);f=g+a.slice(g).search(/\)/)-d}else f=a.slice(d).search(/\)/);var k=a.slice(d+1,d+e);e=h=a.slice(d+e+1,d+f);h=h.split(",");for(g=0;g<h.length;g++)h[g]=yAnalise(h[g],b);e=void 0;g=h[0].toUpperCase();var p=h[0];if(void 0!==b)if(void 0==b[0])e=
b[g]?yAnalise(b[g],b):yAnalise(b[p],b);else for(var w=b.length-1;0<=w&&void 0==e;w--)void 0!=b[w][g]?e=yAnalise(b[w][g],b):void 0!=b[w][p]&&(e=yAnalise(b[w][p],b));else e="string"==eval("typeof "+p)?eval(p):yAnalise(p);void 0==e&&(e="");h[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":h=Math.max(0,parseInt(h[1]));e=parseFloat(e);e=e.toFixed(h);break;case "lon2deg":e=dec2deg(e,!1);break;case "lat2deg":e=dec2deg(e,
!0);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;case "tstime":e=timestamp2time(e);break;case "date":e=h[1]?UDate2Date(e,h[1]):UDate2Date(e);break;case "time":e=h[1]?UDate2Time(e,h[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");p=Math.max(0,str2int(h[1]));w=Math.max(k.length-1,str2int(h[2]));h=Math.max(0,str2int(h[3]));e="";for(g=p;g<p+w;g++){var v=onlyDefinedValue(k[g]);""<v&&(e+=
" "+v)}0<h&&(e=wordwrap(e,h,"<br>",!0));break;case "quoted":e=('"'+e).trim()+'"';break;case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(g=0;g<h.length;g++)""<e&&(e+=","),e+="'"+h[g]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}else{console.log("HALTING yAnalise as entering in loop");break}}else a="";return a}
...
ycomm.explodeData=function(a){var b;a=xml2array(a).root||{};var c=a.dataContext||{},d=a.error||c.error||c.lastError,e=null,f=c.userMsg,h=c.sysMsg;if(h&&h.msg&&"logoff"==h.msg){ycomm.canReceiveMessages=!1;for(var g=window,k;g.opener;)k=g,g=g.opener,k.close();for(;g.parent!=g;)g=g.parent;h.banner&&(_dumpy(4,1,h.banner),alert(h.banner));g.document.location="body.php?s=yeapf&a=logoff"}if(ycomm.canReceiveMessages){if(c){var p;if(c.requiredFields)for(h=c.requiredFields.split(","),p=0;p<h.length;p++)fieldName=
h[p],y$(fieldName)&&y$(fieldName).addClass("fieldWarning");if(c.formError){h="";for(p in c.formError)c.formError.hasOwnProperty(p)&&(""<h&&(h+="\n"),h+=c.formError[p]);alert(h)}}if(a){void 0!=c.formID&&""==formID&&(formID=c.formID);c.firstRow=parseInt(c.firstRow);c.rowCount=parseInt(c.rowCount);c.requestedRows=parseInt(c.requestedRows);p=c.rowCount;b=a.data?a.data.row:a.row;1==p&&(b=Array(b));if(b)for(var w in b)if(b.hasOwnProperty(w))for(var v in b[w])b[w].hasOwnProperty(v)&&(b[w][v]=unmaskHTML(b[w][v]));
...
ycomm.dom.fillElement=function(a,b,c,d){if(void 0===c||null===c)c={};"boolean"==typeof d&&(d={deleteRows:d});d=d||{};"undefined"==typeof d.deleteRows&&(d.deleteRows=!0);"undefined"==typeof d.paintRows&&(d.paintRows=!0);var e,f,h,g,k=y$(a),p="undefined"==typeof ycomm.dom._elem_templates[a];e=c.idFieldName||"id";"boolean"==typeof d.unlearn&&(p=d.unlearn);var w=function(a){a.doc&&a.id&&a.value&&(a=a.doc);return a},v=function(a){var g,h=w(b[q]);s=0;"TR"==a.nodeName&&d.paintRows&&(a.style.backgroundColor=
rowColorSpec.suggestRowColor(D));if(h[e])if(y$(h[e])){for(g=0;y$(h[e]+"_"+g);)g++;a.id=h[e]+"_"+g}else a.id=h[e];if("undefined"!=typeof c.inplaceData)for(var k=0;k<c.inplaceData.length;k++)f=c.inplaceData[k],g=h[f]||"",a.setAttribute("data_"+f,g);(c.onClick||c.onSelect)&&a.addEventListener("click",c.onClick||c.onSelect,!1)},t=function(d){if(d!=e){var f=h.insertCell(s),k=w(b[q]),p=null!==d?unmaskHTML(k[d]):unmaskHTML(k);c.columns&&c.columns[d]&&(c.columns[d].align&&(f.style.textAlign=c.columns[d].align),
c.columns[d].type&&(p=yAnalise("%"+c.columns[d].type+"("+p+")")));g||f.addClass("warning");f.innerHTML=0===p.length?"&nbsp;":p;f.style.verticalAlign="top";f.id=a+"_"+s+"_"+l.rows.length;f.setAttribute("colName",d);if("function"==typeof c.onNewItem)c.onNewItem(a,f,k);s+=1}},l,q,m,s,x,z=(new Date).getTime()-1447265735470;if(k)if("TABLE"==k.nodeName){l=0<k.getElementsByTagName("tbody").length?k.getElementsByTagName("tbody")[0]:k;0<l.getElementsByTagName("tbody").length&&(l=l.getElementsByTagName("tbody")[0]);
if(p)if("undefined"==typeof(c.columns||c.rows||c.html)){if(ycomm.dom._elem_templates[a]={},0<l.rows.length)for(ycomm.dom._elem_templates[a].rows=[],k=0;k<l.rows.length;k++)ycomm.dom._elem_templates[a].rows[k]=trim(l.rows[k].innerHTML+"").replace(/\ \s+/g,"")}else ycomm.dom._elem_templates[a]={},ycomm.dom._elem_templates[a].columns=c.columns,ycomm.dom._elem_templates[a].rows=c.rows,ycomm.dom._elem_templates[a].html=c.html;mergeObject(ycomm.dom._elem_templates[a],c,!0);if(d.deleteRows)for(;0<l.rows.length;)l.deleteRow(l.rows.length-
1);var D=l.rows.length%2;s=null;for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);D++;g=!0;if(!d.deleteRows&&p[e])for(k=0;g&&k<l.rows.length;k++)if(l.rows[k].id==p[e]){for(h=l.rows[k];0<h.cells.length;)h.deleteCell(0);g=!1;p.rowid=k}g&&(h=d.insertAtTop?l.insertRow(0):l.insertRow(l.rows.length));z++;p.rowid=d.insertAtTop||"undefined"===typeof h.rowIndex?z+"":h.rowIndex;p._elementid_=a;v(h);if("undefined"==typeof c.html&&"undefined"==typeof c.rows&&"undefined"==typeof c.columns)if("string"==typeof p)t(null);
else for(f in p)p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&t(f);else if("undefined"!=typeof c.columns)if(isArray(c.columns))for(m=0;m<c.columns.length;m++)t(c.columns[m]);else for(m in c.columns)c.columns.hasOwnProperty(m)&&t(m);else if("undefined"!=typeof c.html){if(x=h.insertCell(0),x.innerHTML=yAnalise(c.html,p),x.style.verticalAlign="top",x.id=a+"_"+s+"_"+l.rows.length,"function"==typeof c.onNewItem)c.onNewItem(a,x,p)}else if("undefined"!=typeof c.rows)for(k=!0,r=0;r<c.rows.length;r++){k||
(h=l.insertRow(l.rows.length),v(h));h.innerHTML=yAnalise(c.rows[r],p);if(!g)for(m=0;m<h.cells.length;m++)h.cells[m].style.borderLeft="solid 1px red";if("function"==typeof c.onNewItem)c.onNewItem(a,h,p);k=!1}if("function"==typeof c.onNewRowReady)c.onNewRowReady(a,h)}}else if("UL"==k.nodeName){if(d.deleteRows)for(;k.firstChild;)k.removeChild(k.firstChild);for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);m=document.createElement("li");t="";z=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)t=t+
yAnalise(c.rows[r],p)+"";z=!0}else if("string"==typeof c.html)t=t+yAnalise(c.html,p)+"",z=!0;else for(f in p)""===t&&p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=p[f]);v(m);z?m.innerHTML=t:m.appendChild(document.createTextNode(t));"string"==typeof c.beforeElement?(t=y$(c.beforeElement),k.insertBefore(m,t)):k.appendChild(m);if("function"==typeof c.onNewItem)c.onNewItem(a,m,p)}}else if("LISTBOX"==k.nodeName){if(d.deleteRows)for(;0<k.childElementCount;)k.childNodes[0].remove();v=0;for(q in b)if(b.hasOwnProperty(q)){p=
w(b[q]);p._elementid_=a;h=document.createElement("listitem");s=0;if("undefined"==typeof c.columns)if("string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in p){if(p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){x=document.createElement("listcell");x.innerHTML=p[f];x.id=a+"_"+s+"_"+v;if("function"==typeof c.onNewItem)c.onNewItem(a,x,p);s+=1;h.appendChild(x)}}else for(f in c.columns)if(f!=e){x=document.createElement("listcell");x.innerHTML=p[f];x.id=
a+"_"+s+"_"+v;if("function"==typeof c.onNewItem)c.onNewItem(a,x,p);s+=1;h.appendChild(x)}k.appendChild(h);v++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);s=0;for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);p._elementid_=a;v="";if("undefined"==typeof c.columns)if("string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in p)p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(v+=p[f]);
else if(isArray(c.columns))for(m=0;m<c.columns.length;m++)v=v+p[c.columns[m]]+" ";else if(m=c.sep||"","string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(v=v+p[f]+m);t=document.createElement("option");"undefined"!=typeof p[e]&&(t.value=p[e]);t.innerHTML=v;t.id=a+"_"+s;if(c.inplaceData)for(m=0;m<c.inplaceData.length;m++)"undefined"!==typeof p[c.inplaceData[m]]&&t.setAttribute("data_"+c.inplaceData[m],p[c.inplaceData[m]]);if("function"==typeof c.onNewItem)c.onNewItem(a,
t,p);k.appendChild(t);s++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var B,A;x=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(var C=w(b[0]||b),t=c.elementPrefixName||c.prefix||"",z=c.elementPostixName||c.postfix||"",k=0;k<x.length;k++){if(v=x[k].getAttribute("editMask"),m=x[k].getAttribute("storageMask"),p=x[k].getAttribute("valueType")||"text",B=suggestKeyName(C,x[k].name||x[k].id,t,z),f=c.columns&&suggestKeyName(c.columns,x[k].name||
x[k].id)||null,"undefined"!=typeof C[B]&&(A=unmaskHTML(C[B]),B=x[k].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(p=c.columns[f].type,v=c.columns[f].editMask||v,m=c.columns[f].storageMask||m);"text"!=p&&(""<v&&""<m?0<=p.indexOf("date")&&(A=dateTransform(A,m,v)):A=yAnalise("%"+p+"("+A+")"));switch(B){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "number":case "range":case "search":case "tel":case "time":case "url":case "week":x[k].value=
A;break;case "radio":case "checkbox":x[k].value==A&&(x[k].checked=x[k].value===A);break;case "select-one":case "select-multi":for(q=0;q<x[k].options.length;q++)x[k].options[q].value==A&&(x[k].selectedIndex=q)}if("function"==typeof c.onNewItem)c.onNewItem(a,x[k],C)}}else 1<b.length&&_dump("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&(d.deleteRows&&(k.innerHTML=""),v=k.innerHTML,b)){for(q in b)if(b.hasOwnProperty(q))if(p=w(b[q]),c.html)v+=yAnalise(c.html,p);
else for(f in p)p.hasOwnProperty(f)&&(v+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,p[f]));k.innerHTML=v}};ycomm.dom.getRowId=function(a,b){if(a)for(;a&&a.parentNode;)a=a.parentNode};ycomm.dom.getRowByRowNo=function(a,b){var c=document.getElementById(a);return c?c.rows[b]:null};ycomm.dom.getTableRowId=function(a,b){var c=ycomm.dom.getRowByRowNo(a,b);return c?c.id:null};
...
ycomm.dom.getFormElements=function(a,b,c){b=b||{};var d=b.elementPrefixName||b.prefix||"";b=b.elementPostixName||b.postfix||"";var e={};a=this.selectElements(a);for(var f,h,g,k,p,w,v=0,t,l=0;l<a.length;l++)if(a[l].getAttribute?(k=a[l].getAttribute("editMask")||"",p=a[l].getAttribute("storageMask")||"",w=a[l].getAttribute("valueType")||"text"):(p=k="",w="text"),t=!0,h=a[l].type.toLowerCase(),f=a[l].name||a[l].id,f.substr(f.length,-b.length)==b&&f.substr(0,d.length)==d&&(f=f.substr(d.length),f=f.substr(0,
f.length-b.length),""<f)){g="";if("radio"==h||"checkbox"==h)t=!1,"undefined"==typeof e[f]&&(e[f]="");switch(h){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "number":case "range":case "search":case "tel":case "time":case "url":case "week":g=a[l].value+"";""<k&&""<p&&0<=w.indexOf("date")&&(g=(g=dateTransform(g,k,p))?g+"":"");break;case "radio":case "checkbox":g=a[l].checked?a[l].value:"";t=""!==
g;break;case "select-one":case "select-multi":g=a[l].selectedIndex;a[l].options[g]&&(g=a[l].options[g].value);break;case "file":"function"==typeof c?(h=new FileReader,v++,h._fieldName=f,h.addEventListener("load",function(){e[this._fieldName]=this.result;v--;0>=v&&c(e)}),h.readAsDataURL(a[l].files[0]),t=!1):g="aOnReady() not present in js call to getFormElements()"}"string"==typeof g&&(isNumber(g)?g=g.toFloat():0<=g.indexOf(",")&&(g=encodeURIComponent(g)));t&&(e[f]=g)}return e};
...
["L","P"];if(a=y$(b.cfg.divContainerName)){try{b.cfg.status=0;null!=b.cfg.callback&&b.cfg.callback(b,"DOMLocked",a);for(var e=null,f=null,h=null,g=null,k=null,p=null,w=null,v=2>b.cfg.view?864E5:6E4*b.cfg.dayEntryDivision,t=0,l=0,q="calDay"+d[b.cfg.view%2];a.hasChildNodes();)a.removeChild(a.lastChild);b.context.oCalTable=document.createElement("table");b.context.oCalTable.cellPadding=0;b.context.oCalTable.cellSpacing=0;var m=b.context.oCalTable.insertRow(-1),s=m.insertCell();s.className="calBand";
var d=!0,x=0,z={};null!=b.cfg.cellSize.height&&(z.height=parseInt(b.cfg.cellSize.height)+"px");null!=b.cfg.cellSize.width&&(z.width=parseInt(b.cfg.cellSize.width)+"px");var D=b.context.dateScope.first,B=b.context.dateScope.last;D.setHours(12);B.setHours(12);var A=function(){f=b.cfg.divContainerName+"_empty_"+x;var a=document.createElement("div");mergeObject(z,a.style);a.id=f;a.className=q+"Cell "+q+"EmptyCell";s.appendChild(a);0==b.cfg.orientation&&t++;x++;null!=b.cfg.callback&&b.cfg.callback(b,"getEmptyDayContent",
a)},C=function(a){0==a?(f=b.cfg.divContainerName+"_day_"+y.toUDate().substring(0,8),e=y.getDate()):(e=y.getHours()+":"+y.getMinutes(),f=b.cfg.divContainerName+"_day_"+y.toUDate().substring(0,12))},y=new Date(D),F=(B-y)/v+1;if(0===b.cfg.view)if(0==b.cfg.orientation)for(n=0;n<D.getDay();n++)A();else{y.setDate(y.getDate()-D.getDay());var G=[],E=new Date(y);for(n=0;n<b.context.nRows;n++)G[n]=new Date(E),E.setDate(E.getDate()+1)}for(;0<F;)d||(m=b.context.oCalTable.insertRow(-1),s=m.insertCell(),s.className=
"calBand",d=!0),e="",1==b.cfg.orientation?y<D||y>B?A():0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented"):0==b.cfg.orientation&&(0===b.cfg.view||1===b.cfg.view?C(0):2===b.cfg.view?C(1):_dumpy(8,1,"Not implemented")),""<e&&(h=q+"Cell",0===y.getDay()&&(h+=" "+q+"FreeCell"),y.getDate()==b.cfg.date.getDate()&&(h+=" "+q+"Highlight"),k=document.createElement("div"),mergeObject(z,k.style),k.id=f,k.className=h,mergeObject(z,k.style),k.date=y,p=document.createElement("span"),
p.id=f+"_tag",p.className="calTag",null!=b.cfg.callback&&(g=b.cfg.callback(b,"getTagContent",p)||"",""<g&&(e=g)),p.innerHTML=e,k.appendChild(p),null!=b.cfg.callback&&(w=b.cfg.callback(b,"getCellContent",k)||"",""<w&&(k.innerHTML+=w)),s.appendChild(k)),1==b.cfg.orientation?y.setTime(y.getTime()+v*b.context.nRows):y.setTime(y.getTime()+v),t++,t>=b.context.nCols&&(t=0,l++,d=!1,1==b.cfg.orientation&&(y=G[l])),F--;if(d){for(;t<b.context.nCols;)A();t=0;d=!1}a.appendChild(b.context.oCalTable)}catch(H){_dumpy(8,
...
function dynTableCloneRow(a,b){for(;void 0!=a&&!(a instanceof HTMLTableRowElement);)a=a.parentNode;if(a){for(var c=a.parentNode,d=a.cloneNode(!0),e=0;e<d.cells.length;e++)for(var f=d.cells[e],h=0;h<f.childNodes.length;h++){var g=f.childNodes[h];if(""<g.id){for(var k=_dynExplodeTag(g.id),p=k[1],p=0;y$(k[0]+zeroPad(p,2));)p++;g.id=k[0]+zeroPad(p,2);g.name=g.id;g.onchange=b}g.value=null}return c.insertBefore(d,a.nextSibling)}alert("Your button is outside a table");return null}
...
function calcGridAddItem(a,b,c,d,e,f,h,g,k,p){void 0==g&&(g=!1);void 0==k&&(k="");void 0==p&&(p="2");var w=!0,v=e.split(",");if(!g)for(var t in v)v.hasOwnProperty(t)&&void 0==b[v[t]]&&(w=!1);w?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=h,a[c].units=k,a[c].decimalPlaces=p):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
d;e.openNextField=[];e.openNextField.name="openNextField";e.openNextField.type="hidden";e.openNextField.value=1;var a=getX(h)+parseInt(h.offsetWidth),p=getY(h)+parseInt(h.offsetHeight);e._position=[];e._position.name="_position";e._position.type="hidden";e._position.value={x:a,y:p};e._position.onChangesFuncName=f;askValue("/",'javascript:dynSetCellValue("'+c+"_"+b+'")',e)}:null)}
