/* YeAPF 0.8.52-18 built on 2016-11-11 17:32 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.52-18 built on 2016-11-11 17:32 (-2 DST)");
...
function str2double(a){void 0===a&&(a="0");var b="",b=0<a.indexOf(",")&&0<a.indexOf(".")?a.replace(".",""):a,b=b.replace(",",".");""===b&&(b="0.00");b=parseFloat(b);isNaN(b)&&(b=0);a=parseFloat(b).toFixed(2);return a=parseFloat(a)}function str2int(a){a=parseInt(a);return null===a||isNaN(a)?0:a}function str2bool(a,b){void 0===b&&(b=!1);return a=void 0===a?b:"TRUE"==a.toUpperCase()}function bool2str(a){return a?"TRUE":"FALSE"}function dec2hex(a){return a.toString(16)}
...
a.removeEventListener(e,c,!1):a.detachEvent?a.detachEvent("on"+e,c):a["on"+e]=null}}}_dump("ymisc");"use strict";
...
b.postFixStack.push(a))}while("ERROR"!=a.type&&"EOF"!=a.type);do(d=b.symStack.pop())&&"EOF"!=d.type&&b.postFixStack.push(d);while(d&&"EOF"!=d.type)},solve:function(a){var d,e=[],f,h,g,k;for(d=0;d<b.postFixStack.length;d++)if(g=!1,f=b.postFixStack[d]){if("NUMBER"==f.type||"LITERAL"==f.type)h=f.token_string,h=String(h).toUpperCase(),g=!0;"IDENTIFIER"==f.type&&(h=a[f.token_string],"undefined"==typeof h?(h="'"+f.token_string+"' is not defined on data",console.error(h),h=!1):(h=String(h).toUpperCase(),
g=!0));if(g)e.push(h);else{k=e.pop();g=e.pop();switch((""+f.token_string).toUpperCase()){case "+":f=g+k;break;case "-":f=g-k;break;case "*":f=g*k;break;case "/":f=g/k;break;case "^":f=Math.pow(g,k);break;case ">":f=g>k;break;case "<":f=g<k;break;case ">=":f=g>=k;break;case "<=":f=g<=k;break;case "==":f=g==k;break;case "AND":case "&&":f=g&&k;break;case "OR":case "||":f=g||k;break;case "LIKE":g=String(g).toUpperCase();k=String(k).toUpperCase();f=k.replace(/\%/g,"");f="%"!=k.substr(0,1)?"%"!=k.substr(k.length-
1)?g==k:g.substr(0,f.length)==f:"%"==k.substr(k.length-1,1)?0<=g.indexOf(f):g.substr(g.length-f.length)==f;break;default:throw h="'"+f.token_string+"' is not a recognized operator",console.error(h),Error();}null!==f&&e.push(f)}}return f=e.pop()},showStack:function(a){for(var b="\t",e=0;e<a.length;e++)b+=a[e].token_string+" ";console.log(b)},parse:function(){b.reset();b._analiseText();return b.stack},reset:function(){b.pos=0;b.symStack=[];b.postFixStack=[];b.priorToken=b.voidToken},init:function(a){b.buf=
a||b.buf||"";b.reset();return b}};return b.init(a)};_dump("yanalise");var cfgDBbase=function(){return that={getConnParams:function(){var a=[];a.server=ystorage.getItem("server");a.user=ystorage.getItem("user");a.password=ystorage.getItem("password");a.token=ystorage.getItem("token");return a},setConnParams:function(a){ystorage.setItem("server",a.server);ystorage.setItem("user",a.user);ystorage.setItem("password",a.password);ystorage.setItem("token",a.token)}}},cfgDB=cfgDBbase();_dump("ycfgdb");
...
ycomm.dom.getTop=function(a){for(var b=0;a;)b+=a.offsetTop,a=a.offsetParent;return b};_dump("ycomm-dom");
