/* YeAPF 0.8.52-134 built on 2016-12-08 21:10 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.52-134 built on 2016-12-08 21:10 (-2 DST)");
...
b.dispatchEvent(a.tabfocusEvent);b.style.display="block";for(f=b;f&&f!=document.body;)f.style.display="block",f=f.parentNode;for(var g=b.getElementsByTagName("*"),e=0;e<g.length;){if("checkbox"==g[e].type||"radio"==g[e].type||"password"==g[e].type||"hidden"==g[e].type||"text"==g[e].type||"select-one"==g[e].type||"textarea"==g[e].type){g[e].focus();break}e++}window.dispatchEvent(a.tabshowEvent)}}}_dumpy(64,1,"return")}}finally{a.changingView=!1}}};a.showWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display=
"block")};a.hideWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display="none")};a.waitIconControl=function(b){void 0!=b&&(b?a.showWaitIcon():a.hideWaitIcon())};a.isInnerTab=function(a,c){var d=!1;if(a)for(var e=a;e&&e.parent!=e;)c==e&&(d=!0),e=e.parentNode;return d};a.hideTab=function(b,c,d){if(!a.locked()){_dumpy(64,1,"hideTab "+b.id);var e=!0;if(d=a.getContainerFromParam(d))if(d.childs.indexOf(b)==d.currentTabNdx){if(e=b.dispatchEvent(a.tabblurEvent)||e)d.currentTabNdx=-1}else e=!0;e&&
"object"==typeof b&&!a.isInnerTab(c,b)&&(b.style.display="none");return e}};a.showNext=function(b){if(b=a.getContainerFromParam(b)){var c=b.currentTabNdx;c<b.childs.length-1?a.displayTab(b.childs[c+1],b):a.displayTab(b.childs[0],b)}};a.showPrior=function(b){if(b=a.getContainerFromParam(b)){var c=b.currentTabNdx;0<c?a.displayTab(b.childs[c-1],b):a.displayTab(b.childs[b.childs.length-1],b)}};a.getCurrentTabId=function(b){var c=null;if(b=a.getContainerFromParam(b)){var d=b.currentTabNdx;-1<d&&(c=b.childs[d].id)}return c};
a.showTab=function(b,c,d){if(!a.locked()){d=a.getContainerFromParam(d,b);void 0==b&&(b=d.childs[0].id);void 0==c&&(c=!1);var e=document.getElementById(b),f="";e?(c&&(f=a.getCurrentTabId(d)),a.displayTab(e,d),c&&a.lockTab(b,f)):alert(b+" not found")}};a.locked=function(){return a.lock.locked};a.releaseLockedTabs=function(){for(var b=0;b<a.getCurrentContainer().childs.length;b++)a.getCurrentContainer().childs[b].locked&&(a.getCurrentContainer().childs[b].locked=!1);a.lock.locked=!1;a.lock.returnTabId=
null};a.lockTab=function(b,c){a.locked()&&a.releaseLockedTabs();y$(b)&&(a.lock.locked=!0,y$(b).locked=!0,a.lock.returnTabId=y$(c)?c:null)};a.unlockTab=function(b){a.locked()&&y$(b)&&y$(b).locked&&(b=a.lock.returnTabId,a.releaseLockedTabs(),null!=b&&a.showTab(b))};return a},mTabNav=tabNavBase();_dump("ytabnav");
