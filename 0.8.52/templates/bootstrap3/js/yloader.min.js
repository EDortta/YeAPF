/* YeAPF 0.8.52-145 built on 2016-12-13 08:40 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.52-145 built on 2016-12-13 08:40 (-2 DST)");
...
function str2double(a){"undefined"===typeof a&&(a="0");a=""+a;var b="",b=0<a.indexOf(",")&&0<a.indexOf(".")?a.replace(".",""):a,b=b.replace(",",".");""===b&&(b="0.00");b=parseFloat(b);isNaN(b)&&(b=0);a=parseFloat(b).toFixed(2);return a=parseFloat(a)}function str2int(a){a=parseInt(a);return null===a||isNaN(a)?0:a}function str2bool(a,b){void 0===b&&(b=!1);return a=void 0===a?b:"TRUE"==a.toUpperCase()}function bool2str(a){return a?"TRUE":"FALSE"}function dec2hex(a){return a.toString(16)}
...
b[g]?yAnalise(b[g],b):yAnalise(b[l],b);else for(var v=b.length-1;0<=v&&void 0==e;v--)void 0!=b[v][g]?e=yAnalise(b[v][g],b):void 0!=b[v][l]&&(e=yAnalise(b[v][l],b));else e="string"==eval("typeof "+l)?eval(l):yAnalise(l);void 0==e&&(e="");h[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":h=Math.max(0,parseInt(h[1]));e=parseFloat(e);e=e.toFixed(h);break;case "lon2deg":e=dec2deg(e,!1);break;case "lat2deg":e=dec2deg(e,
...
typeof d&&(yloader.isWorker?d(a.responseText):d(a.status,b.error,b.data,b.userMsg,b.dataContext,b.geometry))}})):(console.log("Not ready to call "+c),console.log("prototype library not loaded"))};_dump("ycomm-ajax");ycomm.setDataLocation=function(a,b){this._dataLocation_=a;this._deviceId_=b||guid()};ycomm.getDataLocation=function(){return this._dataLocation_};ycomm._scriptSequence=0;ycomm._maxScriptSequenceReceived=0;ycomm._CBSeq=1E3;ycomm._CBControl={};ycomm._load=0;ycomm._queue=0;
ycomm._maxDirectCall=10;ycomm._dataLocation_=function(){var a="object"==typeof document&&document.location&&document.location.href?document.location.href:"",b=a.lastIndexOf("/");return a.substr(0,b+1)+"rest.php"}();ycomm.getLoad=function(){return this._load};
