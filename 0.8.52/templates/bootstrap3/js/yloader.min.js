/* YeAPF 0.8.52-60 built on 2016-11-16 14:29 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.52-60 built on 2016-11-16 14:29 (-2 DST)");
...
(function(){y$=function(a,b,c){var d=null;if(""<a)if("#"==a.substr(0,1)&&(a=a.substr(1)),(d=document.getElementById(a))||(d=document.getElementsByName(a)[0]),d)"undefined"!==typeof b&&(c=0+c,d.getElementsByTagName&&(a=d.getElementsByTagName(b),0<a.length&&(d=a[c])));else{d=a.split(" ");a=null;for(c=0;c<d.length;c++)b=trim(d[c]),"."==b.substr(0,1)&&(b=b.substr(1)),b=getElementsByClassName(document,"*",b),0<b.length&&(a=null===a?b:array_intersect(a,b));d=a}return d}})();"undefined"==typeof $&&($=y$);
