 ...
 **********************************************/
 ...
 console.log("YeAPF 0.8.52-67 built on 2016-11-21 10:30 (-2 DST)");
 /* START yopcontext.js */
     /***********************************************************************
      * First Version (C) 2014 - esteban daniel dortta - dortta@yahoo.com
      *
   ...
   that.loadLibrary = function (jsFileName) {
     ...
     if (jsFileName>'') {
       if (that.selfLocation.substr(0,17)!='chrome-extension:')
         jsFileName = that.selfLocation+'/'+jsFileName+'?v=0.8.52';
       else {
         // chrome.runtime.id
     ...
     ( function () {
       y$ = function (aElementId, aTagName, aIndex) {
         ...
         if (aElementId>'') {
           ...
           if (!ret) {
             /* search by classes */
             var c, className, classes = aElementId.split(' '), classesReturn = null, first=true;
