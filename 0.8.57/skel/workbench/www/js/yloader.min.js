/* YeAPF 0.8.57-14 built on 2017-05-18 16:40 (-3 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.57-14 built on 2017-05-18 16:40 (-3 DST)");
...
!a.isWorker&&a.isChromeExtension&&!chrome.storage;a.loadLibrary=function(b,c,d){var e;if(""<b){if("chrome-extension:"!=a.selfLocation.substr(0,17))b=a.selfLocation+"/"+b+"?v=0.8.57";else{for(var f=a.selfLocation.split("/"),h="",g=3;g<f.length;g++)""<f[g]&&(""<h&&(h+="/"),h+=f[g]);b=h+"/"+b+"?v=0.8.34"}b=b.replace(/\/\//g,"/");b=b.replace("http:/","http://");b=b.replace("https:/","https://");f=b.split("/");0<f.length&&(e=f[f.length-1]);"function"==typeof importScripts?importScripts(b):(f=
