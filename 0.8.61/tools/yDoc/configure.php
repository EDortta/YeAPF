...
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.61-3 built on 2018-07-09 15:12 (-3 DST)\n");
  ...
  echo "<div class=cpyrght><strong><big><I>tools/yDoc/configure.php</I></big></strong><br>
    YeAPF 0.8.61-3 built on 2018-07-09 15:12 (-3 DST)<br>
    ...
    if ($canConfig) {
      ...
      if (function_exists("yeapfVersion"))
        if (("0.8.61") != yeapfVersion())
          die("<ul class=err>Your configure version is '0.8.61' while your installed version is '".yeapfVersion()."'<br><small>You can use 'yeapf.path' file to indicate where is your YeAPF distribution</small></ul>");
