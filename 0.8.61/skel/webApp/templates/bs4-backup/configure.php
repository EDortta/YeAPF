...
*/
  ...
  function openConfigFile()
  {
    ...
    if ($configFile) {
      ...
      fwrite($configFile," * YeAPF 0.8.61-70 built on 2018-09-13 19:29 (-3 DST)\n");
  ...
  echo sayStep("<div style='border-left: solid 4px black; padding: 12px; background-color: #fff'>
    ...
    <h3>YeAPF 0.8.61-70 built on 2018-09-13 19:29 (-3 DST)<br>
    Copyright (C) 2004-2018 Esteban Daniel Dortta - dortta@yahoo.com<br>
    Last modification: 2018-09-13 19:29:13 (-3 DST)</h3></div>");
