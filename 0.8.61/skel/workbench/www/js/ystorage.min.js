...
!0}return e},onDBRequestError:function(a){b.newStatus(-1);console.error("yIndexedDB error trying to open '{0}'".format(g))},onDBRequestSuccess:function(d){b.newStatus(3);b._db=d.target.result;"function"==typeof a&&a()},onDBUpgradeNeeded:function(a){b.newStatus(2);b._db=a.target.result;b._objectStore=b._db.createObjectStore(b._dbTag_,{keyPath:b._keyName_[0]});for(a=1;a<b._keyName_.length;a++)b._objectStore.createIndex(b._keyName_[a]+"_ndx",b._keyName_[a],{unique:!1});b.newStatus(3)},init:function(a,
c){b._dbTag_=a;c=c||"_id";if(!isArray(c)){var e=0<=c.indexOf(",")?",":";";c=c.split(e)}b._keyName_=c.slice();0===b._keyName_.length&&(b._keyName_[0]="_id");b._status=0;Object.defineProperty(b,"status",{get:function(){return b._status},configurable:!1,enumerable:!1});b.newStatus=function(a){if(a!=b._status&&(console.warn(b._dbTag_+".status changes from {0} to {1}".format(b.status,a)),b._status=a,"function"==typeof b.onStatusChange))b.onStatusChange(b)};window.indexedDB&&(b.newStatus(1),b._DBOpenRequest=
window.indexedDB.open(a,1),b._DBOpenRequest.onerror=b.onDBRequestError,b._DBOpenRequest.onsuccess=b.onDBRequestSuccess,b._DBOpenRequest.onupgradeneeded=b.onDBUpgradeNeeded);return b}};return b.init(g,h)});window.yServerWatcherObj||(window.yServerWatcherObj=function(g){var h={serverReady:function(a,b){var d=(new Date).getTime();ycomm.crave("sync","ping",null,function(c,e,f){200==c?0<parseInt(f.pong||0)&&(c=(new Date).getTime()-d,console.log("Server ready..."),console.log("Wasted time: {0}ms".format(c)),
ycomm.wd_interval=4*c,"function"==typeof a&&a()):"function"==typeof b&&b(c,e)})},init:function(){ycomm.setDataLocation(g);h.serverReady(function(){console.log("Server ready!")});return h}};return h.init()});window.yInfoObj||(window.yInfoObj=function(g,h){var a={};if("object"==typeof g&&"string"==typeof g.dbName)return a.cfg={db:ySingleDb(g.dbName,g.keyName),garbage:ySingleDb(g.dbName+"_garbage",g.keyName),dbName:g.dbName,keyName:g.keyName,dataModified:0,onrecordcount:null,onprogress:null,oncomplete:null},
a.onremove=function(b){b._ts_deletion=(new Date).getTime()/1E3;a.cfg.garbage.setItem(b._id,b);a.cfg.dataModified++},a.isbusy=function(){return a.busy},a.getItem=function(b){return a.cfg.db.getItem(b)},a.setItem=function(b,d,c){a.cfg.dataModified++;return a.cfg.db.setItem(b,d,c)},a.removeItem=function(b){return a.cfg.db.removeItem(b)},a.removeItems=function(b){return a.cfg.db.removeItems(b)},a.eliminateItem=function(b){return a.cfg.db.eliminateItem(b)},a.eliminateItems=function(b){return a.cfg.db.eliminateItems(b)},
a.cleanList=function(){return a.cfg.db.cleanList()},a.blankList=function(){return a.cfg.db.blankList()},a.linkTo=function(b,d){return a.cfg.db.linkTo(b,d)},a.filter=function(b,d,c,e){return a.cfg.db.filter(b,d,c,e)},a.each=function(b,d,c,e){return a.cfg.db.each(b,d,c,e)},a.paint=a.each,a.count=function(b){return a.cfg.db.count(b)},a.extractData=function(b,d){var c=[];a.each(function(a){c[c.length]=a},function(){b(c)},d)},a.insertData=function(b,d){return a.cfg.db.insertData(b,d)},a.cleanCondition=
function(){a.cfg.condition={}},a.setCondition=function(b){if("string"==typeof b){b=b.match(/\S+/g);var d,c="";for(d=0;d<b.length;d++)isNumber(b[d])||isOperator(b[d])||(b[d]="%("+b[d]+")"),c+=b[d]+" ";a.cfg.condition={_statement_:c}}else a.cfg.condition=b||{}},a.retrieveFromServer=function(b,d,c){var e=function(){var b={xq_start:a.cfg.xq_start,xq_collectionName:a.cfg.dbName},c=(new Date).getTime();mergeObject(a.cfg.condition,b);ycomm.crave("sync","getDocumentInSequence",b,function(b,d,f){if(0<f.length){a.cfg.interleave.adjustRestTime(c);
for(b=0;b<f.length;b++)if(a.setItem(f[b][a.cfg.keyName],f[b]),"function"==typeof a.cfg.onprogress)a.cfg.onprogress(a.cfg.dbName,f[b],a.cfg.xq_start+b);a.cfg.xq_start+=f.length;setTimeout(e,a.cfg.interleave.restTime)}else{if("function"==typeof a.cfg.oncomplete)a.cfg.oncomplete(a.cfg.dbName);a.busy=!1}})};if(a.busy)return console.warn("yInfoObj busy"),!1;a.busy=!0;a.cfg.onrecordcount=b||null;a.cfg.oncomplete=d||null;a.cfg.onprogress=c||null;a.server.serverReady(function(){ycomm.crave("sync","getRecordCount",
a.cfg.condition,function(b,c,d){d=d||[];d[0]=d[0]||{};if("function"==typeof a.cfg.onrecordcount)a.cfg.onrecordcount(a.cfg.dbName,parseInt(d[0].CC||0));a.cfg.xq_start=0;e()})},function(a,b){console.log("Erro {0} ao tentar acessar o servidor: {1}".format(a,b.message))});return!0},a.templatedData=function(b){var d;if(a.cfg.dataTemplateEmpty)d=b;else{d={};for(var c in a.cfg.dataTemplate)a.cfg.dataTemplate.hasOwnProperty(c)&&(d[c]=b[c])}return d},a.sendToServer=function(b,d,c){c=c||console.warn;if(a.busy)return c("yInfoObj busy"),
!1;a.busy=!0;a.cfg.onrecordcount=null;a.cfg.oncomplete=b||null;a.cfg.onprogress=d||null;var e=0;a.server.serverReady(function(){a.each(function(b){var d=a.templatedData(b);b._ts_upload=(new Date(b)).getTime()/1E3;mergeObject(a.cfg.condition,d);ycomm.crave("sync","setDocument",d,function(b,d,f){if(200==b){if("function"==typeof a.cfg.onprogress)a.cfg.onprogress(a.cfg.dbName,f[0],++e)}else c(b+": "+d)})},function(){if("function"==typeof a.cfg.oncomplete)a.cfg.oncomplete(a.cfg.dbName);a.busy=!1},a.cfg.condition)},
function(a,b){c("Erro {0} ao tentar acessar o servidor: {1}".format(a,b.message))});return!0},a.init=function(b){a.cfg.interleave=yRestTimeControl(500);a.cfg.dataTemplateEmpty="undefined"===typeof b?!0:!1;a.cfg.dataTemplate=b||{};a.cfg.db.onremove=a.onremove;a.server=yServerWatcherObj(restServer);a.cleanCondition();return a},a.init(g.dataTemplate);console.error("Since 0.8.55 the parameters or yInfoObj() has changed to (aDBSpec: {}, aServerSpec: {})");alert("Since 0.8.55 the parameters or yInfoObj() has changed to (aDBSpec: {}, aServerSpec: {})")})})();
