...
(function(){y$=function(a,b,c){var d=void 0,e;if("string"==typeof a&&""<a)if("#"==a.substr(0,1)&&(0<a.indexOf(" ")?d=document.querySelector(a):a=a.substr(1)),d||(d=document.getElementById(a)),d||(d=document.getElementsByName(a),d.length?(1==d.length&&(d=d[0]),0===d.length&&(d=void 0)):d=void 0),d)"undefined"!==typeof b&&(c=0+c,d.getElementsByTagName&&(a=d.getElementsByTagName(b),0<a.length&&(d=a[c])));else{d=a.split(" ");a=void 0;b=!0;for(c=0;c<d.length;c++)e=trim(d[c]),"."==e.substr(0,1)&&(e=e.substr(1)),
e=getElementsByClassName(document,"*",e),0<e.length&&(b?a=e:(b=!1,a=array_intersect(a||[],e)));d=a}return d}})();"undefined"==typeof $&&($=y$);"object"==typeof window&&(window.createDOMEvent=function(a){var b=null;isOnMobile()?(b=document.createEvent("Event"),b.initEvent(a,!0,!0)):b=new Event(a);return b});
...
String.prototype.extenso=function(a){var b=["zero um dois tr\u00c3\u00aas quatro cinco seis sete oito nove dez onze doze treze quatorze quinze dezesseis dezessete dezoito dezenove".split(" "),"dez vinte trinta quarenta cinq\u00c3\u00bcenta sessenta setenta oitenta noventa".split(" "),"cem cento duzentos trezentos quatrocentos quinhentos seiscentos setecentos oitocentos novecentos".split(" "),"mil milh\u00c3\u00a3o bilh\u00c3\u00a3o trilh\u00c3\u00a3o quadrilh\u00c3\u00a3o quintilh\u00c3\u00a3o sextilh\u00c3\u00a3o setilh\u00c3\u00a3o octilh\u00c3\u00a3o nonilh\u00c3\u00a3o decilh\u00c3\u00a3o undecilh\u00c3\u00a3o dodecilh\u00c3\u00a3o tredecilh\u00c3\u00a3o quatrodecilh\u00c3\u00a3o quindecilh\u00c3\u00a3o sedecilh\u00c3\u00a3o septendecilh\u00c3\u00a3o octencilh\u00c3\u00a3o nonencilh\u00c3\u00a3o".split(" ")],
c,d,e,f;d=this.replace(a?/[^,\d]/g:/\D/g,"").split(",");for(var g=d.length-1,h,k=-1,l=[],v=[],w="";++k<=g;v=[])if(k&&(d[k]=(1*("."+d[k])).toFixed(2).slice(2)),(c=(e=d[k]).slice((h=e.length)%3).match(/\d{3}/g),e=h%3?[e.slice(0,h%3)]:[],e=c?e.concat(c):e).length){c=-1;for(h=e.length;++c<h;w="")if(f=1*e[c])20>f%100&&(w+=b[0][f%100])||f%100+1&&(w+=b[1][(f%100/10>>0)-1]+(f%10?" e "+b[0][f%10]:"")),v.push((100>f?w:f%100?b[2][f/100>>0]+" e "+w:b[2][100==f?0:f/100>>0])+(-1<(w=h-c-2)?" "+(1<f&&0<w?b[3][w].replace("\u00c3\u00a3o",
"\u00c3\u00b5es"):b[3][w]):""));(c=1<v.length?(c=v.pop(),v.join(" ")+" e "+c):v.join("")||(!k&&0<1*d[k+1]||l.length?"":b[0][0]))&&l.push(c+(a?" "+(1<1*e.join("")?k?"centavos":(/0{6,}$/.test(d[0])?"de ":"")+"real".replace("l","is"):k?"centavo":"real"):""))}return l.join(" e ")};
...
var yInterfaceObj=function(){var a={openTab:function(b){var c=y$(".op-menu");if(c)if(c.forEach(function(a){a.deleteClass("active")}),"object"==typeof b){b.target&&(b=b.target);for(;b&&"LI"!=b.nodeName;)b=b.parentNode;b.addClass("active");b=b.getAttribute("data-tab");mTabNav.showTab(b)}else if("string"==typeof b)for(var d,c=0;c<document.links.length;c++)d=document.links[c].getAttribute("href"),d==b&&(a.openTab(document.links[c]),c=document.links.length)},getRowCount:function(a,c){return new Promise(function(d,
e){ycomm.invoke(a,"getRowCount",c||{},function(a,b,c,k,l){200==a?c&&c[0]?(c[0].cc=c[0].cc||c[0].CC||0,d(c[0])):e("status: "+a):e("status: "+a)})})},mountPagesIndex:function(b,c){var d=y$(b),e,f,g,h,k,l,v,w;k=getClientSize();if(d&&(e=y$(d.getAttribute("data-paginator")))){c=c||d.getAttribute("data-currentPage");f=d.getAttribute("data-subject");g=str2int(d.getAttribute("data-pageCount"));c=Math.min(g||1,Math.max(1,c||0));e.innerHTML="";h=Math.max(1,c-2);w=Math.ceil(Math.max(k[0],e.parentNode.offsetWidth)/
60);k=Math.min(g,h+4);w=Math.max(1,Math.ceil(g/(w-(k-h))));d.setAttribute("data-pageStep",w);for(d=1;d<1+g;)v=document.createElement("A"),v.setAttribute("href","#"+f),v.setAttribute("class","page-"+f),v.setAttribute("data-subject",f),v.setAttribute("data-table",b),v.setAttribute("data-pageNo",d),v.innerHTML=d,l=document.createElement("LI"),l.appendChild(v),d==c&&l.addClass("active"),e.appendChild(l),d<h?(d+=w,d>h&&(d=h)):d>k?d+=w:d++;addEvent(".page-"+f,"click",a.gotoPage)}},initializePagination:function(b,
