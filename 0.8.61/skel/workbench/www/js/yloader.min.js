/* YeAPF 0.8.61-144 built on 2018-11-20 06:55 (-2 DST) Copyright (C) 2004-2018 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.61-144 built on 2018-11-20 06:55 (-2 DST)");
...
!a.isWorker&&a.isChromeExtension&&!chrome.storage;a.isWebkit=/(safari|chrome)/.test(navigator.userAgent.toLowerCase());a.webKitVersion=function(){for(var a="530.00",c=navigator.userAgent.match(/([A-Za-z]*)\/([0-9A-Za-z\.]*)/g),d=0;d<c.length;d++)"AppleWebKit"==c[d].substr(0,11)&&(a=c[d].substr(12));return a}();a.operatingSystem=function(){for(var a=(navigator.userAgent.match(/(\([A-z\ 0-9\.\;\,\-\/\:]*)\)/g)[0]||"").replace(/[^a-zA-Z0-9\ \.\;]+/g,"").split(";")||["Unknown","Unknown"],c=0;c<a.length;c++)a[c]=
trim(a[c]||"Unknown");return a}();a.loadLibrary=function(b,c,d){var e;if(""<b){if("chrome-extension:"!=a.selfLocation.substr(0,17))b=a.selfLocation+"/"+b+"?v=0.8.61";else{for(var f=a.selfLocation.split("/"),g="",h=3;h<f.length;h++)""<f[h]&&(""<g&&(g+="/"),g+=f[h]);b=g+"/"+b+"?v=0.8.34"}b=b.replace(/\/\//g,"/");b=b.replace("http:/","http://");b=b.replace("https:/","https://");f=b.split("/");0<f.length&&(e=f[f.length-1]);"function"==typeof importScripts?importScripts(b):(f=document.getElementsByTagName("head")[0],
0>b.indexOf(".css")?(c=document.createElement("script"),c.type=0<b.indexOf(".js")?"text/javascript":"text/text",c.onload=d,c.src=b,f.appendChild(c)):(g=document.createElement("link"),g.id=c||e,g.rel="stylesheet",g.type="text/css",g.media="all",g.onload=d,g.href=b,f.appendChild(g)));_dump(e+" added")}};a.isWorker||window.addEventListener("load",function(){var a="CSS1Compat"===document.compatMode?document.documentElement:document.body,c=document.getElementById("screen");c&&(c.style.width=a.clientWidth+
"px")});return a};_dump("R1");var yloader=yloaderBase();_dump("R2");
...
String.prototype.abbreviate||(String.prototype.abbreviate=function(a,b){var c=function(){""<v&&(h.length+k.length+v.length+(0<h.length?1:0<0+k.length?1:0)<a?(k=trim(v+" "+k),x++):h.length+k.length+1<a&&(k=trim(v.substr(0,1)+"."+k),x++))},d=function(){""<l&&(h.length+k.length+l.length+(0<h.length?1:0<0+k.length?1:0)<a?(h=trim(h+" "+l),x++):h.length+k.length+1<a&&(h=trim(h+" "+l.substr(0,1)+"."),x++))};b=b||!1;a=str2int(a);if(0<this.indexOf(" ")){for(var e,f,g=this.toString(),h="",k="",l,v,x;h.length+
k.length+1<=a&&(g=trim(g),e=g.indexOf(" "),0>e&&(e=g.length),f=g.lastIndexOf(" "),l=trim(g.substr(0,e)),v="",e<f&&(v=trim(g.substr(f)),g=trim(g.substr(0,f))),g=trim(g.substr(e)),x=0,b?d():c(),l!=v&&(b?c():d()),0!==x););return trim(h+" "+k)}return this.substr(0,a)});String.prototype.ucFirst||(String.prototype.ucFirst=function(){return this.charAt(0).toUpperCase()+this.slice(1)});String.prototype.lcFirst||(String.prototype.lcFirst=function(){return this.charAt(0).toLowerCase()+this.slice(1)});
...
yAnalise(h[k],b,c);f=void 0;k=h[0].toUpperCase();var v=h[0];if(void 0!==b)if(void 0==b[0])f=b[k]?yAnalise(b[k],b,c):yAnalise(b[v],b,c);else for(var x=b.length-1;0<=x&&void 0==f;x--)void 0!=b[x][k]?f=yAnalise(b[x][k],b,c):void 0!=b[x][v]&&(f=yAnalise(b[x][v],b,c));else f=""==v?"":"."!=v.substr(0,1)&&"string"==eval("typeof "+v)?eval(v):yAnalise(v,null,c);void 0==f&&(f="");h[0]=f;switch(l){case "integer":case "int":case "intz":case "intn":f=str2int(f);0==f&&("intz"==l?f="-":"intn"==l&&(f=""));break;
...
x=Math.max(l.length-1,str2int(h[2]));h=Math.max(0,str2int(h[3]));f="";for(k=v;k<v+x;k++){var w=onlyDefinedValue(l[k]);""<w&&(f+=" "+w)}0<h&&(f=wordwrap(f,h,"<br>",!0));break;case "quoted":f=('"'+f).trim()+'"';break;case "singleQuoted":f=("'"+f).trim()+"'";break;case "condLabel":break;case "checked":f=countCheckedElements(f);break;default:""<l&&("function"==typeof c[l]?f=c[l].apply(null,h):"object"==typeof c[l]?f="function"==typeof c[l][f]?c[l][f].apply(null,h):c[l]:"undefined"!==typeof c[l]&&(f=c[l]))}a=
...
d.requestedRows=parseInt(d.requestedRows);h=d.rowCount;b=a.data?a.data.row:a.row;1==h&&(b=Array(b));if(b){c=[];for(var x in b)if(b.hasOwnProperty(x)){c[x]={};for(var w in b[x])b[x].hasOwnProperty(w)&&(c[x][w]=unmaskHTML(b[x][w]))}}void 0!==a.data&&(f=a.data.geometry)}}return{data:c,geometry:f,dataContext:d,error:e,userMsg:g}};ycomm.text2data=function(a){var b={};"function"==typeof DOMParser&&(a=(new DOMParser).parseFromString(a,"application/xml"),b=ycomm.explodeData(a));return b};
...
ycomm.dom.fillElement=function(a,b,c,d){if(void 0===c||null===c)c={};"boolean"==typeof d&&(d={deleteRows:d});d=d||{};"undefined"==typeof d.deleteRows&&(d.deleteRows=!0);"undefined"==typeof d.paintRows&&(d.paintRows=!0);"undefined"==typeof d.insertAtTop&&(d.insertAtTop=!1);var e,f,g,h,k=y$(a),l="undefined"==typeof ycomm.dom._elem_templates[a];e=c.idFieldName||"id";"boolean"==typeof d.unlearn&&(l=d.unlearn);var v=function(a){a.doc&&a.id&&a.value&&(a=a.doc);return a},x=function(a,b){if("undefined"!=
typeof c.inplaceData)for(var d=0;d<c.inplaceData.length;d++)if("undefined"!==typeof b[c.inplaceData[d]]){var e=c.inplaceData[d];a.setAttribute("data-"+e,b[e]||"")}},w=function(a){var f,g=v(b[q]);C=0;"TR"==a.nodeName&&d.paintRows&&(a.style.backgroundColor=rowColorSpec.suggestRowColor(F));if(g[e])if(y$(g[e])){for(f=0;y$(g[e]+"_"+f);)f++;a.id=g[e]+"_"+f}else a.id=g[e];x(a,g);(c.onClick||c.onSelect)&&a.addEventListener("click",c.onClick||c.onSelect,!1)},s=function(d){if(d!=e){var f=g.insertCell(C),k=
...
ycomm.dom._elem_templates[a].html=c.html;mergeObject(ycomm.dom._elem_templates[a],c,!0);if(d.deleteRows)for(;k.firstChild;)k.removeChild(k.firstChild);for(q in b)if(b.hasOwnProperty(q)){y=v(b[q]);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,y);l=document.createElement("li");x(l,y);t="";s=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)t=t+yAnalise(c.rows[r],y)+"";s=!0}else if("string"==typeof c.html)t=t+yAnalise(c.html,y)+"",s=!0;else for(f in y)""===t&&y.hasOwnProperty(f)&&
f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=y[f]||"");w(l);s?l.innerHTML=t:l.appendChild(document.createTextNode(t));"string"==typeof c.beforeElement?(t=y$(c.beforeElement),k.insertBefore(l,t)):k.appendChild(l);if("function"==typeof c.onNewItem)c.onNewItem(a,l,y)}k.dispatchEvent(window._evtFilled)}else if("LISTBOX"==k.nodeName){if(d.deleteRows)for(;0<k.childElementCount;)k.childNodes[0].remove();w=0;for(q in b)if(b.hasOwnProperty(q)){y=v(b[q]);y._elementid_=a;if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,
y);g=document.createElement("listitem");C=0;if("undefined"==typeof c.columns)if("string"==typeof y)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in y){if(y.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){l=document.createElement("listcell");l.innerHTML=y[f]||"";l.id=a+"_"+C+"_"+w;if("function"==typeof c.onNewItem)c.onNewItem(a,l,y);C+=1;g.appendChild(l)}}else for(f in c.columns)if(f!=e){l=document.createElement("listcell");l.innerHTML=y[f]||"";l.id=a+"_"+C+"_"+w;
if("function"==typeof c.onNewItem)c.onNewItem(a,l,y);C+=1;g.appendChild(l)}x(g,y);k.appendChild(g);w++}k.dispatchEvent(window._evtFilled)}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);C=0;for(q in b)if(b.hasOwnProperty(q)){y=v(b[q]);y._elementid_=a;if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,y);l="";if("undefined"==typeof c.columns)if("string"==typeof y)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");
else for(f in y)y.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(l+=y[f]||"");else if(w=c.sep||"",isArray(c.columns))for(t=0;t<c.columns.length;t++)""<l&&(l+=w),l+=y[c.columns[t]]||"";else if("string"==typeof y)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(l=l+(y[f]||"")+w);w=document.createElement("option");"undefined"!=typeof y[e]&&("DATALIST"==k.nodeName?w.setAttribute("data-"+e,y[e]):w.value=y[e]);w.innerHTML=l;w.id=a+"_"+C;x(w,y);if("function"==
typeof c.onNewItem)c.onNewItem(a,w,y);k.appendChild(w);C++}k.dispatchEvent(window._evtFilled);if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var m,D,z,B=function(a,b){var c=!1;if(z[a]){b=b.toUpperCase();var d=z[a].className.toUpperCase(),c=c||0<=d.indexOf(b)}return c};z=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length){var A=v(b[0]||b);x(k,A);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,A);s=c.elementPrefixName||c.prefix||k.getAttribute("data-prefix")||
"";E=c.elementPostixName||c.postfix||k.getAttribute("data-postfix")||"";for(l=0;l<z.length;l++)if(w=z[l].getAttribute("data-edit-mask")||z[l].getAttribute("editMask"),t=z[l].getAttribute("data-storage-mask")||z[l].getAttribute("storageMask"),y=z[l].getAttribute("data-value-type")||z[l].getAttribute("valueType")||"text",m=suggestKeyName(A,z[l].name||z[l].id,s,E),f=c.columns&&suggestKeyName(c.columns,z[l].name||z[l].id)||null,"undefined"!=typeof A[m]&&(D=unmaskHTML(A[m]),m=z[l].type.toLowerCase(),!c.columns||
""<f)){""<f&&!isArray(c.columns)&&(y=c.columns[f].type,w=c.columns[f].editMask||w,t=c.columns[f].storageMask||t);"text"!=y&&(""<w&&""<t?0<=y.indexOf("date")&&(D=dateTransform(D,t,w)||""):D=yAnalise("%"+y+"("+D+")"));switch(m){case "tel":z[l].value=(""+D).asPhone();break;case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "number":case "range":case "search":case "time":case "url":case "week":z[l].value=
...
k.nodeName&&(l&&("undefined"==typeof(c.columns||c.rows||c.html)?(ycomm.dom._elem_templates[a]={},ycomm.dom._elem_templates[a].html=k.innerHTML):(ycomm.dom._elem_templates[a]={},ycomm.dom._elem_templates[a].columns=c.columns,ycomm.dom._elem_templates[a].rows=c.rows,ycomm.dom._elem_templates[a].html=c.html)),mergeObject(ycomm.dom._elem_templates[a],c,!0),d.deleteRows&&(k.innerHTML=""),l=k.innerHTML,b)){for(q in b)if(b.hasOwnProperty(q)){y=v(b[q]);x(k,y);if("function"==typeof c.onBeforeNewItem)c.onBeforeNewItem(a,
...
ycomm.dom.getFormElements=function(a,b,c){b=b||{};var d={},e=this.selectElements(a),f,g,h,k,l,v=0,x;if(g=y$(a)){a=b.elementPrefixName||b.prefix||g.getAttribute("data-prefix")||"";for(var w=b.elementPostixName||b.postfix||g.getAttribute("data-postfix")||"",s=0;s<e.length;s++)if(e[s].getAttribute?(h=e[s].getAttribute("data-edit-mask")||e[s].getAttribute("editMask"),k=e[s].getAttribute("data-storage-mask")||e[s].getAttribute("storageMask"),l=e[s].getAttribute("data-value-type")||e[s].getAttribute("valueType")||
"text"):(k=h="",l="text"),x=!0,f=e[s].type.toLowerCase(),b=e[s].name||e[s].id,b.substr(b.length,-w.length)==w&&b.substr(0,a.length)==a&&(b=b.substr(a.length),b=b.substr(0,b.length-w.length),""<b)){g="";if("radio"==f||"checkbox"==f)x=!1,"undefined"==typeof d[b]&&(d[b]="");switch(f){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "search":case "tel":case "time":case "url":case "week":g=e[s].value+
"";""<h&&""<k&&0<=l.indexOf("date")&&(g=(g=dateTransform(g,h,k))?g+"":"");break;case "number":case "range":g=e[s].value;isNumber(g)&&(g=g.toFloat());break;case "radio":case "checkbox":g=e[s].checked?e[s].value:"";x=""!==g;break;case "select-one":case "select-multi":g=e[s].selectedIndex;e[s].options[g]&&(g=e[s].options[g].value);break;case "file":"function"==typeof c?(f=new FileReader,v++,f._fieldName=b,f.addEventListener("load",function(){d[this._fieldName]=this.result;v--;0>=v&&c(d)}),f.readAsDataURL(e[s].files[0]),
...
["L","P"];if(a=y$(b.cfg.divContainerName)){try{b.cfg.status=0;null!=b.cfg.callback&&b.cfg.callback(b,"DOMLocked",a);for(var e=null,f=null,g=null,h=null,k=null,l=null,v=null,x=2>b.cfg.view?864E5:6E4*b.cfg.dayEntryDivision,w=0,s=0,p="calDay"+d[b.cfg.view%2];a.hasChildNodes();)a.removeChild(a.lastChild);b.context.oCalTable=document.createElement("table");b.context.oCalTable.cellPadding=0;b.context.oCalTable.cellSpacing=0;var q=b.context.oCalTable.insertRow(-1),t=q.insertCell();t.className="calBand";
var d=!0,C=0,E={};null!=b.cfg.cellSize.height&&(E.height=parseInt(b.cfg.cellSize.height)+"px");null!=b.cfg.cellSize.width&&(E.width=parseInt(b.cfg.cellSize.width)+"px");var y=b.context.dateScope.first,F=b.context.dateScope.last;y.setHours(12);F.setHours(12);var m=function(){f=b.cfg.divContainerName+"_empty_"+C;var a=document.createElement("div");mergeObject(E,a.style);a.id=f;a.className=p+"Cell "+p+"EmptyCell";t.appendChild(a);0==b.cfg.orientation&&w++;C++;null!=b.cfg.callback&&b.cfg.callback(b,"getEmptyDayContent",
a)},D=function(a){0==a?(f=b.cfg.divContainerName+"_day_"+z.toUDate().substring(0,8),e=z.getDate()):(e=z.getHours()+":"+z.getMinutes(),f=b.cfg.divContainerName+"_day_"+z.toUDate().substring(0,12))},z=new Date(y),B=(F-z)/x+1;if(0===b.cfg.view)if(0==b.cfg.orientation)for(n=0;n<y.getDay();n++)m();else{z.setDate(z.getDate()-y.getDay());var A=[],H=new Date(z);for(n=0;n<b.context.nRows;n++)A[n]=new Date(H),H.setDate(H.getDate()+1)}for(;0<B;)d||(q=b.context.oCalTable.insertRow(-1),t=q.insertCell(),t.className=
...
l.id=f+"_tag",l.className="calTag",null!=b.cfg.callback&&(h=b.cfg.callback(b,"getTagContent",l)||"",""<h&&(e=h)),l.innerHTML=e,k.appendChild(l),null!=b.cfg.callback&&(v=b.cfg.callback(b,"getCellContent",k)||"",""<v&&(k.innerHTML+=v)),t.appendChild(k)),1==b.cfg.orientation?z.setTime(z.getTime()+x*b.context.nRows):z.setTime(z.getTime()+x),w++,w>=b.context.nCols&&(w=0,s++,d=!1,1==b.cfg.orientation&&(z=A[s])),B--;if(d){for(;w<b.context.nCols;)m();w=0;d=!1}a.appendChild(b.context.oCalTable)}catch(G){_dumpy(8,
...
function calcGridAddItem(a,b,c,d,e,f,g,h,k,l){void 0==h&&(h=!1);void 0==k&&(k="");void 0==l&&(l="2");var v=!0,x=e.split(",");if(!h)for(var w in x)x.hasOwnProperty(w)&&void 0==b[x[w]]&&(v=!1);v?void 0==a[c]?(a[c]=[],a[c].title=d,a[c].fieldList=e,a[c].calcExpr=f,a[c].resultCellPostfix=g,a[c].units=k,a[c].decimalPlaces=l):console.log("Field '"+c+"' already exists in calcGrid"):console.log("Some fields does not exists in ("+b+") list")}var _cg_rules=[];
...
e){ycomm.invoke(a,"getRowCount",c||{},function(a,b,c,k,l){200==a?c&&c[0]?(c[0].cc=c[0].cc||c[0].CC||0,d(c[0])):e("status: "+a):e("status: "+a)})})},mountPagesIndex:function(b,c){var d=y$(b),e,f,g,h,k,l,v,x;k=getClientSize();if(d&&(e=y$(d.getAttribute("data-paginator")))){c=c||d.getAttribute("data-currentPage");f=d.getAttribute("data-subject");g=str2int(d.getAttribute("data-pageCount"));c=Math.min(g||1,Math.max(1,c||0));e.innerHTML="";h=Math.max(1,c-2);x=Math.ceil(Math.max(k[0],e.parentNode.offsetWidth)/
60);k=Math.min(g,h+4);x=Math.max(1,Math.ceil(g/(x-(k-h))));d.setAttribute("data-pageStep",x);for(d=1;d<1+g;)v=document.createElement("A"),v.setAttribute("href","#"+f),v.setAttribute("class","page-"+f),v.setAttribute("data-subject",f),v.setAttribute("data-table",b),v.setAttribute("data-pageNo",d),v.innerHTML=d,l=document.createElement("LI"),l.appendChild(v),d==c&&l.addClass("active"),e.appendChild(l),d<h?(d+=x,d>h&&(d=h)):d>k?d+=x:d++;addEvent(".page-"+f,"click",a.gotoPage)}},initializePagination:function(b,
...
c){c=c||{};return new Promise(function(d,e){var f=0,g=[],h=function(){mergeObject({xq_start:f},c,!0);ycomm.invoke(a,"loadTable",c,function(a,b,c,x,w){200==a?(g=g.concat(c),w.rowCount>=w.requestedRows?(f+=w.rowCount,setTimeout(h,125)):d(g)):e("status: "+a)})};setTimeout(h,125)})},getButtonContext:function(a){a=a.target;"BUTTON"!=a.nodeName&&(a=a.parentNode);return y$(a.getAttribute("data-table"))},refreshTable:function(b){var c=a.getButtonContext(b),d,e;c&&(b=c.getAttribute("id"),d=JSON.parse(c.getAttribute("data-params"))||
...
trim(b.value).toUpperCase(),d=b.list.childNodes,e=b.closest("FORM"),f,g,h=!1,k,l,v,x=e.getAttribute("data-prefix")||"",w=e.getAttribute("data-postfix")||"",s=JSON.parse(b.getAttribute("data-result-spec")||"[]"),e=function(a){h=!0;for(g=0;g<s.length;g++)if(k=y$(x+s[g].to+w))l="data-"+s[g].from,v=a.getAttribute(l),k.value=v};a.input_clean_associated_field(b);for(f=0;f<d.length;f++)d[f].value.toUpperCase()===c&&e(d[f]);if(!h&&(b=JSON.parse(b.getAttribute("data-line-spec")||"{}"),b.columns))for(b=b.columns[0],
