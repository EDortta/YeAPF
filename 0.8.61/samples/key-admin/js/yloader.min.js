/* YeAPF 0.8.61-221 built on 2019-03-20 19:24 (-3 DST) Copyright (C) 2004-2019 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.61-221 built on 2019-03-20 19:24 (-3 DST)");
...
b&&b.forEach(function(a){ycomm.dom.fillElement(a.id,{})});setTimeout(function(){a.openTab(window.location.hash)},512);return a};return a.init()};"function"==typeof addOnLoadManager&&addOnLoadManager(function(){yInterface=yInterfaceObj()});_dump("yinterface");