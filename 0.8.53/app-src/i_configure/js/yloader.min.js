...
var ycommSSEBase=function(a,b){var c={getLocation:function(){return"object"==typeof document&&document.location&&document.location.href?document.location.href:""},getFolder:function(a){var b=a.lastIndexOf("/");return a.substr(0,b+1)},poll:function(){c.rpc("sse","peekMessage",{sse_session_id:c.sse_session_id},function(a,b,f){if(f)for(a=0;a<f.length;a++)c.message({event:f[a].event,data:f[a].data});setTimeout(c.poll,750)})},startPolling:function(){var b=c.getFolder(c.getLocation()),e=c.getFolder(c._dataLocation_);
c.rpc=b==e?ycomm.invoke:ycomm.crave;c.rpc("sse","attachUser",{w:a,u:"undefined"!=typeof u?u:generateSmallSessionUniqueId()},function(a,b,d){d&&d[0]&&d[0].ok&&(c.sse_session_id=d[0].sse_session_id,c.poll())})},guardianTimeout:function(a){clearTimeout(c.evtGuardian);c.evtSource.close();setTimeout(c.startPolling,125)},open:function(a){console.log(a)},error:function(a){console.error(a)},message:function(a){clearTimeout(c.evtGuardian);if("function"==typeof c.onmessage)c.onmessage(a.data)},init:function(){if("undefined"==
typeof b){var a=c,e;e=c.getLocation();var f=e.lastIndexOf("/");e=e.substr(0,f+1)+"sse.php";a._dataLocation_=e}else c._dataLocation_=b;"file:"==c._dataLocation_.substr(0,5)?console.error("'"+c._dataLocation_+"' is not a correct data location"):"function"==typeof window.EventSource?(c.evtSource=new EventSource(c._dataLocation_),c.evtGuardian=setTimeout(c.guardianTimeout,2E3),c.evtSource.addEventListener("open",c.open,!1),c.evtSource.addEventListener("error",c.error,!1),c.evtSource.addEventListener("message",
c.message,!1)):c.startPolling();return c}};return c.init()};_dump("ycomm-sse");
