/* YeAPF 0.8.53-92 built on 2017-01-23 18:31 (-2 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.53-92 built on 2017-01-23 18:31 (-2 DST)");
...
!a.isWorker&&a.isChromeExtension&&!chrome.storage;a.loadLibrary=function(b){var c;if(""<b){if("chrome-extension:"!=a.selfLocation.substr(0,17))b=a.selfLocation+"/"+b+"?v=0.8.53";else{for(var d=a.selfLocation.split("/"),e="",f=3;f<d.length;f++)""<d[f]&&(""<e&&(e+="/"),e+=d[f]);b=e+"/"+b+"?v=0.8.34"}b=b.replace(/\/\//g,"/");b=b.replace("http:/","http://");d=b.split("/");0<d.length&&(c=d[d.length-1]);"function"==typeof importScripts?importScripts(b):(d=document.createElement("script"),d.type=
0<b.indexOf(".js")?"text/javascript":0<b.indexOf(".css")?"text/css":"text/text",d.src=b,document.getElementsByTagName("head")[0].appendChild(d));_dump(c+" added")}};a.isWorker||window.addEventListener("load",function(){var a="CSS1Compat"===document.compatMode?document.documentElement:document.body,c=document.getElementById("screen");c&&(c.style.width=a.clientWidth+"px")});return a};_dump("R1");var yloader=yloaderBase();_dump("R2");
(function(){y$=function(a,b,c){var d=void 0,e;if(""<a)if("#"==a.substr(0,1)&&(a=a.substr(1)),(d=document.getElementById(a))||(d=document.getElementsByName(a)[0]),d)"undefined"!==typeof b&&(c=0+c,d.getElementsByTagName&&(a=d.getElementsByTagName(b),0<a.length&&(d=a[c])));else{d=a.split(" ");a=void 0;b=!0;for(c=0;c<d.length;c++)e=trim(d[c]),"."==e.substr(0,1)&&(e=e.substr(1)),e=getElementsByClassName(document,"*",e),0<e.length&&(b?a=e:(b=!1,a=array_intersect(a||[],e)));d=a}return d}})();
...
Function.prototype.method=function(a,b){this.prototype[a]=b;return this};Function.method("inherits",function(a){this.prototype=new a;return this});"function"!==typeof Object.create&&(Object.create=function(a){var b=function(){};b.prototype=a;return new b});Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=c);d<c;d++)if(d in this&&this[d]===a)return d;return-1});
...
!0);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;case "tstime":e=timestamp2time(e);break;case "date":e=h[1]?UDate2Date(e,h[1]):UDate2Date(e);break;case "time":e=h[1]?UDate2Time(e,h[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");l=Math.max(0,str2int(h[1]));v=Math.max(k.length-1,str2int(h[2]));h=Math.max(0,str2int(h[3]));e="";for(g=l;g<l+v;g++){var w=onlyDefinedValue(k[g]);""<w&&(e+=
" "+w)}0<h&&(e=wordwrap(e,h,"<br>",!0));break;case "quoted":e=('"'+e).trim()+'"';break;case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(g=0;g<h.length;g++)""<e&&(e+=","),e+="'"+h[g]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}else{console.log("HALTING yAnalise as entering in loop");break}}else a="";return a}
...
(y$("waitIcon").style.display="block")};a.hideWaitIcon=function(){y$("waitIcon")&&(y$("waitIcon").style.display="none")};a.waitIconControl=function(b){void 0!=b&&(b?a.showWaitIcon():a.hideWaitIcon())};a.isInnerTab=function(a,c){var d=!1;if(a)for(var e=a;e&&e.parent!=e;)c==e&&(d=!0),e=e.parentNode;return d};a.hideTab=function(b,c,d){if(!a.locked()){_dumpy(64,1,"hideTab "+b.id);var e=!0;if(d=a.getContainerFromParam(d))if(d.childs.indexOf(b)==d.currentTabNdx){if(e=b.dispatchEvent(a.tabblurEvent)||e)d.currentTabNdx=
-1}else e=!0;e&&"object"==typeof b&&!a.isInnerTab(c,b)&&(b.style.display="none");return e}};a.showNext=function(b){if(b=a.getContainerFromParam(b)){var c=b.currentTabNdx;c<b.childs.length-1?a.displayTab(b.childs[c+1],b):a.displayTab(b.childs[0],b)}};a.showPrior=function(b){if(b=a.getContainerFromParam(b)){var c=b.currentTabNdx;0<c?a.displayTab(b.childs[c-1],b):a.displayTab(b.childs[b.childs.length-1],b)}};a.getCurrentTabId=function(b){var c=null;if(b=a.getContainerFromParam(b)){var d=b.currentTabNdx;
-1<d&&(c=b.childs[d].id)}return c};a.showTab=function(b,c,d){if(!a.locked()){d=a.getContainerFromParam(d,b);void 0==b&&(b=d.childs[0].id);void 0==c&&(c=!1);var e=document.getElementById(b),f="";e?(c&&(f=a.getCurrentTabId(d)),a.displayTab(e,d),c&&a.lockTab(b,f)):alert(b+" not found")}};a.locked=function(){return a.lock.locked};a.releaseLockedTabs=function(){for(var b=0;b<a.getCurrentContainer().childs.length;b++)a.getCurrentContainer().childs[b].locked&&(a.getCurrentContainer().childs[b].locked=!1);
...
ycomm.bring=function(a){var b=document.head;ycomm.waitIconControl(!0);var c=document.createElement("script");_dumpy(4,1,a);var d=null,e=null,f=a.substr(a.indexOf("?")+1).split("&"),h;for(h in f)if(f.hasOwnProperty(h)){var g=f[h].split("=");"scriptSequence"==g[0]&&(d=g[1]);"callback"==g[0]&&(e=g[1])}ycomm._maxScriptSequenceReceived=Math.max(ycomm._maxScriptSequenceReceived,d);c.UUID=generateUUID();c.maxWaitCount=ycomm.timeout/ycomm.wd_interval+2;c.callbackFunctionName=e;c.onload=function(){0<ycomm._load&&
ycomm._load--;this.abort=null;ycomm.waitIconControl(!1)};c.abort=function(){_dumpy(4,1,"Calling {0}(404);".format(e));setTimeout("{0}(404,{message: 'Server do not respond ({1})'}, {})".format(e,a),100)};c.pool=function(){_dumpy(4,5,this.UUID+" : "+this.maxWaitCount);this.maxWaitCount--;0<this.maxWaitCount?this._whatchdog_=setTimeout(this.id+".pool()",ycomm.wd_interval):"function"==typeof this.abort&&this.abort()};c.setAttribute("src",a);c.id="rest_"+d;try{_dumpy(4,2,"Creating {0} as {1}".format(c.UUID,
c.src)),b.appendChild(c),setTimeout(c.id+".pool()",ycomm.wd_interval)}catch(k){_dump("Exception: {0}".format(k.message))}setTimeout("ycomm._removeJSONP("+d+",'"+e+"');",ycomm.timeout)};
ycomm.crave=function(a,b,c,d,e){var f="undefined"==typeof u?"":u;"undefined"==typeof e&&(e=0);ycomm.registerCall("crave",a,b);ycomm._scriptSequence++;if(ycomm.getDataLocation()){var h;"function"==typeof d?(ycomm._CBSeq++,h="ycb"+ycomm._CBSeq,ycomm._CBControl[h]={ready:!1},window[h]=function(a,b,c,e,f,t){d(a,b,c,e,f,t);_dumpy(4,1,h)}):"string"==typeof d?h=d:console.error("param callBackFunction need to be function or string");""<h&&(ycomm._load++,a=ycomm.buildCommonURL(a||"",b||"",c||{},f),a="{0}?{1}&callback={2}&callbackId={3}&scriptSequence={4}&deviceId={5}".format(ycomm._dataLocation_,
...
ycomm.dom={_elem_templates:[]};ycomm.dom.fillInplaceData=function(a,b){for(var c in b)b.hasOwnProperty(c)&&("data-"==c.substr(0,5)?a.setAttribute(c,b[c]):a.setAttribute("data-"+c,b[c]))};ycomm.dom.getInplaceData=function(a){a=a.attributes;var b={},c,d,e;for(e in a)a.hasOwnProperty(e)&&(c=a[e],d=c.nodeName,"data-"==d.substr(0,5)&&(b[d]=c.nodeValue));return b};
...
c,!0);if(d.deleteRows)for(;0<q.rows.length;)q.deleteRow(q.rows.length-1);var D=q.rows.length%2;z=null;for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);D++;g=!0;if(!d.deleteRows&&l[e])for(k=0;g&&k<q.rows.length;k++)if(q.rows[k].id==l[e]){for(h=q.rows[k];0<h.cells.length;)h.deleteCell(0);g=!1;l.rowid=k}g&&(h=d.insertAtTop?q.insertRow(0):q.insertRow(q.rows.length));A++;l.rowid=d.insertAtTop||"undefined"===typeof h.rowIndex?A+"":h.rowIndex;l._elementid_=a;t(h);if("undefined"==typeof c.html&&"undefined"==
typeof c.rows&&"undefined"==typeof c.columns)if("string"==typeof l)m(null);else for(f in l)l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&m(f);else if("undefined"!=typeof c.columns)if(isArray(c.columns))for(p=0;p<c.columns.length;p++)m(c.columns[p]);else for(p in c.columns)c.columns.hasOwnProperty(p)&&m(p);else if("undefined"!=typeof c.html){if(x=h.insertCell(0),x.innerHTML=yAnalise(c.html,l),x.style.verticalAlign="top",x.id=a+"_"+z+"_"+q.rows.length,"function"==typeof c.onNewItem)c.onNewItem(a,
x,l)}else if("undefined"!=typeof c.rows)for(k=!0,r=0;r<c.rows.length;r++){k||(h=q.insertRow(q.rows.length),t(h));h.innerHTML=yAnalise(c.rows[r],l);if(!g)for(p=0;p<h.cells.length;p++)h.cells[p].style.borderLeft="solid 1px red";if("function"==typeof c.onNewItem)c.onNewItem(a,h,l);k=!1}if("function"==typeof c.onNewRowReady)c.onNewRowReady(a,h)}}else if("UL"==k.nodeName){if(d.deleteRows)for(;k.firstChild;)k.removeChild(k.firstChild);for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);p=document.createElement("li");
w(p,l);m="";A=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)m=m+yAnalise(c.rows[r],l)+"";A=!0}else if("string"==typeof c.html)m=m+yAnalise(c.html,l)+"",A=!0;else for(f in l)""===m&&l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(m+=l[f]);t(p);A?p.innerHTML=m:p.appendChild(document.createTextNode(m));"string"==typeof c.beforeElement?(m=y$(c.beforeElement),k.insertBefore(p,m)):k.appendChild(p);if("function"==typeof c.onNewItem)c.onNewItem(a,p,l)}}else if("LISTBOX"==k.nodeName){if(d.deleteRows)for(;0<
k.childElementCount;)k.childNodes[0].remove();t=0;for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);l._elementid_=a;h=document.createElement("listitem");z=0;if("undefined"==typeof c.columns)if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in l){if(l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;h.appendChild(x)}}else for(f in c.columns)if(f!=
e){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;h.appendChild(x)}w(h,l);k.appendChild(h);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);z=0;for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);l._elementid_=a;t="";if("undefined"==typeof c.columns)if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in l)l.hasOwnProperty(f)&&
f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=l[f]);else if(m=c.sep||"",isArray(c.columns))for(p=0;p<c.columns.length;p++)""<t&&(t+=m),t+=l[c.columns[p]];else if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(t=t+l[f]+m);p=document.createElement("option");"undefined"!=typeof l[e]&&("DATALIST"==k.nodeName?p.setAttribute("data-"+e,l[e]):p.value=l[e]);p.innerHTML=t;p.id=a+"_"+z;w(p,l);if("function"==typeof c.onNewItem)c.onNewItem(a,p,l);k.appendChild(p);
z++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var C,B,y,l=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(t=v(b[0]||b),w(k,t),x=c.elementPrefixName||c.prefix||"",y=c.elementPostixName||c.postfix||"",k=0;k<l.length;k++){if(m=l[k].getAttribute("editMask"),A=l[k].getAttribute("storageMask"),p=l[k].getAttribute("valueType")||"text",C=suggestKeyName(t,l[k].name||l[k].id,x,y),f=c.columns&&suggestKeyName(c.columns,l[k].name||l[k].id)||null,"undefined"!=
typeof t[C]&&(B=unmaskHTML(t[C]),C=l[k].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(p=c.columns[f].type,m=c.columns[f].editMask||m,A=c.columns[f].storageMask||A);"text"!=p&&(""<m&&""<A?0<=p.indexOf("date")&&(B=dateTransform(B,A,m)):B=yAnalise("%"+p+"("+B+")"));switch(C){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "number":case "range":case "search":case "tel":case "time":case "url":case "week":l[k].value=
B;break;case "radio":case "checkbox":l[k].value==B&&(l[k].checked=l[k].value===B);break;case "select-one":case "select-multi":for(s=0;s<l[k].options.length;s++)l[k].options[s].value==B&&(l[k].selectedIndex=s)}if("function"==typeof c.onNewItem)c.onNewItem(a,l[k],t)}}else 1<b.length&&_dump("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&(d.deleteRows&&(k.innerHTML=""),t=k.innerHTML,b)){for(s in b)if(b.hasOwnProperty(s))if(l=v(b[s]),w(k,l),c.html)t+=yAnalise(c.html,
l);else for(f in l)l.hasOwnProperty(f)&&(t+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,l[f]));k.innerHTML=t}};ycomm.dom.getRowId=function(a,b){if(a)for(;a&&a.parentNode;)a=a.parentNode};ycomm.dom.getRowByRowNo=function(a,b){var c=document.getElementById(a);return c?c.rows[b]:null};ycomm.dom.getTableRowId=function(a,b){var c=ycomm.dom.getRowByRowNo(a,b);return c?c.id:null};
...
var ycommSSEBase=function(a,b,c){var d={getLocation:function(){return"object"==typeof document&&document.location&&document.location.href?document.location.href:""},getFolder:function(a){var b=a.lastIndexOf("/");return a.substr(0,b+1)},rpc:function(a,b){b=b||{};"undefined"!=typeof d.sse_session_id&&(b.sse_session_id=d.sse_session_id);return new Promise(function(c,g){d.rpcMethod("_sse",a,b,function(a,b,d){200==a?c(d):g(a)})})},poll:function(){d.pollEnabled&&d.rpc("peekMessage").then(function(a){if(a){console.log("data: "+
JSON.stringify(a));for(var b=0;b<a.length;b++)d.dispatchEvent(a[b].event,{data:a[b].data})||d.message({data:a[b].data})}setTimeout(d.poll,1E3)})},attachUser:function(b){d.rpc("attachUser",{w:a,user:d.user}).then(function(c){c&&c[0]&&c[0].ok&&(d.w=a,d.sse_session_id=c[0].sse_session_id,b())})},addEventListener:function(a,b){"undefined"==typeof d.events&&(d.events={});"undefined"==typeof d.events[a]&&(d.events[a]=[]);d.events[a].push([d.state,b]);1==d.state&&(d.pollEnabled||d.evtSource.addEventListener(a,
b),"ready"==trim(a.toLowerCase())&&d.dispatchEvent("ready"));return d},dispatchEvent:function(a,b){var c=!1;if("undefined"!==typeof d.events)for(var g=0;g<(d.events[a]||[]).length;g++)d.events[a][g][1](b),c|=1;eventName1=a;eventName2="on_"+a;"function"==typeof d[eventName1]?(d[eventName1](b),c|=1):"function"==typeof d[eventName2]?(d[eventName2](b),c|=1):c|=0;return c},startPolling:function(){d.pollEnabled=!0;d.state=1;d.dispatchEvent("ready",{gateway:"Polling"});setTimeout(d.poll,125)},guardianTimeout:function(a){clearTimeout(d.evtGuardian);
d.evtSource.close();d.evtSource=void 0;d.startPolling()},close:function(a){d.closing||(d.closing=!0,console.log("CLOSE"),d.state=-1,d.pollEnabled=!1,d.dispatchEvent("close"),d.evtSource&&d.evtSource.close(),d.closing=!1)},open:function(a){console.log("OPEN")},error:function(a){console.error("ERROR")},message:function(a){clearTimeout(d.evtGuardian);console.log("MESSAGE");if(0===d.state){d.state=1;for(var b in d.events)if(d.events.hasOwnProperty(b))for(var c=0;c<d.events[b].length;c++){var g=d.events[b][c];
1>g[0]&&(g[0]=1,d.evtSource.addEventListener(b,g[1]))}d.dispatchEvent("ready",{gateway:"SSE"})}if("function"==typeof d.onmessage)d.onmessage(a.data)},init:function(){d.state=-1;d._dataLocation_="undefined"==typeof c?function(){var a=d.getLocation(),b=a.lastIndexOf("/");return a.substr(0,b+1)+"sse.php"}():c;if("file:"==d._dataLocation_.substr(0,5))console.error("'"+d._dataLocation_+"' is not a correct data location");else{d.user="undefined"!=typeof b?b:generateUUID();var a=d.getFolder(d.getLocation()),
f=d.getFolder(d._dataLocation_);d.rpcMethod=a==f?ycomm.invoke:ycomm.crave;d.attachUser(function(){d.state=0;"function"==typeof window.EventSource?(d.evtSource=new EventSource(d._dataLocation_+"?si="+md5(d.sse_session_id)),d.evtSource.addEventListener("open",d.open,!1),d.evtSource.addEventListener("error",d.error,!1),d.evtSource.addEventListener("message",d.message,!1),d.evtSource.addEventListener("close",d.close,!1),d.evtGuardian=setTimeout(d.guardianTimeout,1500)):d.startPolling()})}return d}};return d.init()};
_dump("ycomm-sse");
