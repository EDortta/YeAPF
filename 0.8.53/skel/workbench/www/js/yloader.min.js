/* YeAPF 0.8.53-56 built on 2017-01-14 13:26 (-2 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.53-56 built on 2017-01-14 13:26 (-2 DST)");
...
ycomm.dom={_elem_templates:[]};ycomm.dom.fillInplaceData=function(a,b){for(var c in b)b.hasOwnProperty(c)&&a.setAttribute("data-"+c,b[c])};ycomm.dom.getInplaceData=function(a){a=a.attributes;var b={},c,d,e;for(e in a)a.hasOwnProperty(e)&&(c=a[e],d=c.nodeName,"data-"==d.substr(0,5)&&(b[d]=c.nodeValue));return b};
...
0;b<a.length;b++)d.dispatchEvent(a[b].event,{data:a[b].data})||d.message({data:a[b].data});setTimeout(d.poll,1E3)})},attachUser:function(b){d.rpc("attachUser",{w:a,user:d.user}).then(function(a){a&&a[0]&&a[0].ok&&(d.sse_session_id=a[0].sse_session_id,b())})},addEventListener:function(a,b){"ready"!=trim(a.toLowerCase())&&("undefined"==typeof d.events&&(d.events={}),"undefined"==typeof d.events[a]&&(d.events[a]=[]),d.events[a].push([d.state,b]));d["on_"+a]=b;1==d.state&&(d.pollEnabled||d.evtSource.addEventListener(a,
