/* YeAPF 0.8.53-97 built on 2017-01-24 08:07 (-2 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.53-97 built on 2017-01-24 08:07 (-2 DST)");
...
v(b[s]);"function"==typeof c.onBeforeNewItem&&onBeforeNewItem(a,l);p=document.createElement("li");w(p,l);m="";A=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)m=m+yAnalise(c.rows[r],l)+"";A=!0}else if("string"==typeof c.html)m=m+yAnalise(c.html,l)+"",A=!0;else for(f in l)""===m&&l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(m+=l[f]);t(p);A?p.innerHTML=m:p.appendChild(document.createTextNode(m));"string"==typeof c.beforeElement?(m=y$(c.beforeElement),k.insertBefore(p,m)):k.appendChild(p);
if("function"==typeof c.onNewItem)c.onNewItem(a,p,l)}}else if("LISTBOX"==k.nodeName){if(d.deleteRows)for(;0<k.childElementCount;)k.childNodes[0].remove();t=0;for(s in b)if(b.hasOwnProperty(s)){l=v(b[s]);l._elementid_=a;"function"==typeof c.onBeforeNewItem&&onBeforeNewItem(a,l);h=document.createElement("listitem");z=0;if("undefined"==typeof c.columns)if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in l){if(l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=
f){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;h.appendChild(x)}}else for(f in c.columns)if(f!=e){x=document.createElement("listcell");x.innerHTML=l[f];x.id=a+"_"+z+"_"+t;if("function"==typeof c.onNewItem)c.onNewItem(a,x,l);z+=1;h.appendChild(x)}w(h,l);k.appendChild(h);t++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);z=0;for(s in b)if(b.hasOwnProperty(s)){l=
v(b[s]);l._elementid_=a;"function"==typeof c.onBeforeNewItem&&onBeforeNewItem(a,l);t="";if("undefined"==typeof c.columns)if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in l)l.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=l[f]);else if(m=c.sep||"",isArray(c.columns))for(p=0;p<c.columns.length;p++)""<t&&(t+=m),t+=l[c.columns[p]];else if("string"==typeof l)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=
e&&(t=t+l[f]+m);p=document.createElement("option");"undefined"!=typeof l[e]&&("DATALIST"==k.nodeName?p.setAttribute("data-"+e,l[e]):p.value=l[e]);p.innerHTML=t;p.id=a+"_"+z;w(p,l);if("function"==typeof c.onNewItem)c.onNewItem(a,p,l);k.appendChild(p);z++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var C,B,y,l=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(t=v(b[0]||b),w(k,t),"function"==typeof c.onBeforeNewItem&&onBeforeNewItem(a,t),x=c.elementPrefixName||
c.prefix||"",y=c.elementPostixName||c.postfix||"",k=0;k<l.length;k++){if(m=l[k].getAttribute("editMask"),A=l[k].getAttribute("storageMask"),p=l[k].getAttribute("valueType")||"text",C=suggestKeyName(t,l[k].name||l[k].id,x,y),f=c.columns&&suggestKeyName(c.columns,l[k].name||l[k].id)||null,"undefined"!=typeof t[C]&&(B=unmaskHTML(t[C]),C=l[k].type.toLowerCase(),!c.columns||""<f)){""<f&&!isArray(c.columns)&&(p=c.columns[f].type,m=c.columns[f].editMask||m,A=c.columns[f].storageMask||A);"text"!=p&&(""<m&&
""<A?0<=p.indexOf("date")&&(B=dateTransform(B,A,m)):B=yAnalise("%"+p+"("+B+")"));switch(C){case "text":case "password":case "textarea":case "email":case "hidden":case "color":case "date":case "datetime":case "datetime-local":case "month":case "number":case "range":case "search":case "tel":case "time":case "url":case "week":l[k].value=B;break;case "radio":case "checkbox":l[k].value==B&&(l[k].checked=l[k].value===B);break;case "select-one":case "select-multi":for(s=0;s<l[k].options.length;s++)l[k].options[s].value==
B&&(l[k].selectedIndex=s)}if("function"==typeof c.onNewItem)c.onNewItem(a,l[k],t)}}else 1<b.length&&_dump("There are more than one record returning from the server")}else if("DIV"==k.nodeName&&(d.deleteRows&&(k.innerHTML=""),t=k.innerHTML,b)){for(s in b)if(b.hasOwnProperty(s))if(l=v(b[s]),w(k,l),"function"==typeof c.onBeforeNewItem&&onBeforeNewItem(a,l),c.html)t+=yAnalise(c.html,l);else for(f in l)l.hasOwnProperty(f)&&(t+="<div><div class=tnFieldName><b><small>{0}</small></b></div>{1}".format(f,l[f]));
k.innerHTML=t}};ycomm.dom.getRowId=function(a,b){if(a)for(;a&&a.parentNode;)a=a.parentNode};ycomm.dom.getRowByRowNo=function(a,b){var c=document.getElementById(a);return c?c.rows[b]:null};ycomm.dom.getTableRowId=function(a,b){var c=ycomm.dom.getRowByRowNo(a,b);return c?c.id:null};
