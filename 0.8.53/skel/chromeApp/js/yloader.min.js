/* YeAPF 0.8.53-67 built on 2017-01-16 15:18 (-2 DST) Copyright (C) 2004-2017 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.53-67 built on 2017-01-16 15:18 (-2 DST)");
...
ycomm.dom={_elem_templates:[]};ycomm.dom.fillInplaceData=function(a,b){for(var c in b)b.hasOwnProperty(c)&&("data-"==c.substr(0,5)&&(c=c.substr(5)),a.setAttribute("data-"+c,b[c]))};ycomm.dom.getInplaceData=function(a){a=a.attributes;var b={},c,d,e;for(e in a)a.hasOwnProperty(e)&&(c=a[e],d=c.nodeName,"data-"==d.substr(0,5)&&(b[d]=c.nodeValue));return b};
