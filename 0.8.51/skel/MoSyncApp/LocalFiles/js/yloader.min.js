/* YeAPF 0.8.51-84 built on 2016-11-05 11:39 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.51-84 built on 2016-11-05 11:39 (-2 DST)");
...
function yAnalise(a,b){if(void 0!==a){a=unmaskHTML(a);var c=/%[+(\w)]|[]\(/gi,d,e,f,h,g;for(e="";"string"==typeof a&&0<=(d=a.search(c));)if(e=a.slice(d).search(/\(/),0<=e){f=a.slice(d+e+1,d+e+2);if('"'==f||"'"==f){g=d+e+1;do g++,h=a.slice(g,g+1);while(h!=f&&g<a.length);f=g+a.slice(g).search(/\)/)-d}else f=a.slice(d).search(/\)/);var k=a.slice(d+1,d+e);e=h=a.slice(d+e+1,d+f);h=h.split(",");for(g=0;g<h.length;g++)h[g]=yAnalise(h[g],b);e=void 0;g=h[0].toUpperCase();var p=h[0];if(void 0!==b)if(void 0==
b[0])e=b[g]?yAnalise(b[g],b):yAnalise(b[p],b);else for(var w=b.length-1;0<=w&&void 0==e;w--)void 0!=b[w][g]?e=yAnalise(b[w][g],b):void 0!=b[w][p]&&(e=yAnalise(b[w][p],b));else e="string"==eval("typeof "+p)?eval(p):yAnalise(p);void 0==e&&(e="");h[0]=e;switch(k){case "integer":case "int":case "intz":case "intn":e=str2int(e);0==e&&("intz"==k?e="-":"intn"==k&&(e=""));break;case "decimal":h=Math.max(0,parseInt(h[1]));e=parseFloat(e);e=e.toFixed(h);break;case "lon2deg":e=dec2deg(e,!1);break;case "lat2deg":e=
dec2deg(e,!0);break;case "ibdate":e=IBDate2Date(e);break;case "tsdate":e=timestamp2date(e);break;case "tstime":e=timestamp2time(e);break;case "date":e=h[1]?UDate2Date(e,h[1]):UDate2Date(e);break;case "time":e=h[1]?UDate2Time(e,h[1]):UDate2Time(e);break;case "nl2br":e=e.replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br>$2");break;case "words":k=e.split(" ");p=Math.max(0,str2int(h[1]));w=Math.max(k.length-1,str2int(h[2]));h=Math.max(0,str2int(h[3]));e="";for(g=p;g<p+w;g++){var v=onlyDefinedValue(k[g]);
""<v&&(e+=" "+v)}0<h&&(e=wordwrap(e,h,"<br>",!0));break;case "quoted":e=('"'+e).trim()+'"';break;case "singleQuoted":e=("'"+e).trim()+"'";break;case "condLabel":break;default:if(""<k&&"function"==eval("typeof "+k)){e="";for(g=0;g<h.length;g++)""<e&&(e+=","),e+="'"+h[g]+"'";e=("<script>"+k+"("+e+");\x3c/script>").evalScripts()}}a=a.slice(0,d)+e+a.slice(d+f+1)}else d++}else a="";return a}
