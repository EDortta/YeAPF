/* YeAPF 0.8.51-88 built on 2016-11-09 12:24 (-2 DST) Copyright (C) 2004-2016 Esteban Daniel Dortta - dortta@yahoo.com */
if("undefined"===typeof console)var console="undefined"!=typeof window?window.console=window.console||{}:{};(function(){for(var a="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),b,c=0;c<a.length;c++)b=a[c],console[b]||(console[b]=function(){})})();console.log("YeAPF 0.8.51-88 built on 2016-11-09 12:24 (-2 DST)");
...
ycomm.dom.fillElement=function(a,b,c,d){if(void 0===c||null===c)c={};"boolean"==typeof d&&(d={deleteRows:d});d=d||{};"undefined"==typeof d.deleteRows&&(d.deleteRows=!0);"undefined"==typeof d.paintRows&&(d.paintRows=!0);var e,f,h,g,k=y$(a),p="undefined"==typeof ycomm.dom._elem_templates[a];e=c.idFieldName||"id";var w=function(a){a.doc&&a.id&&a.value&&(a=a.doc);return a},v=function(a){var g,h=w(b[q]);s=0;"TR"==a.nodeName&&d.paintRows&&(a.style.backgroundColor=rowColorSpec.suggestRowColor(D));if(h[e])if(y$(h[e])){for(g=
0;y$(h[e]+"_"+g);)g++;a.id=h[e]+"_"+g}else a.id=h[e];if("undefined"!=typeof c.inplaceData)for(var k=0;k<c.inplaceData.length;k++)f=c.inplaceData[k],g=h[f]||"",a.setAttribute("data_"+f,g);(c.onClick||c.onSelect)&&a.addEventListener("click",c.onClick||c.onSelect,!1)},t=function(d){if(d!=e){var f=h.insertCell(s),k=w(b[q]),p=null!==d?unmaskHTML(k[d]):unmaskHTML(k);c.columns&&c.columns[d]&&(c.columns[d].align&&(f.style.textAlign=c.columns[d].align),c.columns[d].type&&(p=yAnalise("%"+c.columns[d].type+
"("+p+")")));g||f.addClass("warning");f.innerHTML=0===p.length?"&nbsp;":p;f.style.verticalAlign="top";f.id=a+"_"+s+"_"+l.rows.length;f.setAttribute("colName",d);if("function"==typeof c.onNewItem)c.onNewItem(a,f,k);s+=1}},l,q,m,s,x,z=(new Date).getTime()-1447265735470;if(k)if("TABLE"==k.nodeName){l=0<k.getElementsByTagName("tbody").length?k.getElementsByTagName("tbody")[0]:k;0<l.getElementsByTagName("tbody").length&&(l=l.getElementsByTagName("tbody")[0]);if(p)if("undefined"==typeof(c.columns||c.rows||
c.html)){if(ycomm.dom._elem_templates[a]={},0<l.rows.length)for(ycomm.dom._elem_templates[a].rows=[],k=0;k<l.rows.length;k++)ycomm.dom._elem_templates[a].rows[k]=trim(l.rows[k].innerHTML+"").replace(/\ \s+/g,"")}else ycomm.dom._elem_templates[a]={},ycomm.dom._elem_templates[a].columns=c.columns,ycomm.dom._elem_templates[a].rows=c.rows,ycomm.dom._elem_templates[a].html=c.html;mergeObject(ycomm.dom._elem_templates[a],c,!0);if(d.deleteRows)for(;0<l.rows.length;)l.deleteRow(l.rows.length-1);var D=l.rows.length%
2;s=null;for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);D++;g=!0;if(!d.deleteRows&&p[e])for(k=0;g&&k<l.rows.length;k++)if(l.rows[k].id==p[e]){for(h=l.rows[k];0<h.cells.length;)h.deleteCell(0);g=!1;p.rowid=k}g&&(h=d.insertAtTop?l.insertRow(0):l.insertRow(l.rows.length));z++;p.rowid=d.insertAtTop||"undefined"===typeof h.rowIndex?z+"":h.rowIndex;p._elementid_=a;v(h);if("undefined"==typeof c.html&&"undefined"==typeof c.rows&&"undefined"==typeof c.columns)if("string"==typeof p)t(null);else for(f in p)p.hasOwnProperty(f)&&
f!=e&&"rowid"!=f&&"_elementid_"!=f&&t(f);else if("undefined"!=typeof c.columns)if(isArray(c.columns))for(m=0;m<c.columns.length;m++)t(c.columns[m]);else for(m in c.columns)c.columns.hasOwnProperty(m)&&t(m);else if("undefined"!=typeof c.html){if(x=h.insertCell(0),x.innerHTML=yAnalise(c.html,p),x.style.verticalAlign="top",x.id=a+"_"+s+"_"+l.rows.length,"function"==typeof c.onNewItem)c.onNewItem(a,x,p)}else if("undefined"!=typeof c.rows)for(k=!0,r=0;r<c.rows.length;r++){k||(h=l.insertRow(l.rows.length),
v(h));h.innerHTML=yAnalise(c.rows[r],p);if(!g)for(m=0;m<h.cells.length;m++)h.cells[m].style.borderLeft="solid 1px red";if("function"==typeof c.onNewItem)c.onNewItem(a,h,p);k=!1}if("function"==typeof c.onNewRowReady)c.onNewRowReady(a,h)}}else if("UL"==k.nodeName){if(d.deleteRows)for(;k.firstChild;)k.removeChild(k.firstChild);for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);m=document.createElement("li");t="";z=!1;if("object"==typeof c.rows){for(r=0;r<c.rows.length;r++)t=t+yAnalise(c.rows[r],p)+"";z=!0}else if("string"==
typeof c.html)t=t+yAnalise(c.html,p)+"",z=!0;else for(f in p)""===t&&p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(t+=p[f]);v(m);z?m.innerHTML=t:m.appendChild(document.createTextNode(t));"string"==typeof c.beforeElement?(t=y$(c.beforeElement),k.insertBefore(m,t)):k.appendChild(m);if("function"==typeof c.onNewItem)c.onNewItem(a,m,p)}}else if("LISTBOX"==k.nodeName){if(d.deleteRows)for(;0<k.childElementCount;)k.childNodes[0].remove();v=0;for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);p._elementid_=
a;h=document.createElement("listitem");s=0;if("undefined"==typeof c.columns)if("string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in p){if(p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f){x=document.createElement("listcell");x.innerHTML=p[f];x.id=a+"_"+s+"_"+v;if("function"==typeof c.onNewItem)c.onNewItem(a,x,p);s+=1;h.appendChild(x)}}else for(f in c.columns)if(f!=e){x=document.createElement("listcell");x.innerHTML=p[f];x.id=a+"_"+s+"_"+v;if("function"==
typeof c.onNewItem)c.onNewItem(a,x,p);s+=1;h.appendChild(x)}k.appendChild(h);v++}}else if("SELECT"==k.nodeName||"DATALIST"==k.nodeName){if(d.deleteRows)for(;0<k.options.length;)k.removeChild(k.options[0]);s=0;for(q in b)if(b.hasOwnProperty(q)){p=w(b[q]);p._elementid_=a;v="";if("undefined"==typeof c.columns)if("string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in p)p.hasOwnProperty(f)&&f!=e&&"rowid"!=f&&"_elementid_"!=f&&(v+=p[f]);else if(isArray(c.columns))for(m=
0;m<c.columns.length;m++)v=v+p[c.columns[m]]+" ";else if(m=c.sep||"","string"==typeof p)_dumpy(2,1,"ERRO: yeapf-dom.js - string cell not implemented");else for(f in c.columns)f!=e&&(v=v+p[f]+m);t=document.createElement("option");"undefined"!=typeof p[e]&&(t.value=p[e]);t.innerHTML=v;t.id=a+"_"+s;if(c.inplaceData)for(m=0;m<c.inplaceData.length;m++)"undefined"!==typeof p[c.inplaceData[m]]&&t.setAttribute("data_"+c.inplaceData[m],p[c.inplaceData[m]]);if("function"==typeof c.onNewItem)c.onNewItem(a,t,
p);k.appendChild(t);s++}if(k.onclick)k.onclick()}else if("FORM"==k.nodeName){var B,A;x=d.deleteRows?this.cleanForm(a):this.selectElements(a);if(b)if("object"==typeof b||1===b.length)for(var C=w(b[0]||b),t=c.elementPrefixName||c.prefix||"",z=c.elementPostixName||c.postfix||"",k=0;k<x.length;k++){if(v=x[k].getAttribute("editMask"),m=x[k].getAttribute("storageMask"),p=x[k].getAttribute("valueType")||"text",B=suggestKeyName(C,x[k].name||x[k].id,t,z),f=c.columns&&suggestKeyName(c.columns,x[k].name||x[k].id)||
